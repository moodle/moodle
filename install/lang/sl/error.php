...
$string['remotedownloaderror'] = 'Prenos komponent na vaš strežnik ni uspel. Preverite nastavitve prehodnega strežnika. Priporočljiva je uporaba razširitve cURL za PHP.<br /><br />Datoteko <a href="{$a->url}">{$a->url}</a> morate prenesti ročno - skopirajte jo v imenik "{$a->dest}" in razširite.';
