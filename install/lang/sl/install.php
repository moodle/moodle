...
$string['clialreadyinstalled'] = 'Datoteka config.php že obstaja. Uporabite admin/cli/upgrade.php, če želite posodobiti vašo stran.';
...
$string['environmentsub2'] = 'Vsaka izdaja Moodla ima nekatere minimalne PHP zahteve in številne mandatorne PHP razširitve. Pred vsako namestitvijo ali posodobitvijo se izvede popolno preverjanje okolja. Obrnite se na skrbnika strežnika, če ne veste, kako namestiti novo verzijo ali omogočiti PHP razširitev.';
...
$string['pathssubwwwroot'] = 'Polni spletni naslov kjer bo Moodle dostopan. Dostop do Moodla z uporabo več naslovov ni mogoč. Če ima vaša stran več javnih naslovov, morate nastaviti trajne preusmeritve na vse naslove razen tega. Če je vaša stran dostopana preko interneta in omrežja, uporabite tukaj javne naslove in nastaviet DNS tako, da lahko uporabniki znotraj omrežja uporabljajo tudi javne naslove. Če naslovi niso pravilni, spremenite URL v vašem brskalniku in ponovno poženite namestitev z drugo vrednostjo.';
