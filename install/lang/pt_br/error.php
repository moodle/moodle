...
$string['remotedownloaderror'] = '<p>O download do componente para o seu servidor falhou. Verifique as configurações de proxy; a extensão PHP cURL é altamente recomendada.</p>
<p>Você deve baixar o arquivo <a href="{$a->url}">{$a->url}</a> manualmente, copiá-lo para "{$a->dest}" no seu servidor e descompactá-lo lá.</p>';
