...
$string['downloadlanguagesub'] = 'Now the installer is trying to download the complete lang pack that you have selected in order to continue the installation using it. If the process doesn\'t end or you get an error, so can safely skip it and continue with the installation in English.';
