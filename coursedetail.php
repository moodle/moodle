...
<body  id="page-course-view-topics" class="format-topics limitedwidth  path-course path-course-view chrome dir-ltr lang-en yui-skin-sam yui3-skin-sam qubits-localhost-in pagelayout-course course-3 context-19 category-1 uses-drawers drawer-open-index">
...
//]]>
    ...
    <nav class="navbar messageicon fixed-top navbar-light bg-white navbar-expand"  aria-label="Site navigation" style="z-index:auto;">
       ...
       <div class="pagetitle-left-alignment">
        ...
        <ol class="breadcrumb bg-none">
                ...
                <li class="breadcrumb-item active" aria-current="page">DigiChamps Level 1</li>
        </ol>
    </nav>
        </div>
    ...
    <div class="popover-region-toggle nav-link icon-no-margin"
        ...
        role="button"
        aria-controls="popover-region-container-64953479a1422649534791b3b966"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-64953479a1422649534791b3b966"
    ...
    <a id="message-drawer-toggle-64953479a510a649534791b3b967" class="nav-link popover-region-toggle position-relative icon-no-margin" href="#"
            role="button">
...
<div  class="drawer drawer-left drawer-primary d-print-none not-initialized" data-region="fixed-drawer" id="theme_boost-drawers-primary" data-preference="" data-state="show-drawer-primary" data-forceopen="0" data-close-on-resize="1">
    ...
    <div id="courseindex-content">
        <div data-region="loading-placeholder-content" aria-hidden="true" id="6495347968764649534791b3b964-course-index-placeholder">
            <ul class="media-list">
                <li class="media">
...
<li class="type_siteadmin depth_1 contains_branch" tabindex="-1" role="treeitem" aria-expanded="false" data-requires-ajax="true" data-loaded="false"><hr /><p class="tree_item root_node tree_item branch" id="expandable_branch_71_siteadministration"><a href="http://qubits.localhost.in/admin/search.php">Site administration</a></p></li></ul></div>
    ...
    <div class="input-group">
        ...
        <input type="text"
           id="searchinput-6495347966538649534791b3b963"
           class="form-control"
  ...
  <span id="sb-2"></span></aside>
    ...
    <form method="post" action="http://qubits.localhost.in/course/view.php" >
        ...
        <button type="submit" class="btn btn-primary"
            id="single_button649534791b3b91"
        ...
        <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1 class="h2">DigiChamps Level 1</h1></div></div>
                    </div>
                    ...
                    <nav class="moremenu navigation">
                        <ul id="moremenu-649534796990d-nav-tabs" role="menubar" class="nav more-nav nav-tabs">
                            ...
                            <li role="none" class="nav-item dropdown dropdownmoremenu d-none" data-region="morebutton">
                                <a class="dropdown-toggle nav-link " href="#" id="moremenu-dropdown-649534796990d" role="menuitem" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" tabindex="-1">
                                    More
                                </a>
                                <ul class="dropdown-menu dropdown-menu-left" data-region="moredropdown" aria-labelledby="moremenu-dropdown-649534796990d" role="menu">
                                </ul>
                            </li>
                        </ul>
                    </nav>
            ...
            <div id="page-content" class="pb-3 d-print-block">
                <div id="region-main-box">
                    <section id="region-main" aria-label="Content">
                        ...
                        <div role="main"><span id="maincontent"></span><div class="course-content"><div id="6495347a36f0f649534791b3b980-course-format">
    ...
    <ul class="topics" data-for="course_sectionlist">
                    ...
                    >
                                        ...
                                        <div class="d-flex align-items-start position-relative">
                                            ...
                                            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
                                                id="sectionid-6-title" data-for="section_title" data-id="6" data-number="0">
                                                General
                                            </h3>
                                        </div>
                                        ...
                                        <div class="section_availability course-description-item">
                                                <div class="availabilityinfo isrestricted isfullinfo">
                                                    <div class="description-inner">
                                                        <i class="icon fa fa-lock fa-fw " aria-hidden="true"  ></i> Available from <strong>2 June 2050, 8:00 PM</strong> (hidden otherwise)
                                                    </div>
                                                </div>
                                        </div>
                            </div>
                ...
                >
                    ...
                    >
                                        ...
                                        <div class="d-flex align-items-start position-relative">
                                            ...
                                            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
                                                id="sectionid-7-title" data-for="section_title" data-id="7" data-number="1">
                                ...
                                <div class=" my-3" data-for="sectioninfo">
                                    ...
                                    <ul class="section m-0 p-0 img-text  d-block " data-for="cmlist">
                                                <li
                                                    ...
                                                    data-id="4"
                                                >
                                                        <div class="activity-item course-complete" data-activityname="Unit 1 Summary">
        ...
        <span class="instancename">Unit 1 Summary <span class="accesshide " > Page</span></span>
                                                                                           ...
                                                                                           <div class="d-flex type-opacity">
                                                                                                    <div class="contentspace">Type: Theory</div>
                                                                                                    <div class="contentspace">Status: Done</div>
                                                                                                    <div><i class="qicon-calendar mr-2"></i>Last Opened: 19 Jan, 2023</div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Unit 1 Summary" class="activity-information">
                                                                                    </div>
                                                                            </div>
                                                                    </div>
        ...
        <span class="instancename">1.1 Introduction to Computing Devices <span class="accesshide " > Page</span></span>
                                                                                                 ...
                                                                                                 <div class="d-flex type-opacity">
                                                                                                    <div class="contentspace">Type: Theory</div>
                                                                                                    <div class="contentspace">Status: Inprogress</div>
                                                                                                    <div><i class="qicon-calendar mr-2"></i>Last Opened: 19 Jan, 2023</div>
                                                                                            </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.1 Introduction to Computing Devices" class="activity-information">
                                                                                                <div data-region="completion-info" class="d-none">
        ...
        <span class="instancename">1.1 Reflect <span class="accesshide " > Feedback</span></span>
                                                                                                 ...
                                                                                                 <div class="d-flex type-opacity">
                                                                                                    <div class="contentspace">Type: Theory</div>
                                                                                                    <div class="contentspace">Status: Not Started</div>
                                                                                                    <div><i class="qicon-calendar mr-2"></i>Last Opened: 19 Jan, 2023</div>
                                                                                            </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.1 Reflect" class="activity-information">
        ...
        <span class="instancename">1.2 Parts of a Computer <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.2 Parts of a Computer" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="8"
                                                >
                                                        <div class="activity-item " data-activityname="1.2 Reflect">
        ...
        <span class="instancename">1.2 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.2 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="9"
                                                >
                                                        <div class="activity-item " data-activityname="1.3 Safety Measures">
        ...
        <span class="instancename">1.3 Safety Measures <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.3 Safety Measures" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="10"
                                                >
                                                        <div class="activity-item " data-activityname="1.3 Reflect">
        ...
        <span class="instancename">1.3 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.3 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="11"
                                                >
                                                        <div class="activity-item " data-activityname="1.4 Keyboard and Mouse">
        ...
        <span class="instancename">1.4 Keyboard and Mouse <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.4 Keyboard and Mouse" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="12"
                                                >
                                                        <div class="activity-item " data-activityname="1.4 Reflect">
        ...
        <span class="instancename">1.4 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="1.4 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="13"
                                                >
                                                        <div class="activity-item " data-activityname="Exercise - Unit 1">
        ...
        <span class="instancename">Exercise - Unit 1 <span class="accesshide " > Quiz</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Exercise - Unit 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                        ...
                                        <div class="d-flex align-items-start position-relative">
                                            <a role="button" data-toggle="collapse"
                                               ...
                                               class="btn btn-icon mr-1 icons-collapse-expand justify-content-center
                                                    stretched-link 
                                                   "
                                               aria-label="Unit 2: Development of Technology">
                                            <span class="expanded-icon icon-no-margin p-2" title="Collapse">
                                                <i class="icon fa fa-chevron-down fa-fw " aria-hidden="true"  ></i>
                                            </span>
                                            <span class="collapsed-icon icon-no-margin p-2" title="Expand">
                                            ...
                                            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
                                                id="sectionid-8-title" data-for="section_title" data-id="8" data-number="2">
                                                Unit 2: Development of Technology
                                            </h3>
                                        </div>
                            <div data-region="sectionbadges" class="sectionbadges d-flex align-items-center">
                            </div>
                                ...
                                <div class=" my-3" data-for="sectioninfo">
                                    ...
                                    <ul class="section m-0 p-0 img-text  d-block " data-for="cmlist">
                                                <li
                                                    ...
                                                    data-id="14"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Unit 2 Summary">
        ...
        <span class="instancename">Unit 2 Summary <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Unit 2 Summary" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                                            ...
                                                                            <div class="my-1 align-items-center d-none">
                                                                                <span class="badge badge-pill badge-warning">Hidden from students</span>
                                                                            </div>
                                                ...
                                                <li
                                                    ...
                                                    data-id="15"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.1 Technology and Us">
        ...
        <span class="instancename">2.1 Technology and Us <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.1 Technology and Us" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="16"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.1 Mastery Challenge 1">
        ...
        <span class="instancename">2.1 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.1 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                                ...
                                                                <div class="description">
                                                                        <div data-region="activity-dates" class="activity-dates small course-description-item">
                                                                            <div class="description-inner">
                                                                                        <div>
                                                                                            <strong>Opened:</strong> Thursday, 2 June 2022, 8:00 PM
                                                                                        </div>
                                                                            </div>
                                                                        </div>
                                                                </div>
                                                ...
                                                <li
                                                    ...
                                                    data-id="17"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.1 Mastery Challenge 2">
        ...
        <span class="instancename">2.1 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.1 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="18"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.1 Mastery Challenge 3">
        ...
        <span class="instancename">2.1 Mastery Challenge 3 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.1 Mastery Challenge 3" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="19"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.1 Reflect">
        ...
        <span class="instancename">2.1 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.1 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="20"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.2 How to Turn on the System and Work with Applications">
        ...
        <span class="instancename">2.2 How to Turn on the System and Work with Applications <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.2 How to Turn on the System and Work with Applications" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="21"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.2 Mastery Challenge 1">
        ...
        <span class="instancename">2.2 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.2 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="22"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.2 Mastery Challenge 2">
        ...
        <span class="instancename">2.2 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.2 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="23"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="2.2 Reflect">
        ...
        <span class="instancename">2.2 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="2.2 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="24"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Exercise - Unit 2">
        ...
        <span class="instancename">Exercise - Unit 2 <span class="accesshide " > Quiz</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Exercise - Unit 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                        ...
                                        <div class="d-flex align-items-start position-relative">
                                            <a role="button" data-toggle="collapse"
                                               ...
                                               class="btn btn-icon mr-1 icons-collapse-expand justify-content-center
                                                    stretched-link 
                                                   "
                                               aria-label="Unit 3: Internet and Safety">
                                            <span class="expanded-icon icon-no-margin p-2" title="Collapse">
                                                <i class="icon fa fa-chevron-down fa-fw " aria-hidden="true"  ></i>
                                            </span>
                                            <span class="collapsed-icon icon-no-margin p-2" title="Expand">
                                            ...
                                            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
                                                id="sectionid-9-title" data-for="section_title" data-id="9" data-number="3">
                                                Unit 3: Internet and Safety
                                            </h3>
                                        </div>
                            <div data-region="sectionbadges" class="sectionbadges d-flex align-items-center">
                                            <span class="badge badge-pill badge-warning order-2">Hidden from students</span>
                            </div>
                            </div>
                                ...
                                <div class=" my-3" data-for="sectioninfo">
                                    ...
                                    <ul class="section m-0 p-0 img-text  d-block " data-for="cmlist">
                                                <li
                                                    ...
                                                    data-id="25"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Unit 3 Summary">
        ...
        <span class="instancename">Unit 3 Summary <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Unit 3 Summary" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="26"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.1 Search the Internet">
        ...
        <span class="instancename">3.1 Search the Internet <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.1 Search the Internet" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="27"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.1 Mastery Challenge 1">
        ...
        <span class="instancename">3.1 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.1 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="28"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.1 Mastery Challenge 2">
        ...
        <span class="instancename">3.1 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.1 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="29"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.1 Mastery Challenge 3">
        ...
        <span class="instancename">3.1 Mastery Challenge 3 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.1 Mastery Challenge 3" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="30"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.1 Reflect">
        ...
        <span class="instancename">3.1 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.1 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="31"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.2 Be Safe">
        ...
        <span class="instancename">3.2 Be Safe <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.2 Be Safe" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="32"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.2 Mastery Challenge 1">
        ...
        <span class="instancename">3.2 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.2 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="33"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.2  Mastery Challenge 2">
        ...
        <span class="instancename">3.2  Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.2  Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="34"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.2 Mastery Challenge 3">
        ...
        <span class="instancename">3.2 Mastery Challenge 3 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.2 Mastery Challenge 3" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="35"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="3.2 Reflect">
        ...
        <span class="instancename">3.2 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="3.2 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="36"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Unit 3 - Exercise">
        ...
        <span class="instancename">Unit 3 - Exercise <span class="accesshide " > Quiz</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Unit 3 - Exercise" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                        ...
                                        <div class="d-flex align-items-start position-relative">
                                            <a role="button" data-toggle="collapse"
                                               ...
                                               class="btn btn-icon mr-1 icons-collapse-expand justify-content-center
                                                    stretched-link 
                                                   "
                                               aria-label="Unit 4: Painting and Stamps">
                                            <span class="expanded-icon icon-no-margin p-2" title="Collapse">
                                                <i class="icon fa fa-chevron-down fa-fw " aria-hidden="true"  ></i>
                                            </span>
                                            <span class="collapsed-icon icon-no-margin p-2" title="Expand">
                                            ...
                                            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
                                                id="sectionid-10-title" data-for="section_title" data-id="10" data-number="4">
                                                Unit 4: Painting and Stamps
                                            </h3>
                                        </div>
                            <div data-region="sectionbadges" class="sectionbadges d-flex align-items-center">
                                            <span class="badge badge-pill badge-warning order-2">Hidden from students</span>
                                ...
                                <div class=" my-3" data-for="sectioninfo">
                                    ...
                                    <ul class="section m-0 p-0 img-text  d-block " data-for="cmlist">
                                                <li
                                                    ...
                                                    data-id="37"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Unit 4 Summary">
        ...
        <span class="instancename">Unit 4 Summary <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Unit 4 Summary" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="38"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.1 Paint tool">
        ...
        <span class="instancename">4.1 Paint tool <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.1 Paint tool" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="39"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.1 Mastery Challenge 1">
        ...
        <span class="instancename">4.1 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.1 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="40"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.1 Mastery Challenge 2">
        ...
        <span class="instancename">4.1 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.1 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="41"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.1 Mastery Challenge 3">
        ...
        <span class="instancename">4.1 Mastery Challenge 3 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.1 Mastery Challenge 3" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="42"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.1 Reflect">
        ...
        <span class="instancename">4.1 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.1 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="43"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.2 Color a Canvas">
        ...
        <span class="instancename">4.2 Color a Canvas <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.2 Color a Canvas" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="44"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.2 Mastery Challenge 1">
        ...
        <span class="instancename">4.2 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.2 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="45"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.2 Mastery Challenge 2">
        ...
        <span class="instancename">4.2 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.2 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="46"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.2 Reflect">
        ...
        <span class="instancename">4.2 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.2 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="47"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.3 Stamps">
        ...
        <span class="instancename">4.3 Stamps <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.3 Stamps" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="48"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.3 Mastery Challenge 1">
        ...
        <span class="instancename">4.3 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.3 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="49"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.3 Mastery Challenge 2">
        ...
        <span class="instancename">4.3 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.3 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="50"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.3 Reflect">
        ...
        <span class="instancename">4.3 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.3 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="51"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.4 Manage and Present Projects">
        ...
        <span class="instancename">4.4 Manage and Present Projects <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.4 Manage and Present Projects" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="52"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.4 Mastery Challenge 1">
        ...
        <span class="instancename">4.4 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.4 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="53"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.4 Mastery Challenge 2">
        ...
        <span class="instancename">4.4 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.4 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="54"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="4.4 Reflect">
        ...
        <span class="instancename">4.4 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="4.4 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="55"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Exercise - Unit 4">
        ...
        <span class="instancename">Exercise - Unit 4 <span class="accesshide " > Quiz</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Exercise - Unit 4" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                                ...
                                                                <div class="description">
                                                                        <div data-region="activity-dates" class="activity-dates small course-description-item">
                                                                            <div class="description-inner">
                                                                                        <div>
                                                                                            <strong>Opened:</strong> Saturday, 4 June 2022, 9:23 AM
                                                                                        </div>
                                                                            </div>
                                                                        </div>
                                                                </div>
                                        ...
                                        <div class="d-flex align-items-start position-relative">
                                            <a role="button" data-toggle="collapse"
                                               ...
                                               class="btn btn-icon mr-1 icons-collapse-expand justify-content-center
                                                    stretched-link 
                                                   "
                                               aria-label="Unit 5: PowerPoint Basics">
                                            <span class="expanded-icon icon-no-margin p-2" title="Collapse">
                                                <i class="icon fa fa-chevron-down fa-fw " aria-hidden="true"  ></i>
                                            </span>
                                            <span class="collapsed-icon icon-no-margin p-2" title="Expand">
                                            ...
                                            <h3 class="sectionname course-content-item d-flex align-self-stretch align-items-center mb-0"
                                                id="sectionid-11-title" data-for="section_title" data-id="11" data-number="5">
                                                Unit 5: PowerPoint Basics
                                            </h3>
                                        </div>
                            <div data-region="sectionbadges" class="sectionbadges d-flex align-items-center">
                                            <span class="badge badge-pill badge-warning order-2">Hidden from students</span>
                                ...
                                <div class=" my-3" data-for="sectioninfo">
                                    ...
                                    <ul class="section m-0 p-0 img-text  d-block " data-for="cmlist">
                                                <li
                                                    ...
                                                    data-id="56"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Unit 5 Summary">
        ...
        <span class="instancename">Unit 5 Summary <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Unit 5 Summary" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="57"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.1 My Favorite Picture">
        ...
        <span class="instancename">5.1 My Favorite Picture <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.1 My Favorite Picture" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="58"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.1 Mastery Challenge 1">
        ...
        <span class="instancename">5.1 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.1 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="59"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.1 Mastery Challenge 2">
        ...
        <span class="instancename">5.1 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.1 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="60"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.1 Mastery Challenge 3">
        ...
        <span class="instancename">5.1 Mastery Challenge 3 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.1 Mastery Challenge 3" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="61"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.1 Reflect">
        ...
        <span class="instancename">5.1 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.1 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="62"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.2 Parents and their Young Ones">
        ...
        <span class="instancename">5.2 Parents and their Young Ones <span class="accesshide " > Page</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.2 Parents and their Young Ones" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="63"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.2 Mastery Challenge 1">
        ...
        <span class="instancename">5.2 Mastery Challenge 1 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.2 Mastery Challenge 1" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="64"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.2 Mastery Challenge 2">
        ...
        <span class="instancename">5.2 Mastery Challenge 2 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.2 Mastery Challenge 2" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="65"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.2 Mastery Challenge 3">
        ...
        <span class="instancename">5.2 Mastery Challenge 3 <span class="accesshide " > Assignment</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.2 Mastery Challenge 3" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="66"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="5.2 Reflect">
        ...
        <span class="instancename">5.2 Reflect <span class="accesshide " > Feedback</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="5.2 Reflect" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                ...
                                                <li
                                                    ...
                                                    data-id="67"
                                                >
                                                        <div class="activity-item hiddenactivity" data-activityname="Exercise - Unit 5">
        ...
        <span class="instancename">Exercise - Unit 5 <span class="accesshide " > Quiz</span></span>
                                                                            ...
                                                                            <div class="activity-info mt-1 mt-md-0">
                                                                                    <div data-region="activity-information" data-activityname="Exercise - Unit 5" class="activity-information">
                                                                                                <div data-region="completion-info">
                                                                                                                    <button class="btn btn-outline-secondary btn-sm text-nowrap" disabled>
                                                                                                                        Mark as done
                                                                                                                    </button>
                                                                ...
                                                                <div class="description">
                                                                        <div data-region="activity-dates" class="activity-dates small course-description-item">
                                                                            <div class="description-inner">
                                                                                        <div>
                                                                                            <strong>Opened:</strong> Saturday, 4 June 2022, 11:03 AM
                                                                                        </div>
                                                                            </div>
                                                                        </div>
                                                                </div>
        ...
        <footer id="page-footer" class="footer-popover bg-white">
            ...
            <div class="footer-content-popover container" data-region="footer-content-popover">
                    <div class="footer-section p-3 border-bottom">
                            <div class="footer-support-link"><a href="https://docs.moodle.org/401/en/course/view/topics"><i class="icon fa fa-book fa-fw iconhelp icon-pre" aria-hidden="true"  ></i>Help and documentation</a></div>
...
M.util.js_pending('core_courseformat/courseeditor'); require(['core_courseformat/courseeditor'], function(amd) {amd.setViewFormat("3", {"editing":false,"supportscomponents":true,"statekey":"1687499705_1687499706"}); M.util.js_complete('core_courseformat/courseeditor');});;

require(['core_courseformat/local/courseindex/placeholder'], function(component) {
    component.init('6495347968764649534791b3b964-course-index-placeholder');
});
;
...
function(
    ...
    var toggle = $('#message-drawer-toggle-64953479a510a649534791b3b967');
    Popover.init(toggle);
});
;
...
require(['core/edit_switch'], function(editSwitch) {
    editSwitch.init('64953479a65fd649534791b3b968-editingswitch');
});
;
...
;
    ...
    require(['core/moremenu'], function(moremenu) {
        moremenu(document.querySelector('#moremenu-649534796990d-nav-tabs'));
    });
;
...
require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-64953479af7d8649534791b3b979');
    MessageDrawer.init(root, '64953479af7d8649534791b3b979', false);
});
;
...
require(['core_courseformat/local/content'], function(component) {
    component.init('6495347a36f0f649534791b3b980-course-format', {}, 0);
});
;
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random649534791b3b981'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random649534791b3b981'); });
})();
//]]>
</script>
    ...
    <div
    id="drawer-64953479af7d8649534791b3b979"
    ...
    tabindex="0"
>
            <div id="message-drawer-64953479af7d8649534791b3b979" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-64953479af7d8649534791b3b979"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-64953479af7d8649534791b3b979"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-64953479af7d8649534791b3b979"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-64953479af7d8649534791b3b979"
                                        class="nav-link"
                                        href="#requests-tab-panel-64953479af7d8649534791b3b979"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-64953479af7d8649534791b3b979"
                                        aria-selected="false"
                                    >
                                        Requests
                    ...
                    data-user-id="2"
                                        id="contacts-tab-panel-64953479af7d8649534791b3b979"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-64953479af7d8649534791b3b979"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="2"
                                        id="requests-tab-panel-64953479af7d8649534791b3b979"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-64953479af7d8649534791b3b979"
                ...
                >
                    ...
                    <div id="message-drawer-view-overview-container-64953479af7d8649534791b3b979" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-64953479af7d8649534791b3b979"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-64953479af7d8649534791b3b979"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="2"
                                            id="view-overview-favourites-target-64953479af7d8649534791b3b979"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-64953479af7d8649534791b3b979"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex rounded-0 align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-64953479af7d8649534791b3b979"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-64953479af7d8649534791b3b979"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="2"
                                            id="view-overview-group-messages-target-64953479af7d8649534791b3b979"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header rounded-0" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex rounded-0 align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-64953479af7d8649534791b3b979"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-64953479af7d8649534791b3b979"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="2"
                                            id="view-overview-messages-target-64953479af7d8649534791b3b979"
                    ...
                    <div class="hidden" data-region="content-container">
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-64953479af7d8649534791b3b979-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-64953479af7d8649534791b3b979-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-64953479af7d8649534791b3b979-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-64953479af7d8649534791b3b979-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-64953479af7d8649534791b3b979" checked>
                                    <label class="custom-control-label" for="enter-to-send-64953479af7d8649534791b3b979">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
