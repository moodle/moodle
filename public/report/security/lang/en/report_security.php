...
$string['check_securitymessages_action_enable'] = 'Enable';
$string['check_securitymessages_action_enable_notification'] = 'Enable notification';
$string['check_securitymessages_action_enableandlock'] = 'Enable and lock';
$string['check_securitymessages_action_lock'] = 'Lock';
$string['check_securitymessages_details'] = '<p>It is highly recommended that security-critical message notifications are forced on so that users cannot opt out of receiving them. This includes new login alerts sent via email and mobile push notifications.</p>';
$string['check_securitymessages_error'] = 'The following security message notifications are not forced on: {$a}';
$string['check_securitymessages_name'] = 'Security message notifications';
$string['check_securitymessages_notification_disabled'] = 'notification disabled';
$string['check_securitymessages_notification_enabled'] = 'Notification enabled';
$string['check_securitymessages_ok'] = 'All security-critical message notifications are forced on.';
