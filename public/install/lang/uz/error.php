...
$string['remotedownloaderror'] = '<p>Komponentni serveringizga yuklash muvaffaqiyatsiz bo‘ldi. Iltimos, proksi sozlamalarini tekshiring; PHP cURL kengaytmasi tavsiya etiladi.</p>
<p>Siz <a href="{$a->url}">{$a->url}</a> faylini qo‘lda yuklab olib, serveringizdagi "{$a->dest}" joyga nusxalab, u yerda arxivni ochishingiz kerak.</p>';
$string['wrongdestpath'] = 'Noto‘g‘ri manzil yo‘li';
$string['wrongsourcebase'] = 'Manba URL bazasi noto‘g‘ri';
$string['wrongzipfilename'] = 'ZIP fayl nomi noto‘g‘ri';
