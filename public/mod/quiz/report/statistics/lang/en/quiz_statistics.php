...
$string['recalculatedebounce'] = 'Statistics recalculation debounce delay';
$string['recalculatedebouncedesc'] = 'How long to debounce queued statistics recalculation tasks to prevent repeated recalculations. Set to 0 to prevent automatic recalculation.';
$string['recalculatenow'] = 'Recalculate now';
$string['recalculatenowadded'] = 'Recalculation is added to the queue.';
$string['recalculatepending'] = 'A recalculation is pending. It is scheduled to run in {$a} seconds.';
$string['recalculatependingpast'] = 'A recalculation is scheduled and should be running as soon as possible.';
