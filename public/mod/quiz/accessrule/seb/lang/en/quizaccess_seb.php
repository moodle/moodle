...
$string['seb:manage_seb_allowscreencapture'] = 'Change SEB quiz setting: Allow browser access to screen';
$string['seb:manage_seb_allowedbrowserexamkeys'] = 'Change SEB quiz setting: Allowed browser exam keys';
$string['seb:manage_seb_alloweddisplaysmaxnumber'] = 'Change SEB quiz setting: Maximum allowed displays';
...
$string['seb_allowscreencapture'] = 'Allow browser access to screen';
$string['seb_allowscreencapture_help'] = 'If enabled, the operating system\'s screen capture functionality (Print Screen key, screen recording tools) is allowed while Safe Exam Browser is running. This is required for proctoring tools such as Veyon that need access to the student\'s screen on SEB 3.10 and later. Note: enabling this setting allows exam content to be captured via screenshots.';
...
$string['seb_alloweddisplaysmaxnumber'] = 'Maximum allowed displays';
$string['seb_alloweddisplaysmaxnumber_help'] = 'Sets the maximum allowed number of connected displays (1-3).';
