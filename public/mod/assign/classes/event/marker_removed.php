...
/**
 * The mod_assign marker removed event class.
 *
 ...
 */
class marker_removed extends base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' has unallocated the user with id '{$this->other['markerid']}' as a marker " .
    ...
    public static function get_name() {
        return get_string('eventmarkerremoved', 'mod_assign');
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new coding_exception(
                'cannot call marker_removed::create() directly, use marker_removed::create_from_marker() instead.',
            );
        }
