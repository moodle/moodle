...
$string['assign:manageoptionalallocations'] = 'Manage optional markers allocated to submissions';
$string['assign:manageoverrides'] = 'Manage assignment overrides';
$string['assign:managerestrictedgrades'] = 'Manage grades that are restricted by multiple marking requirements';
...
$string['enableoptionalmarker'] = 'Enable optional marker';
...
$string['eventagreedgradecalculated'] = 'Agreed grade calculated';
...
$string['gradingrestricted'] = 'Grading is restricted until all markers have completed marking.';
...
$string['markercount'] = 'Number of required markers';
$string['markercount_help'] = 'The number of required markers for the assignment. This does not include optional markers.';
$string['markercountdecreasevalidation'] = 'Cannot reduce required marker count as it will remove allocated markers.';
...
$string['markinginprogresswarning'] = 'You have marks that have been entered but not set as "Marking completed". Only marks in this state are eligible for grade calculations.';
...
$string['maxmarkercount'] = 'Maximum required markers limit';
$string['maxmarkercount_help'] = 'The maximum number of required markers that can be selected for an assignment.';
$string['maxoptionalmarkercount'] = 'Maximum optional markers limit';
$string['maxoptionalmarkercount_help'] = 'The maximum number of optional markers that can be selected for an assignment.';
...
$string['multimarkupdate'] = 'Update agreed grades';
$string['multimarkupdate:clear'] = 'Clear agreed grades';
$string['multimarkupdate:clear_help'] = 'Clear the agreed grade for all latest attempts.';
$string['multimarkupdate:none'] = 'Keep current agreed grades';
$string['multimarkupdate:none_help'] = 'Keep the current agreed grades until a mark or marker allocation is updated.';
$string['multimarkupdate:recalculate'] = 'Recalculate agreed grades';
$string['multimarkupdate:recalculate_help'] = 'Recalculate the agreed grade for all latest attempts using the selected strategy.';
$string['multimarkupdatecalculatevalidation'] = 'You must choose whether to update existing agreed grades when changing multiple marking calculation settings.';
$string['multimarkupdateenable'] = 'Some grades have already been awarded. If you wish to enable multiple marking, you must choose how these will be handled as agreed grades.';
$string['multimarkupdatemarkervalidation'] = 'You must choose whether to update the existing agreed grades when increasing the number of required markers.';
$string['multimarkupdatemessage'] = 'Some agreed grades have already been determined. If you wish to change the calculation method or increase grade requirements, you must choose how to update existing agreed grades.';
...
$string['optionalmarkercount'] = 'Number of optional markers';
$string['optionalmarkercount_help'] = 'The number of optional markers for the assignment.';
$string['optionalmarkercountdecreasevalidation'] = 'Cannot reduce optional marker count as it will remove allocated or enabled markers.';
...
$string['privacy:metadata:markerenabled'] = 'Whether an optional marker is enabled';
$string['privacy:metadata:markeroptional'] = 'Whether the allocated marker is optional';
...
$string['quickgrading_help'] = 'Quick grading allows you to assign grades (and learning outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
