...
/**
 * The assignsubmission_kalvid submission_created event.
 *
...
/**
 * The assignsubmission_kalvid submission_created event class.
 *
 * @package    assignsubmission_kalvid
 * @since      Moodle 2.7
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_created extends \mod_assign\event\submission_created {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' created a Kaltura media submission with " .
