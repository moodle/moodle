...
$string['pluginsource:selfhosted'] = 'Self-hosted';
$string['pluginsource_desc'] = 'Select the source of the Tiny Premium plugins. If you select \'Tiny Cloud\', you will need to provide an API key. If you select \'Self-hosted\', you will need to provide a valid path to TinyMCE in the <a href="{$a}">TinyMCE General settings</a> page.';
...
$string['premium:usemarkdown'] = 'Use TinyMCE Premium Markdown';
...
$string['premiumplugin:markdown'] = 'Markdown';
