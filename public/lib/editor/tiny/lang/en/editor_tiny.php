...
$string['package_source'] = 'TinyMCE source';
$string['package_source_desc'] = 'Choose which TinyMCE editor to use. The \'Built-in\' option uses the version that comes with Moodle. The \'Self-hosted\' option lets you specify your own TinyMCE version.';
$string['package_source_shipped'] = 'Built-in';
