...
/**
 * Tests for the String module, which provides an ESM wrapper around the AMD
 * core/str module for loading Moodle language strings.
 *
...
describe('getString', () => {
    it('returns the string resolved by get_string', async() => {
