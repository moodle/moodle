 ...
 *   $locations = $firebasedataconnectService->projects_locations;
 *  </code>
 */
...
class_alias(ProjectsLocations::class, 'Google_Service_FirebaseDataConnect_Resource_ProjectsLocations');
