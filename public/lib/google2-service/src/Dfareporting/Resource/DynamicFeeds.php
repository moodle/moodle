...
class DynamicFeeds extends \Google\Service\Resource
{
  ...
  {
    $params = ['dynamicFeedId' => $dynamicFeedId];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], DynamicFeed::class);
  }
  /**
  ...
  public function update(DynamicFeed $postBody, $optParams = [])
  {
    $params = ['postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('update', [$params], DynamicFeed::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(DynamicFeeds::class, 'Google_Service_Dfareporting_Resource_DynamicFeeds');
