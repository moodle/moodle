...
class GoogleCloudPaymentsResellerSubscriptionV1SuspendSubscriptionResponse extends \Google\Model
{
...
class_alias(GoogleCloudPaymentsResellerSubscriptionV1SuspendSubscriptionResponse::class, 'Google_Service_PaymentsResellerSubscription_GoogleCloudPaymentsResellerSubscriptionV1SuspendSubscriptionResponse');
