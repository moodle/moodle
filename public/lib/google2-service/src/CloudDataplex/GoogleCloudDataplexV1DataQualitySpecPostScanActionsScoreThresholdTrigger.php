...
class_alias(GoogleCloudDataplexV1DataQualitySpecPostScanActionsScoreThresholdTrigger::class, 'Google_Service_CloudDataplex_GoogleCloudDataplexV1DataQualitySpecPostScanActionsScoreThresholdTrigger');
