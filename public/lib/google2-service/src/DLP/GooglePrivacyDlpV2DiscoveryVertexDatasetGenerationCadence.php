...
class_alias(GooglePrivacyDlpV2DiscoveryVertexDatasetGenerationCadence::class, 'Google_Service_DLP_GooglePrivacyDlpV2DiscoveryVertexDatasetGenerationCadence');
