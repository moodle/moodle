...
class GoogleCloudApigeeV1ListSecurityFeedbackResponse extends \Google\Collection
{
  ...
  protected $securityFeedbackType = GoogleCloudApigeeV1SecurityFeedback::class;
   ...
   */
  public function getSecurityFeedback()
  {
    return $this->securityFeedback;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudApigeeV1ListSecurityFeedbackResponse::class, 'Google_Service_Apigee_GoogleCloudApigeeV1ListSecurityFeedbackResponse');
