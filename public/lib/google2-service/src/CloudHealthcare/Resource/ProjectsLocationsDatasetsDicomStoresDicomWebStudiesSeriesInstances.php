...
class ProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstances extends \Google\Service\Resource
{
  ...
  public function getStorageInfo($resource, $optParams = [])
  {
    ...
    return $this->call('getStorageInfo', [$params], StorageInfo::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstances::class, 'Google_Service_CloudHealthcare_Resource_ProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstances');
