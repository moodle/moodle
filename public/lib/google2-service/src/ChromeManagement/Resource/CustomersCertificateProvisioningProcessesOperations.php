...
class_alias(CustomersCertificateProvisioningProcessesOperations::class, 'Google_Service_ChromeManagement_Resource_CustomersCertificateProvisioningProcessesOperations');
