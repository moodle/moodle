 ...
 *   $projects = $videointelligenceService->operations_projects;
 *  </code>
 */
...
class_alias(OperationsProjects::class, 'Google_Service_CloudVideoIntelligence_Resource_OperationsProjects');
