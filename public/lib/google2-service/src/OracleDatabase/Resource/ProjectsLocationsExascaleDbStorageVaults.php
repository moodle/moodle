...
class ProjectsLocationsExascaleDbStorageVaults extends \Google\Service\Resource
{
  ...
  public function get($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], ExascaleDbStorageVault::class);
  }
  /**
  ...
  public function listProjectsLocationsExascaleDbStorageVaults($parent, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], ListExascaleDbStorageVaultsResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProjectsLocationsExascaleDbStorageVaults::class, 'Google_Service_OracleDatabase_Resource_ProjectsLocationsExascaleDbStorageVaults');
