 ...
 *   $logs = $loggingService->projects_logs;
 *  </code>
 */
class ProjectsLogs extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLogs::class, 'Google_Service_Logging_Resource_ProjectsLogs');
