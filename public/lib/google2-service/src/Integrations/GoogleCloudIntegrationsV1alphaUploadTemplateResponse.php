...
class_alias(GoogleCloudIntegrationsV1alphaUploadTemplateResponse::class, 'Google_Service_Integrations_GoogleCloudIntegrationsV1alphaUploadTemplateResponse');
