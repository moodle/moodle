...
class_alias(GoogleCloudIntegrationsV1alphaChangeCustomerConfigResponse::class, 'Google_Service_Integrations_GoogleCloudIntegrationsV1alphaChangeCustomerConfigResponse');
