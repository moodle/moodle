...
class GoogleCloudIntegrationsV1alphaUploadTestCaseRequest extends \Google\Model
{
  /**
...
class_alias(GoogleCloudIntegrationsV1alphaUploadTestCaseRequest::class, 'Google_Service_Integrations_GoogleCloudIntegrationsV1alphaUploadTestCaseRequest');
