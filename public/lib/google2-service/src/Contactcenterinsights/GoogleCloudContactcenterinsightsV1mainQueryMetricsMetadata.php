...
class GoogleCloudContactcenterinsightsV1mainQueryMetricsMetadata extends \Google\Model
{
  /**
...
class_alias(GoogleCloudContactcenterinsightsV1mainQueryMetricsMetadata::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1mainQueryMetricsMetadata');
