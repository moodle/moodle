...
class GoogleCloudContactcenterinsightsV1QueryMetricsResponse extends \Google\Collection
{
   ...
   */
  public $location;
  protected $macroAverageSliceType = GoogleCloudContactcenterinsightsV1QueryMetricsResponseSlice::class;
  ...
  /**
   * @return GoogleCloudContactcenterinsightsV1QueryMetricsResponseSlice
   */
...
class_alias(GoogleCloudContactcenterinsightsV1QueryMetricsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1QueryMetricsResponse');
