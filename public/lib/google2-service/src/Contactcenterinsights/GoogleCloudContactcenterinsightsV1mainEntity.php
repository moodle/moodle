...
class GoogleCloudContactcenterinsightsV1mainEntity extends \Google\Model
{
  /**
   * Unspecified.
   */
...
class_alias(GoogleCloudContactcenterinsightsV1mainEntity::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1mainEntity');
