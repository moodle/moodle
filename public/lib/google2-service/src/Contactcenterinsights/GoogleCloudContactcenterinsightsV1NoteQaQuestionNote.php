...
class_alias(GoogleCloudContactcenterinsightsV1NoteQaQuestionNote::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1NoteQaQuestionNote');
