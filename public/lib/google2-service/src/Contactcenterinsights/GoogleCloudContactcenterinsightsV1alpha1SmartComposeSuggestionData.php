...
class GoogleCloudContactcenterinsightsV1alpha1SmartComposeSuggestionData extends \Google\Model
{
  /**
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1SmartComposeSuggestionData::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1SmartComposeSuggestionData');
