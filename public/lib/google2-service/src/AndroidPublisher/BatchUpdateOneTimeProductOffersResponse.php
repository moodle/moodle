...
class BatchUpdateOneTimeProductOffersResponse extends \Google\Collection
{
...
class_alias(BatchUpdateOneTimeProductOffersResponse::class, 'Google_Service_AndroidPublisher_BatchUpdateOneTimeProductOffersResponse');
