...
class BatchUpdateSubscriptionOfferStatesResponse extends \Google\Collection
{
...
class_alias(BatchUpdateSubscriptionOfferStatesResponse::class, 'Google_Service_AndroidPublisher_BatchUpdateSubscriptionOfferStatesResponse');
