...
class ListOneTimeProductsResponse extends \Google\Collection
{
...
class_alias(ListOneTimeProductsResponse::class, 'Google_Service_AndroidPublisher_ListOneTimeProductsResponse');
