...
class ListServiceProjectAttachmentsResponse extends \Google\Collection
{
...
class_alias(ListServiceProjectAttachmentsResponse::class, 'Google_Service_AppHub_ListServiceProjectAttachmentsResponse');
