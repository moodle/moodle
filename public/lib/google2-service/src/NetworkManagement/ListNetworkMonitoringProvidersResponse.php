...
class ListNetworkMonitoringProvidersResponse extends \Google\Collection
{
  ...
  {
    $this->networkMonitoringProviders = $networkMonitoringProviders;
  }
  /**
...
class_alias(ListNetworkMonitoringProvidersResponse::class, 'Google_Service_NetworkManagement_ListNetworkMonitoringProvidersResponse');
