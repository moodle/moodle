 ...
 *   $catalogs = $biglakeService->projects_catalogs;
 *  </code>
 */
class ProjectsCatalogs extends \Google\Service\Resource
{
  /**
   * Gets the IAM policy for the specified Catalog. (catalogs.getIamPolicy)
   *
...
class_alias(ProjectsCatalogs::class, 'Google_Service_BigLakeService_Resource_ProjectsCatalogs');
