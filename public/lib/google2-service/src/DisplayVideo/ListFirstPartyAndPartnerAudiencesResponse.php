...
class ListFirstPartyAndPartnerAudiencesResponse extends \Google\Collection
{
  ...
  {
    $this->firstPartyAndPartnerAudiences = $firstPartyAndPartnerAudiences;
  }
  /**
...
class_alias(ListFirstPartyAndPartnerAudiencesResponse::class, 'Google_Service_DisplayVideo_ListFirstPartyAndPartnerAudiencesResponse');
