...
class RegionQuotaStatusWarningData extends \Google\Model
{
  /**
...
class_alias(RegionQuotaStatusWarningData::class, 'Google_Service_Compute_RegionQuotaStatusWarningData');
