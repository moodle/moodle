...
class TargetPoolAggregatedListWarningData extends \Google\Model
{
  /**
...
class_alias(TargetPoolAggregatedListWarningData::class, 'Google_Service_Compute_TargetPoolAggregatedListWarningData');
