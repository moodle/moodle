...
class_alias(SecurityPoliciesListPreconfiguredExpressionSetsResponse::class, 'Google_Service_Compute_SecurityPoliciesListPreconfiguredExpressionSetsResponse');
