...
class HttpsHealthCheckListWarningData extends \Google\Model
{
  /**
...
class_alias(HttpsHealthCheckListWarningData::class, 'Google_Service_Compute_HttpsHealthCheckListWarningData');
