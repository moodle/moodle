...
class TargetVpnGatewayListWarningData extends \Google\Model
{
  /**
...
class_alias(TargetVpnGatewayListWarningData::class, 'Google_Service_Compute_TargetVpnGatewayListWarningData');
