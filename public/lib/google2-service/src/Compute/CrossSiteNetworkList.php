...
class CrossSiteNetworkList extends \Google\Collection
{
   ...
   */
  public $unreachables;
  protected $warningType = CrossSiteNetworkListWarning::class;
   ...
   *
   * @param CrossSiteNetworkListWarning $warning
   */
  public function setWarning(CrossSiteNetworkListWarning $warning)
  {
    $this->warning = $warning;
  }
  /**
   * @return CrossSiteNetworkListWarning
   */
...
class_alias(CrossSiteNetworkList::class, 'Google_Service_Compute_CrossSiteNetworkList');
