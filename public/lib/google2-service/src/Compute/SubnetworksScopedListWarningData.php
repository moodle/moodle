...
class SubnetworksScopedListWarningData extends \Google\Model
{
  /**
...
class_alias(SubnetworksScopedListWarningData::class, 'Google_Service_Compute_SubnetworksScopedListWarningData');
