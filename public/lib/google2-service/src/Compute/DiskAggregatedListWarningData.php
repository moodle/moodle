...
class DiskAggregatedListWarningData extends \Google\Model
{
  /**
...
class_alias(DiskAggregatedListWarningData::class, 'Google_Service_Compute_DiskAggregatedListWarningData');
