...
class ForwardingRulesScopedListWarningData extends \Google\Model
{
  /**
...
class_alias(ForwardingRulesScopedListWarningData::class, 'Google_Service_Compute_ForwardingRulesScopedListWarningData');
