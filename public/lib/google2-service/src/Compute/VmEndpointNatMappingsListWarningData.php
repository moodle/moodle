...
class VmEndpointNatMappingsListWarningData extends \Google\Model
{
  /**
...
class_alias(VmEndpointNatMappingsListWarningData::class, 'Google_Service_Compute_VmEndpointNatMappingsListWarningData');
