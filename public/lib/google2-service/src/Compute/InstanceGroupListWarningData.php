...
class InstanceGroupListWarningData extends \Google\Model
{
  /**
...
class_alias(InstanceGroupListWarningData::class, 'Google_Service_Compute_InstanceGroupListWarningData');
