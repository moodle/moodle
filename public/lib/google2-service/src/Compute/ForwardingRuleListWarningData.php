...
class ForwardingRuleListWarningData extends \Google\Model
{
  /**
...
class_alias(ForwardingRuleListWarningData::class, 'Google_Service_Compute_ForwardingRuleListWarningData');
