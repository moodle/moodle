...
class DiskTypesScopedListWarningData extends \Google\Model
{
  /**
...
class_alias(DiskTypesScopedListWarningData::class, 'Google_Service_Compute_DiskTypesScopedListWarningData');
