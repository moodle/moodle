...
class InterconnectGroupConfiguredTopologyCapability extends \Google\Collection
{
  ...
  {
    return $this->supportedSla;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(InterconnectGroupConfiguredTopologyCapability::class, 'Google_Service_Compute_InterconnectGroupConfiguredTopologyCapability');
