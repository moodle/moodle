...
class SearchSparkApplicationStagesResponse extends \Google\Collection
{
...
class_alias(SearchSparkApplicationStagesResponse::class, 'Google_Service_Dataproc_SearchSparkApplicationStagesResponse');
