...
class UpdateInboundSamlSsoProfileOperationMetadata extends \Google\Model
{
  /**
...
class_alias(UpdateInboundSamlSsoProfileOperationMetadata::class, 'Google_Service_CloudIdentity_UpdateInboundSamlSsoProfileOperationMetadata');
