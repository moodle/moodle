...
class GoogleCloudDocumentaiV1beta3ProcessorVersion extends \Google\Model
{
   ...
   * version.
   *
   * @param GoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfo $deprecationInfo
   */
   ...
   *
   * @param GoogleCloudDocumentaiV1beta3DocumentSchema $documentSchema
   */
   ...
   * versions.
   *
   * @param GoogleCloudDocumentaiV1beta3ProcessorVersionGenAiModelInfo $genAiModelInfo
   */
   ...
   * version.
   *
   * @param GoogleCloudDocumentaiV1beta3EvaluationReference $latestEvaluation
   */
