...
class_alias(GoogleCloudDocumentaiV1DocumentRevisionHumanReview::class, 'Google_Service_Contentwarehouse_GoogleCloudDocumentaiV1DocumentRevisionHumanReview');
