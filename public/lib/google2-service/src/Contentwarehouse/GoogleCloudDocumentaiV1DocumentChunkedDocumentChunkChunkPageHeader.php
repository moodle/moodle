...
class_alias(GoogleCloudDocumentaiV1DocumentChunkedDocumentChunkChunkPageHeader::class, 'Google_Service_Contentwarehouse_GoogleCloudDocumentaiV1DocumentChunkedDocumentChunkChunkPageHeader');
