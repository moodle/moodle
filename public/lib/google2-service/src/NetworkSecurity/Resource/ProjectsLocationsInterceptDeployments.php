...
use Google\Service\NetworkSecurity\InterceptDeployment;
use Google\Service\NetworkSecurity\ListInterceptDeploymentsResponse;
 ...
 *   $interceptDeployments = $networksecurityService->projects_locations_interceptDeployments;
 *  </code>
 */
class ProjectsLocationsInterceptDeployments extends \Google\Service\Resource
{
  /**
   * Creates a deployment in a given project and location. See
   * https://google.aip.dev/133. (interceptDeployments.create)
   *
   * @param string $parent Required. The parent resource where this deployment
   * will be created. Format: projects/{project}/locations/{location}
   * @param InterceptDeployment $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string interceptDeploymentId Required. The ID to use for the new
   ...
   */
  public function create($parent, InterceptDeployment $postBody, $optParams = [])
  {
   ...
   * projects/{project}/locations/{location}/interceptDeployments/{intercept_deplo
   * yment}
   * @param array $optParams Optional parameters.
  ...
  public function get($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], InterceptDeployment::class);
  }
  /**
   * Lists deployments in a given project and location. See
   * https://google.aip.dev/132.
   * (interceptDeployments.listProjectsLocationsInterceptDeployments)
   *
   ...
   * `ListInterceptDeployments` must match the call that provided the page token.
   * See https://google.aip.dev/158 for more details.
   * @return ListInterceptDeploymentsResponse
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsInterceptDeployments($parent, $optParams = [])
  {
    $params = ['parent' => $parent];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], ListInterceptDeploymentsResponse::class);
  }
  /**
   * Updates a deployment. See https://google.aip.dev/134.
   * (interceptDeployments.patch)
   *
   * @param string $name Immutable. Identifier. The resource name of this
   * deployment, for example: `projects/123456789/locations/us-
   * central1-a/interceptDeployments/my-dep`. See https://google.aip.dev/122 for
   * more details.
   * @param InterceptDeployment $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * `intercept_deployment.description`). See https://google.aip.dev/161 for more
   * details.
   * @return Operation
   * @throws \Google\Service\Exception
   */
  public function patch($name, InterceptDeployment $postBody, $optParams = [])
  {
...
class_alias(ProjectsLocationsInterceptDeployments::class, 'Google_Service_NetworkSecurity_Resource_ProjectsLocationsInterceptDeployments');
