...
class InterceptEndpointGroupAssociationDetails extends \Google\Model
{
  /**
   * Not set.
   */
...
class_alias(InterceptEndpointGroupAssociationDetails::class, 'Google_Service_NetworkSecurity_InterceptEndpointGroupAssociationDetails');
