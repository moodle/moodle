...
class ListInterceptDeploymentsResponse extends \Google\Collection
{
  ...
  {
    $this->interceptDeployments = $interceptDeployments;
  }
  /**
  ...
  {
    return $this->interceptDeployments;
  }
  /**
   * A token that can be sent as `page_token` to retrieve the next page. If this
   * field is omitted, there are no subsequent pages. See
...
class_alias(ListInterceptDeploymentsResponse::class, 'Google_Service_NetworkSecurity_ListInterceptDeploymentsResponse');
