...
class GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec extends \Google\Collection
{
  /**
  ...
  protected $controlPointsType = GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpecControlPoint::class;
   ...
   *
   * @param GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpecControlPoint[] $controlPoints
   */
  ...
  /**
   * @return GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpecControlPoint[]
   */
...
class_alias(GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec');
