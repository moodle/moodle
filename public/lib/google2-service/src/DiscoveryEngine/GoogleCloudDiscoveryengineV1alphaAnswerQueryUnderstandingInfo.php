...
class_alias(GoogleCloudDiscoveryengineV1alphaAnswerQueryUnderstandingInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaAnswerQueryUnderstandingInfo');
