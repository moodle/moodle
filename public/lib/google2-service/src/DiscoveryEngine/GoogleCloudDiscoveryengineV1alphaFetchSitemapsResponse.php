...
class GoogleCloudDiscoveryengineV1alphaFetchSitemapsResponse extends \Google\Collection
{
  ...
  {
    $this->sitemapsMetadata = $sitemapsMetadata;
  }
  /**
  ...
  {
    return $this->sitemapsMetadata;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleCloudDiscoveryengineV1alphaFetchSitemapsResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaFetchSitemapsResponse');
