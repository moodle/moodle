...
class GoogleCloudDiscoveryengineV1NaturalLanguageQueryUnderstandingConfig extends \Google\Model
{
  /**
   * Default value.
   */
...
class_alias(GoogleCloudDiscoveryengineV1NaturalLanguageQueryUnderstandingConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1NaturalLanguageQueryUnderstandingConfig');
