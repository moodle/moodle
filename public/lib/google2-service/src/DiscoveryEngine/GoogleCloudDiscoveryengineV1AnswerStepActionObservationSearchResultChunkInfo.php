...
class_alias(GoogleCloudDiscoveryengineV1AnswerStepActionObservationSearchResultChunkInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1AnswerStepActionObservationSearchResultChunkInfo');
