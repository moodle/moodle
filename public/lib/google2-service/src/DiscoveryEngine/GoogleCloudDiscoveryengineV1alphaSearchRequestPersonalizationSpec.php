...
class_alias(GoogleCloudDiscoveryengineV1alphaSearchRequestPersonalizationSpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaSearchRequestPersonalizationSpec');
