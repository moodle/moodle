...
class_alias(GoogleCloudDiscoveryengineV1ImportUserEventsResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ImportUserEventsResponse');
