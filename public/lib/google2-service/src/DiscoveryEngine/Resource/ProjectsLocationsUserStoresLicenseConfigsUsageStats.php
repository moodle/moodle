...
class ProjectsLocationsUserStoresLicenseConfigsUsageStats extends \Google\Service\Resource
{
  ...
  public function listProjectsLocationsUserStoresLicenseConfigsUsageStats($parent, $optParams = [])
  {
    ...
    return $this->call('list', [$params], GoogleCloudDiscoveryengineV1ListLicenseConfigsUsageStatsResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProjectsLocationsUserStoresLicenseConfigsUsageStats::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsUserStoresLicenseConfigsUsageStats');
