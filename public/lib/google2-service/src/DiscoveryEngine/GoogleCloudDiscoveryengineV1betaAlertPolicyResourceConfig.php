...
class_alias(GoogleCloudDiscoveryengineV1betaAlertPolicyResourceConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaAlertPolicyResourceConfig');
