...
class_alias(GoogleCloudBeyondcorpSecuritygatewaysV1SetPeeringRequest::class, 'Google_Service_BeyondCorp_GoogleCloudBeyondcorpSecuritygatewaysV1SetPeeringRequest');
