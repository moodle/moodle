 ...
 */
class phpunit_util extends \core\test\testing_util {
    /**
    ...
    public static function initialise_cfg() {
        ...
        if ($dbhash !== \core\component::get_all_versions_hash()) {
    ...
    public static function reset_all_data($detectchanges = false) {
        ...
        \core\di::get(\core\hook\manager::class)->phpunit_stop_redirections();
        ...
        if (class_exists(\availability_date\condition::class, false)) {
...
class_alias(phpunit_util::class, \phpunit_util::class);
