 ...
 */
class course_restricted_module_viewed extends \core\event\course_module_viewed {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' viewed the restricted '{$cm->modname}' activity with " .
    ...
    public static function get_name() {
        return get_string('eventcourserestrictedmoduleviewed', 'core');
    }
