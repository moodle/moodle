...
$string['courseorder_help'] = 'Agregue cursos a continuación y configure el orden, los días para completar y el calendario de recordatorios para cada uno. Cambie el número de orden para reorganizar los cursos.';
$string['duedays'] = 'Días para Completar';
$string['order'] = 'Orden';
$string['addcourse'] = 'Agregar Curso';
$string['nocourses'] = 'No se han agregado cursos aún. Use el menú desplegable de arriba para agregar cursos.';
$string['coursealreadyadded'] = 'Este curso ya ha sido agregado al plan.';
$string['reminders_help_short'] = 'Recordatorios: días separados por comas antes del vencimiento (ej., "7, 3, 1" = recordatorios 7, 3 y 1 días antes de la fecha límite)';
