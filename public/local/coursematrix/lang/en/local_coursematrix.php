...
$string['courseorder_help'] = 'Add courses below and configure the order, days to complete, and reminder schedule for each. Change the order number to rearrange courses.';
$string['duedays'] = 'Days to Complete';
$string['order'] = 'Order';
$string['addcourse'] = 'Add Course';
$string['nocourses'] = 'No courses added yet. Use the dropdown above to add courses.';
$string['coursealreadyadded'] = 'This course has already been added to the plan.';
$string['reminders_help_short'] = 'Reminders: comma-separated days before due (e.g., "7, 3, 1" = reminders 7, 3, and 1 days before due date)';
