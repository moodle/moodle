...
final class week_test extends core_reportbuilder_testcase {
    ...
    public function test_column_aggregation(): void {
        ...
        // Test subjects, spanning two weeks (Monday start is the default).
        ...
        $this->getDataGenerator()->create_user(['firstname' => 'Charlie', 'lastaccess' => 1623146400]);
        ...
        // Week aggregation requires other columns to be aggregated to make any sense.
        $generator->create_column([
            'reportid' => $report->get('id'),
        ...
        $this->assertEquals([
            ['Monday, 29 December 1969', 'Admin'],
            ['Monday, 31 May 2021', 'Andy, Bob'],
            ['Monday, 7 June 2021', 'Charlie'],
