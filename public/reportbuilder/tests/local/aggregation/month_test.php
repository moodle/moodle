...
final class month_test extends core_reportbuilder_testcase {
    ...
    public function test_column_aggregation(): void {
        ...
        // Test subjects, spanning two months.
        $this->getDataGenerator()->create_user(['firstname' => 'Andy', 'lastaccess' => 1621072800]);
        ...
        // Month aggregation requires other columns to be aggregated to make any sense.
        $generator->create_column([
            'reportid' => $report->get('id'),
