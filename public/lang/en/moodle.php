...
$string['oauth2:confirmscopes:title'] = 'Confirm scopes';
...
$string['oauth2:confirmscopes:reviewpolicies'] = 'Review {$a->clientname} <a href="{$a->clientprivacypolicy}">Privacy Policy</a> and <a href="{$a->clienttermsofservice}">Terms of Service</a> to understand how {$a->clientname} will process and protect your data.';
...
$string['oauth2:contineasuser'] = 'Continue as {$a}';
$string['oauth2:contineasuser:changeuser'] = 'Change user';
$string['ok'] = 'OK';
...
$string['privacy:metadata:oauth2_server_client_access_tokens:userid'] = 'The ID of the user which owns the access token';
...
$string['privacy:metadata:oauth2_server_client_auth_codes:userid'] = 'The ID of the user which owns the authorisation code';
...
$string['privacy:metadata:oauth2_server_client_granted_scopes:userid'] = 'The ID of the user which owns the granted scopes';
$string['privacy:metadata:rest_api_tokens'] = 'Personal Access Tokens used for communication with external services';
$string['privacy:metadata:rest_api_tokens:userid'] = 'The ID of the user which owns a Personal Access Token';
