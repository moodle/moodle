...
$string['apitokenexpiryinpast'] = 'The token expiry date must be in the future.';
$string['apitokenexpirytoofar'] = 'The token expiry date must be no more than one year from today.';
$string['apitokennoscopes'] = 'Select at least one scope for the token.';
$string['apitokenunknownscope'] = 'The scope "{$a}" is not a scope this site provides.';
...
$string['calendareventskipforbrokencoursemodule'] = 'Skipping calendar update for broken {$a->modulename} instance {$a->instance} in course {$a->course}, cm {$a->cm}.';
$string['calendareventskipformissingcourse'] = 'Skipping calendar update for non-existing course (id={$a}).';
...
$string['expiredapitoken'] = 'Expired API key';
...
$string['invalidapitoken'] = 'Invalid API key';
...
$string['revokedapitoken'] = 'Revoked API key';
