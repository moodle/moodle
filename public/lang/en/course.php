...
$string['course_backup_scope_desc'] = 'Allows creation of course backups for backup and restore purposes.';
$string['course_backup_scope_summary'] = 'Create course backups';
$string['course_content_delete_scope_desc'] = 'Allows permanent deletion of content within course activities and resources.';
$string['course_content_delete_scope_summary'] = 'Permanently delete content within course activities and resources';
...
$string['course_content_write_scope_desc'] = 'Allows access to create and modify content within course activities and resources.';
$string['course_content_write_scope_summary'] = 'Create and modify content within course activities and resources';
$string['course_delete_scope_desc'] = 'Allows permanent deletion of courses and course categories.';
$string['course_delete_scope_summary'] = 'Permanently delete courses and course categories';
$string['course_read_scope_desc'] = 'Allows read-only access to the course and course category catalog across the site including related metadata.';
$string['course_read_scope_summary'] = 'View courses and course categories';
$string['course_restore_scope_desc'] = 'Allows access to restore courses from backups.';
$string['course_restore_scope_summary'] = 'Restore courses';
$string['course_structure_delete_scope_desc'] = 'Allows access to delete course structure entities like course sections, activities, and resources.';
$string['course_structure_delete_scope_summary'] = 'Delete course sections, activities, and resources';
$string['course_structure_read_scope_desc'] = 'Allows read-only access to course structure (sections, activities, and resources)';
$string['course_structure_read_scope_summary'] = 'View course sections, activities, and resources';
$string['course_structure_write_scope_desc'] = 'Allows access to create and modify course structure entities like sections, activities, and resources.';
$string['course_structure_write_scope_summary'] = 'Manage course sections, activities, and resources';
$string['course_write_scope_desc'] = 'Allows creation of courses and course categories, as well as updating existing course and category metadata and related settings.';
$string['course_write_scope_summary'] = 'Create and update courses and course categories';
...
$string['resetinprogress'] = 'A reset is already in progress for this course.';
$string['resetinprogressedit'] = 'There is a pending reset requested for this course. Please do not edit the course until this is complete.';
