...
$string['enrolment_delete_scope_desc'] = 'Allows unenrolment of users from the course, removal of enrolment methods, and removal of role assignments.';
$string['enrolment_delete_scope_summary'] = 'Delete course enrolments';
$string['enrolment_read_scope_desc'] = 'Allows read-only access to retrieve lists of enrolled users, active enrolment methods, role assignments, and enrolment statuses.';
$string['enrolment_read_scope_summary'] = 'View course enrolments';
$string['enrolment_write_scope_desc'] = 'Allows access to enrol users to courses, change enrolment methods, and change role assignments.';
$string['enrolment_write_scope_summary'] = 'Manage enrolments';
