...
$string['addoutcomeitem'] = 'Add learning outcome item';
...
$string['aggregateoutcomes'] = 'Include learning outcomes in aggregation';
$string['aggregateoutcomes_help'] = 'If enabled, learning outcomes are included in the aggregation. This may result in an unexpected category total.';
...
$string['editoutcomes'] = 'Edit learning outcomes';
$string['editscale'] = 'Edit scale';
$string['edittree'] = 'Setup';
$string['enableoutcomes'] = 'Enable learning outcomes';
$string['enableoutcomes_help'] = 'If enabled, grade items may be graded using one or more scales tied to learning outcome statements.';
...
$string['errorupdatinggradecategoryaggregateoutcomes'] = 'Error updating the "Include learning outcomes in aggregation" setting of grade category ID {$a->id}';
...
$string['exportalloutcomes'] = 'Export all learning outcomes';
...
$string['grade_read_scope_desc'] = 'Allows read-only access to the gradebook including grades, grade items, grade categories and feedback comments.';
$string['grade_read_scope_summary'] = 'View gradebook';
$string['grade_write_scope_desc'] = 'Allows access to create and update grade items, categories, and feedback comments, as well as override student grades.';
$string['grade_write_scope_summary'] = 'Manage gradebook';
...
$string['gradeoutcomeitem'] = 'Grade learning outcome item';
$string['gradeoutcomes'] = 'Learning outcomes';
$string['gradeoutcomescourses'] = 'Course learning outcomes';
...
$string['hidenooutcomes'] = 'Show learning outcomes';
...
$string['importcustom'] = 'Import as course learning outcomes';
...
$string['importoutcomes'] = 'Import learning outcomes';
$string['importoutcomes_help'] = 'Learning outcomes can be imported via CSV file, which must follow the same format used by the learning outcomes export CSV file.';
$string['importoutcomes_link'] = 'grade/outcome';
$string['importoutcomesuccess'] = 'Imported learning outcome "{$a->name}" with ID #{$a->id}';
$string['importplugins'] = 'Import plugins';
$string['importpreview'] = 'Import preview';
$string['importsettings'] = 'Import settings';
$string['importskippednomanagescale'] = 'You don\'t have permission to add a new scale, so learning outcome "{$a}" was skipped as it required creating a new scale';
$string['importskippedoutcome'] = 'A learning outcome with shortname "{$a}" already exists in this context, the one in the imported file was skipped.';
$string['importstandard'] = 'Import as site-wide learning outcomes';
...
$string['linkedactivity_help'] = 'This setting specifies an activity to which this learning outcome item is linked. This may be used to measure student performance on criteria not assessed by the activity grade.';
...
$string['newoutcomeitem'] = 'New learning outcome item';
$string['no'] = 'No';
...
$string['noexistingoutcomes'] = 'There are no existing learning outcomes.';
...
$string['nooutcome'] = 'No learning outcome';
$string['nooutcomes'] = 'Learning outcome items must be linked to a course learning outcome, but there are no learning outcomes for this course. Would you like to add one?';
...
$string['outcome'] = 'Learning outcome';
$string['outcome_help'] = 'This setting determines the learning outcome which this grade item will represent in the gradebook.';
$string['outcomeassigntocourse'] = 'Assign another learning outcome to this course';
$string['outcomecategory'] = 'Create learning outcomes in category';
$string['outcomecategorynew'] = 'New category';
$string['outcomeconfirmdelete'] = 'Are you sure you wish to delete the learning outcome "{$a}"?';
$string['outcomecreate'] = 'Add a new learning outcome';
$string['outcomedelete'] = 'Delete learning outcome';
$string['outcomefullname'] = 'Full name';
$string['outcomeitem'] = 'Learning outcome item';
$string['outcomeitemsedit'] = 'Edit learning outcome item';
$string['outcomereport'] = 'Learning outcomes report';
$string['outcomes'] = 'Learning outcomes';
$string['outcomescourse'] = 'Learning outcomes assigned to this course';
$string['outcomescoursecustom'] = 'Course learning outcomes in use (cannot be removed)';
$string['outcomescoursenotused'] = 'Site-wide learning outcomes not in use';
$string['outcomescourseused'] = 'Site-wide learning outcomes in use (cannot be removed)';
$string['outcomescustom'] = 'Course learning outcomes';
$string['outcomesdisabled'] = 'Learning outcomes are not enabled';
$string['outcomeshortname'] = 'Short name';
$string['outcomesstandard'] = 'Site-wide learning outcomes';
$string['outcomesstandardavailable'] = 'Available site-wide learning outcomes';
$string['outcomestandard'] = 'Site-wide learning outcome';
$string['outcomestandard_help'] = 'A site-wide learning outcome is available for all courses.';
...
$string['privacy:metadata:outcomes'] = 'A record of learning outcomes';
...
$string['privacy:metadata:outcomes_modules'] = 'A record of outcome-module associations';
$string['privacy:metadata:outcomes_modules:timecreated'] = 'The time when the outcome-module association was created';
$string['privacy:metadata:outcomes_modules:usercreated'] = 'The user who created the outcome-module association';
$string['privacy:metadata:outcomeshistory'] = 'A record of previous versions of learning outcomes';
...
$string['shownooutcomes'] = 'Hide learning outcomes';
...
$string['usenooutcome'] = 'Use no learning outcome';
...
$string['verbosescales_help'] = 'A verbose scale uses words rather than numbers. Set to \'Yes\' if verbose scales are to be imported. Set to \'No\' if only numerical scales are to be imported.';
