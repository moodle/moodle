...
$string['runasap'] = 'Run ASAP';
$string['runasap_confirm'] = 'Are you sure you want to run this task \'{$a}\' ASAP? The task will run via cron at the next available time.';
$string['runasaperrorrunning'] = 'This task \'{$a}\' is already running and cannot be scheduled to run ASAP.';
$string['runasapsuccess'] = 'This task \'{$a}\' has been scheduled to run ASAP.';
