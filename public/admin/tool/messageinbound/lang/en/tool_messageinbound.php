...
$string['tls'] = 'Transport Layer Security (TLS) (TLS; started via protocol-level negotiation over unencrypted channel; RECOMMENDED way of initiating secure connection)';
$string['tlsv1'] = 'Transport Layer Security (TLS) v1 (direct connection to TLS server version 1.x)';
