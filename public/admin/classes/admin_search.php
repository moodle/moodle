...
class admin_search {
    ...
    public const SEARCH_MATCH_PAGE_TITLE = 'title';

    /** @var string Search match for a setting short name. */
    public const SEARCH_MATCH_SETTING_SHORT_NAME = 'shortname';

    /** @var string Search match for a setting display name. */
    public const SEARCH_MATCH_SETTING_DISPLAY_NAME = 'displayname';

    /** @var string Search match for a setting value. */
    public const SEARCH_MATCH_SETTING_VALUE = 'value';

    /** @var string Search match for a setting helper. */
    public const SEARCH_MATCH_SETTING_HELPER = 'helper';
