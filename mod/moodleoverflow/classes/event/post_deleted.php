...
/**
 * The mod_moodleoverflow post deleted event.
 *
...
/**
 * The mod_moodleoverflow post deleted event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int discussionid: The discussion id the post is part of.
 *      - int moodleoverflowid: The moodleoverflow id the post is part of.
 * }
 *
 * @package   mod_moodleoverflow
 * @copyright 2017 Kennet Winter <k_wint10@uni-muenster.de>
