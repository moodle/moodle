...
/**
 * The mod_moodleoverflow read tracking enabled event.
 *
...
/**
 * The mod_moodleoverflow read tracking enabled event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int moodleoverflowid: The id of the moodleoverflow which readtracking has been enabled on.
 * }
 *
 * @package   mod_moodleoverflow
 * @copyright 2017 Kennet Winter <k_wint10@uni-muenster.de>
...
class readtracking_enabled extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreadtrackingenabled', 'mod_moodleoverflow');
    }
