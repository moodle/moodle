...
class restore_assignsubmission_kalvid_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_kalvid');
    ...
    /**
     * Processes one assignsubmission_kalvid element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_kalvid_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignsubmission_kalvid', $data);
    }
