...
function assign_reset_userdata($data) {
    ...
    if ($data->timeshift) {
        ...
        shift_course_mod_dates('assign', array('allowsubmissionsfromdate', 'duedate'), $data->timeshift, $data->courseid);
...
function assign_update_events($assign, $override = null) {
    ...
    foreach ($overrides as $current) {
        ...
        $allowsubmissionsfromdate  = isset($current->allowsubmissionsfromdate) ? $current->allowsubmissionsfromdate : $assign->get_context()->allowsubmissionsfromdate;
