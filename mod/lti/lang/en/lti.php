...
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the LTI activities during this analysis interval (Levels = No view, View, Submit, View feedback) <a href="{$a}Learning_analytics_indicators#Cognitive_depth" target="_blank">More info</a>';
