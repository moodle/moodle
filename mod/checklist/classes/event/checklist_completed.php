...
/**
 * The mod_checklist checklist completed event.
 *
...
/**
 * The mod_checklist checklist completed class.
 *
 * @package    mod_checklist
 * @since      Moodle 2.7
 * @copyright  2014 Davo Smith <moodle@davosmith.co.uk>
...
class checklist_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventchecklistcomplete', 'mod_checklist');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has completed the checklist with the course module id '$this->contextinstanceid'";
    }
