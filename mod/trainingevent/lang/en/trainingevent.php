...
$string['eventhaspassed'] = '<h2>This training event is no longer available</h2>';
...
$string['modulename_help'] = 'A training event is an activity which allows users to attend a face to face activity base in a physical location.  It allows for various types of access from simple click to attend to levels of approval required.';
