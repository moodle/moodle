...
/**
 * The mod_trainingevent company attendance changed event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attendance_changed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('attendance_changed', 'mod_trainingevent');
    }
