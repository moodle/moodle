...
$string['apiurl_desc'] = '';
$string['approval_type_automatic'] = 'Automatically approve';
$string['approval_type_manual'] = 'Manually approve';
$string['approval_type_none'] = 'No registration required';
...
$string['on'] = 'On';
$string['option_approval_type'] = 'Approval Type';
...
$string['option_registration_type'] = 'Registration Type';
...
$string['registration_type_any_occurrence'] = 'Attendees register once and can attend any of the occurrences.';
$string['registration_type_each_occurrence'] = 'Attendees need to register for each occurrence to attend.';
$string['registration_type_one_or_more_occurrence'] = 'Attendees register once and can choose one or more occurrences to attend.';
