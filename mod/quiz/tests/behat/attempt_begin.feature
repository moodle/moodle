...
Feature: The various checks that may happen when an attept is started
  ...
  Scenario: Start a quiz with time limit and password
    ...
    When I am on the "Quiz 1" "mod_quiz > View" page logged in as "student"
    And I follow "Attempt quiz"
    Then I should see "To attempt this quiz you need to know the quiz password" in the "region-main" "region"
    And I should see "Your attempt will have a time limit of 1 hour. When you " in the "region-main" "region"
    And I set the field "Quiz password" to "Frog"
    And I click on "Start attempt" "button" in the "region-main" "region"
  ...
  Scenario: Cancel starting a quiz with time limit and password
    ...
    And "Attempt quiz" "link" should be visible
