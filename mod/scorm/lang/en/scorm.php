...
$string['autocontinue_hlp'] = 'activate auto continue mode for the SCORM object';
...
$string['displaycoursestructure_hlp'] = 'enable the display of the course structure on the entry page';
...
$string['hidetoc'] = 'Display course structure (TOC) in player';
$string['hidetoc_hlp'] = 'control whether and how to display or hide the course structure (TOC) in the SCORM player';
