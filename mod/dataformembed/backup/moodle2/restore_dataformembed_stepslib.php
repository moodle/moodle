...
/**
 * Structure step to restore one dataformembed activity
 */
class restore_dataformembed_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function process_dataformembed($data) {
        global $DB;
