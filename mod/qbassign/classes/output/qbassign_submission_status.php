...
/**
 * This file contains the definition for the renderable qbassign submission status.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_submission_status implements \renderable {
    ...
    /** @var int The time limit for the qbassignment */
    public $timelimit = 0;
     ...
     * @param array $usergroups Array containing all groups the user is qbassigned to.
     * @param int $timelimit The time limit for the qbassignment.
     */
