...
/**
 * Cognitive depth indicator - qbassign.
 *
...
namespace mod_qbassign\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_qbassign');
    }
    ...
    protected function feedback_submitted_events() {
        return array('\mod_qbassign\event\assessable_submitted');
    }
