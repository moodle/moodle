...
/**
 * The mod_qbassign assessable submitted event.
 *
...
/**
 * The mod_qbassign assessable submitted event class.
 *
...
class assessable_submitted extends base {
     ...
     */
    public static function create_from_submission(\qbassign $qbassign, \stdClass $submission, $editable) {
        global $USER;
    ...
    public static function get_name() {
        return get_string('eventassessablesubmitted', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submit for grading', $this->qbassign->format_submission_for_log($submission));
