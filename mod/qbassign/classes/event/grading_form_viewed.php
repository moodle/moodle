...
/**
 * The mod_qbassign grading form viewed event.
 *
...
/**
 * The mod_qbassign grading form viewed event class.
 *
...
class grading_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingformviewed', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $msg = get_string('viewgradingformforstudent', 'qbassign',
