...
/**
 * The mod_qbassign user override created event.
 *
...
/**
 * The mod_qbassign user override created event class.
 *
...
class user_override_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridecreated', 'mod_qbassign');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the override with id '$this->objectid' for the qbassign with " .
