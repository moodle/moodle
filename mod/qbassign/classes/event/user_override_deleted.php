...
/**
 * The mod_qbassign user override deleted event.
 *
...
/**
 * The mod_qbassign user override deleted event class.
 *
...
class user_override_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridedeleted', 'mod_qbassign');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the override with id '$this->objectid' for the qbassign with " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/qbassign/overrides.php', array('cmid' => $this->contextinstanceid));
    }
