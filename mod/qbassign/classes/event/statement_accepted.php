...
/**
 * The mod_qbassign statement accepted event.
 *
...
/**
 * The mod_qbassign statement accepted event class.
 *
 * @package    mod_qbassign
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class statement_accepted extends base {
    ...
    public static function get_name() {
        return get_string('eventstatementaccepted', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        global $USER;
        $logmessage = get_string('submissionstatementacceptedlog', 'mod_qbassign', fullname($USER)); // Nasty hack.
