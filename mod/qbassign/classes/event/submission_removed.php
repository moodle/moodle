...
/**
 * The mod_qbassign submission removed event class.
 *
...
class submission_removed extends base {
     ...
     */
    public static function create_from_submission(qbassign $qbassign, stdClass $submission): submission_removed {
        $groupname = null;
        $groupid = 0;
        ...
        $data = [
            ...
            'anonymous' => $qbassign->is_blind_marking() ? 1 : 0,
            'other' => [
    ...
    public static function get_name(): string {
        return get_string('eventsubmissionremoved', 'mod_qbassign');
    }
    ...
    public function get_description(): string {
        $descriptionstring = "The user with id '$this->userid' removed the submission with id '$this->objectid' in " .
            "the qbassignment with course module id '$this->contextinstanceid' submitted by ";
    ...
    public static function get_objectid_mapping(): array {
        return ['db' => 'qbassign_submission', 'restore' => 'submission'];
    }
    ...
    public static function get_other_mapping(): array {
        $othermapped = [];
        $othermapped['submissionid'] = ['db' => 'qbassign_submission', 'restore' => 'submission'];
