...
/**
 * The mod_qbassign reveal identities confirmation page viewed event.
 *
...
/**
 * The mod_qbassign reveal identities confirmation page viewed event class.
 *
...
class reveal_identities_confirmation_page_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventrevealidentitiesconfirmationpageviewed', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewrevealidentitiesconfirm', 'qbassign'));
