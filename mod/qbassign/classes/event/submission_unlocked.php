...
/**
 * The mod_qbassign submission unlocked event.
 *
...
/**
 * The mod_qbassign submission unlocked event class.
 *
 * @package    mod_qbassign
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_unlocked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionunlocked', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('unlocksubmissionforstudent', 'qbassign', array('id' => $user->id, 'fullname' => fullname($user)));
