...
/**
 * The mod_qbassign marker updated event.
 *
...
/**
 * The mod_qbassign marker updated event class.
 *
...
class marker_updated extends base {
     ...
     */
    public static function create_from_marker(\qbassign $qbassign, \stdClass $user, \stdClass $marker) {
        $data = array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' has set the marker for the user with id '$this->relateduserid' to " .
            "'{$this->other['markerid']}' for the qbassignment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventmarkerupdated', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkerallocationforlog', 'qbassign', $a);
