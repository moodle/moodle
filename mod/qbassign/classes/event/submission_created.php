...
/**
 * The mod_qbassign submission_created abstract event.
 *
...
/**
 * The mod_qbassign submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_qbassign');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'qbassign_submission', 'restore' => 'submission');
