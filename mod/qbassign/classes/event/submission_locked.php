...
/**
 * The mod_qbassign submission locked event.
 *
...
/**
 * The mod_qbassign submission locked event class.
 *
 * @package    mod_qbassign
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' locked the submission for the user with id '$this->relateduserid' for " .
            "the qbassignment with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'qbassign', array('id' => $user->id, 'fullname' => fullname($user)));
