...
/**
 * The mod_qbassign submission viewed event.
 *
...
/**
 * The mod_qbassign submission viewed event class.
 *
...
class submission_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionviewed', 'mod_qbassign');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissionforuser', 'qbassign', $this->relateduserid);
