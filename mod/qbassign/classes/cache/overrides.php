...
/**
 * Cache data source for the qbassign overrides.
 *
...
namespace mod_qbassign\cache;

use cache_definition;

/**
 * Class qbassign_overrides
 *
 * @package   mod_qbassign
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class overrides implements \cache_data_source {
    ...
    public function load_for_cache($key) {
        ...
        [$qbassignid, $ug, $ugid] = explode('_', $key);
        $qbassignid = (int) $qbassignid;
        ...
        switch ($ug) {
            case 'u':
                ...
                $override = $DB->get_record(
                    'qbassign_overrides',
                    ['qbassignid' => $qbassignid, 'userid' => $userid],
            ...
            case 'g':
                ...
                $override = $DB->get_record(
                    'qbassign_overrides',
                    ['qbassignid' => $qbassignid, 'groupid' => $groupid],
