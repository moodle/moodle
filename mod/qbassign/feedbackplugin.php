...
/**
 * Abstract class for feedback_plugin inherited from qbassign_plugin abstract class.
 *
 * @package   mod_qbassign
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qbassign_feedback_plugin extends qbassign_plugin {
     ...
     *      'component' => qbassignFEEDBACK_XYZ_COMPONENT,
     *      'filearea' => qbassignFEEDBACK_XYZ_FILEAREA,
     *      'itemid' => $grade->id
     * ]
     *
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole qbassignment.
     * @return array - An array of action and description strings.
