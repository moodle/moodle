 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassignfeedback_offline_upload_grades_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'uploadgrades', get_string('uploadgrades', 'qbassignfeedback_offline'));
        ...
        $mform->addHelpButton('gradesfile', 'gradesfile', 'qbassignfeedback_offline');
        ...
        $mform->addElement('checkbox', 'ignoremodified', '', get_string('ignoremodified', 'qbassignfeedback_offline'));
        $mform->addHelpButton('ignoremodified', 'ignoremodified', 'qbassignfeedback_offline');
        ...
        $this->add_action_buttons(true, get_string('uploadgrades', 'qbassignfeedback_offline'));
