 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassignfeedback_editpd_widget implements renderable {

    /** @var int $qbassignment - qbassignment instance id */
    public $qbassignment = 0;
    ...
    /**
     * Constructor
     * @param int $qbassignment - qbassignment instance id
     ...
     */
    public function __construct($qbassignment, $userid, $attemptnumber, $downloadurl,
