YUI.add('moodle-qbassignfeedback_editpd-editor', function (Y, NAME) {
...
M.qbassignfeedback_editpd.point = POINT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var EDIT = function() {
     ...
     * @property start
     * @type M.qbassignfeedback_editpd.point|false
     * @public
     */
    this.start = false;
     ...
     * @property path
     * @type M.qbassignfeedback_editpd.point[]
     * @public
     */
    this.path = [];
};
...
M.qbassignfeedback_editpd = M.qbassignfeedback_editpd || {};
M.qbassignfeedback_editpd.edit = EDIT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONPEN, M.qbassignfeedback_editpd.annotation, {
    /**
...
M.qbassignfeedback_editpd = M.qbassignfeedback_editpd || {};
M.qbassignfeedback_editpd.annotationpen = ANNOTATIONPEN;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var COMMENT = function(editor, gradeid, pageno, x, y, width, colour, rawtext) {
     ...
     * @property menu
     * @type M.qbassignfeedback_editpd.dropdown
     * @public
     */
    this.menu = null;
        ...
        if (!this.editor.get('readonly')) {
            ...
            node.on('gesturemove', function(e) {
                if (editor.currentedit.tool === 'select') {
                    ...
                    newlocation = this.editor.get_canvas_coordinates(new M.qbassignfeedback_editpd.point(x, y));
            ...
            this.menu = new M.qbassignfeedback_editpd.commentmenu({
    ...
    this.updatePosition = function() {
        ...
        var newlocation = new M.qbassignfeedback_editpd.point(this.x, this.y);
...
M.qbassignfeedback_editpd = M.qbassignfeedback_editpd || {};
M.qbassignfeedback_editpd.comment = COMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
