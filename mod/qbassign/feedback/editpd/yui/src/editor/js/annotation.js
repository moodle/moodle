...
Y.extend(ANNOTATION, Y.Base, {
    ...
    /**
     * Reference to M.qbassignfeedback_editpd.drawable
     * @property drawable
     * @type M.qbassignfeedback_editpd.drawable
     * @public
     */
    drawable: false,
    ...
    draw_highlight: function() {
        ...
        if (this.editor.currentannotation === this) {
            ...
            var deleteicon = Y.Node.create('<img src="' + M.util.image_url('trash', 'qbassignfeedback_editpd') + '"/>'),
                deletelink = Y.Node.create('<a href="#" role="button"></a>');

            deleteicon.setAttrs({
                'alt': M.util.get_string('deleteannotation', 'qbassignfeedback_editpd')
            });
     ...
     * @public
     * @method draw
     * @return M.qbassignfeedback_editpd.drawable|false
     */
    draw: function() {
...
M.qbassignfeedback_editpd.annotation = ANNOTATION;
