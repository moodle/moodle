...
Y.extend(ANNOTATIONSTAMP, M.qbassignfeedback_editpd.annotation, {
    /**
    ...
    draw: function() {
        ...
        position = this.editor.get_window_coordinates(new M.qbassignfeedback_editpd.point(this.x, this.y));
    ...
    draw_current_edit: function(edit) {
        ...
        position = this.editor.get_window_coordinates(new M.qbassignfeedback_editpd.point(bounds.x, bounds.y));
...
M.qbassignfeedback_editpd.annotationstamp = ANNOTATIONSTAMP;
