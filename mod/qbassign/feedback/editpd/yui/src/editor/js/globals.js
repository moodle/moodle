 ...
 */
var AJAXBASE = M.cfg.wwwroot + '/mod/qbassign/feedback/editpd/ajax.php',
    AJAXBASEPROGRESS = M.cfg.wwwroot + '/mod/qbassign/feedback/editpd/ajax_progress.php',
    CSS = {
        DIALOGUE: 'qbassignfeedback_editpd_widget'
    },
    SELECTOR = {
        ...
        SEARCHFILTER: '.qbassignfeedback_editpd_commentsearch input',
        SEARCHCOMMENTSLIST: '.qbassignfeedback_editpd_commentsearch ul',
        ...
        UNSAVEDCHANGESDIV: '.qbassignfeedback_editpd_warningmessages',
        UNSAVEDCHANGESINPUT: 'input[name="qbassignfeedback_editpd_haschanges"]',
