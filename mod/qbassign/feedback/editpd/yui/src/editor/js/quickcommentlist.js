...
var QUICKCOMMENTLIST = function(editor) {
     ...
     * Array of Comments
     * @property shapes
     * @type M.qbassignfeedback_editpd.quickcomment[]
     * @public
     */
    this.comments = [];
    ...
    this.add = function(comment) {
        ...
        config = {
            ...
            data: {
                ...
                'qbassignmentid': this.editor.get('qbassignmentid')
            },
            on: {
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            quickcomment = new M.qbassignfeedback_editpd.quickcomment(jsondata.id,
                                                                                     jsondata.rawtext,
                                                                                     jsondata.width,
                                                                                     jsondata.colour);
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            Y.each(jsondata, function(comment) {
                                var quickcomment = new M.qbassignfeedback_editpd.quickcomment(comment.id,
                                                                                             comment.rawtext,
                                                                                             comment.width,
                                                                                             comment.colour);
                                this.comments.push(quickcomment);
...
M.qbassignfeedback_editpd.quickcommentlist = QUICKCOMMENTLIST;
