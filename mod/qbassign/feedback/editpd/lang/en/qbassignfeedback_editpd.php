...
/**
 * Strings for component 'qbassignfeedback_editpd', language 'en'
 *
...
$string['editpd'] = 'Annotate PDF';
$string['editpd_help'] = 'Annotate student submissions directly in the browser and produce an edited downloadable PDF.';
$string['enabled'] = 'Annotate PDF';
$string['enabled_help'] = 'If enabled, the teacher will be able to create annotated PDF files when marking qbassignment submissions. This allows the teacher to add comments, drawing and stamps directly on top of the student\'s work. The annotating is done in the browser and no extra software is required.';
