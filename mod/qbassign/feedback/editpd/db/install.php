...
/**
 * Install code for the feedback_editpd module.
 *
 ...
 * editpd install code
 */
function xmldb_qbassignfeedback_editpd_install() {
    global $CFG;
    ...
    $filerecord->component = 'qbassignfeedback_editpd';
    ...
    foreach ($defaultstamps as $stamp) {
        ...
        $fs->create_file_from_pathname($filerecord,
            $CFG->dirroot . '/mod/qbassign/feedback/editpd/pix/' . $filerecord->filename);
    }
}
