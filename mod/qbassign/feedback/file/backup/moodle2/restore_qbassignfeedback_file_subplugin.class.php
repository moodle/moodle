 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qbassignfeedback_file_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_qbassignfeedback_file_grade($data) {
        global $DB;
        ...
        $DB->insert_record('qbassignfeedback_file', $data);

        $this->add_related_files('qbassignfeedback_file', 'feedback_files', 'grade', null, $oldgradeid);
    }
