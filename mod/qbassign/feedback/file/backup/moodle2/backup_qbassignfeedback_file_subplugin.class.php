 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qbassignfeedback_file_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('qbassignfeedback_file', array('grade' => backup::VAR_PARENTID));
        // The parent is the grade.
        $subpluginelement->annotate_files('qbassignfeedback_file', 'feedback_files', 'grade');
        return $subplugin;
    }
