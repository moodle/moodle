...
/**
 * Post-install code for the qbassignfeedback_file module.
 *
...
/**
 * Code run after the qbassignfeedback_file module database tables have been created.
 * Moves the feedback file plugin down
 *
 * @return bool
 */
function xmldb_qbassignfeedback_file_install() {
    global $CFG;
