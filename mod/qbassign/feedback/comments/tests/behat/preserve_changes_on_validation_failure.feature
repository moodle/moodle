...
Feature: Check that any changes to qbassignment feedback comments are not lost
  ...
  @javascript
  Scenario: Update the grade and feedback for an qbassignment
    ...
    And the following "activities" exist:
      | activity | name                 | course | qbassignfeedback_comments_enabled |
      | qbassign   | Test qbassignment name | C1     | 1                               |
