 ...
 */
namespace qbassignfeedback_comments\privacy;
...
/**
 * Unit tests for mod/qbassign/feedback/comments/classes/privacy/
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider_test extends \mod_qbassign\privacy\provider_test {
    ...
    protected function create_feedback($qbassign, $student, $teacher, $submissiontext, $feedbacktext) {
        ...
        file_prepare_draft_area($draftitemid, $context->id, qbassignFEEDBACK_COMMENTS_COMPONENT,
            qbassignFEEDBACK_COMMENTS_FILEAREA, $grade->id);
        ...
        $feedbackdata->qbassignfeedbackcomments_editor = [
            'text' => $feedbacktext,
            'format' => FORMAT_HTML,
            'itemid' => $draftitemid
        ];
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('qbassignfeedback_comments');
        $collection = \qbassignfeedback_comments\privacy\provider::get_metadata($collection);
    ...
    public function test_export_feedback_user_data() {
        ...
        \qbassignfeedback_comments\privacy\provider::export_feedback_user_data($exportdata);
        ...
        $exportdata = new \mod_qbassign\privacy\qbassign_plugin_request_data($context, $qbassign, $grade, [], $user2);
        \qbassignfeedback_comments\privacy\provider::export_feedback_user_data($exportdata);
        $this->assertStringContainsString($feedbacktext, $writer->get_data(['Feedback comments'])->commenttext);
    ...
    public function test_delete_feedback_for_context() {
        ...
        $fs = new \file_storage();
        $files = $fs->get_area_files($qbassign->get_context()->id, qbassignFEEDBACK_COMMENTS_COMPONENT,
    ...
    public function test_delete_feedback_for_grade() {
        ...
        $requestdata = new \mod_qbassign\privacy\qbassign_plugin_request_data($context, $qbassign, $grade1, [], $user1);
    ...
    public function test_delete_feedback_for_grades() {
        ...
        $feedbacktext = '<p>Comment for third student in the second qbassignment.</p>';
        list($plugin4, $grade4) = $this->create_feedback($qbassign2, $user3, $user5, 'Submission text', $feedbacktext);
        $feedbacktext = '<p>Comment for fourth student in the second qbassignment.</p>';
        ...
        $fs = new \file_storage();
        // 6 including directories for qbassign 1.
        // 4 including directories for qbassign 2.
        $this->assertCount(6, $fs->get_area_files($qbassign1->get_context()->id,
                qbassignFEEDBACK_COMMENTS_COMPONENT, qbassignFEEDBACK_COMMENTS_FILEAREA));
        $this->assertCount(4, $fs->get_area_files($qbassign2->get_context()->id,
                qbassignFEEDBACK_COMMENTS_COMPONENT, qbassignFEEDBACK_COMMENTS_FILEAREA));

        $deletedata = new \mod_qbassign\privacy\qbassign_plugin_request_data($qbassign1->get_context(), $qbassign1);
        ...
        // We have deleted two from qbassign 1, and none from qbassign 2.
        // 2 including directories for qbassign 1.
        // 4 including directories for qbassign 2.
        $this->assertCount(2, $fs->get_area_files($qbassign1->get_context()->id,
                qbassignFEEDBACK_COMMENTS_COMPONENT, qbassignFEEDBACK_COMMENTS_FILEAREA));
        $this->assertCount(4, $fs->get_area_files($qbassign2->get_context()->id,
                qbassignFEEDBACK_COMMENTS_COMPONENT, qbassignFEEDBACK_COMMENTS_FILEAREA));
    }
