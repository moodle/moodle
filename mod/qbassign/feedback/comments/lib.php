...
/**
 * Serves qbassignment comment feedback files.
 *
 ...
 */
function qbassignfeedback_comments_pluginfile(
        $course,
        $cm,
        context $context,
        $filearea,
    ...
    if ($instance->id != $record->qbassignment) {
        return false;
    }
    ...
    $fullpath = "/{$context->id}/qbassignfeedback_comments/$filearea/$itemid/$relativepath";
