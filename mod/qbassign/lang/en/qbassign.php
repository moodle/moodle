...
/**
 * Strings for component 'qbassign', language 'en'
 *
...
$string['qbassign:reviewgrades'] = 'Review grades';
...
$string['numberofsubmittedqbassignments'] = 'Submitted';
...
$string['overridegroupeventname'] = '{$a->qbassign} - {$a->group}';
...
$string['quickgrading_help'] = 'Quick grading allows you to qbassign grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['subplugintype_qbassignsubmission'] = 'Submission plugin';
$string['subplugintype_qbassignsubmission_plural'] = 'Submission plugins';
$string['subplugintype_qbassignfeedback'] = 'Feedback plugin';
$string['subplugintype_qbassignfeedback_plural'] = 'Feedback plugins';
