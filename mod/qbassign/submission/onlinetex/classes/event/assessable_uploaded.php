...
/**
 * The qbassignsubmission_onlinetex assessable uploaded event.
 *
...
namespace qbassignsubmission_onlinetex\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The qbassignsubmission_onlinetex assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'qbassignsubmission_onlinetex');
    }
