...
/**
 * Unit tests for qbassignsubmission_onlinetex.
 *
...
/**
 * Unit tests for mod/qbassign/submission/onlinetex/classes/privacy/
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider_test extends \mod_qbassign\privacy\provider_test {
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('qbassignsubmission_onlinetex');
        $collection = \qbassignsubmission_onlinetex\privacy\provider::get_metadata($collection);
    ...
    public function test_export_submission_user_data() {
        ...
        \qbassignsubmission_onlinetex\privacy\provider::export_submission_user_data($exportdata);
        $this->assertEquals($submissiontext, $writer->get_data(['Attempt 1',
                get_string('privacy:path', 'qbassignsubmission_onlinetex')])->text);
    }
    ...
    public function test_delete_submission_for_context() {
        ...
        \qbassignsubmission_onlinetex\privacy\provider::delete_submission_for_context($requestdata);
    ...
    public function test_delete_submission_for_userid() {
        ...
        \qbassignsubmission_onlinetex\privacy\provider::delete_submission_for_userid($requestdata);
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('qbassignsubmission_onlinetex', ['qbassignment' => $qbassign1->get_instance()->id]);
        ...
        \qbassignsubmission_onlinetex\privacy\provider::delete_submissions($requestdata);
        ...
        $data = $DB->get_records('qbassignsubmission_onlinetex', ['qbassignment' => $qbassign2->get_instance()->id]);
