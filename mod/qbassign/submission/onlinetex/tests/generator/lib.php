 ...
 */
class qbassignsubmission_onlinetex_generator extends qbassignsubmission_subplugin_generator {
    /**
    ...
    public function add_submission_data(stdClass $submission, qbassign $qbassign, array $data): void {
        if (array_key_exists('onlinetex', $data)) {
            $submission->onlinetex_editor = [
