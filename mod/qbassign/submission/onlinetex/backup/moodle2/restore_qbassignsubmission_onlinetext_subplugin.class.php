 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qbassignsubmission_onlinetex_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_onlinetex');
    ...
    /**
     * Processes one qbassignsubmission_onlinetex element
     *
     * @param mixed $data
     */
    public function process_qbassignsubmission_onlinetex_submission($data) {
        global $DB;
        ...
        $DB->insert_record('qbassignsubmission_onlinetex', $data);

        $this->add_related_files('qbassignsubmission_onlinetex', 'submissions_onlinetex', 'submission', null, $oldsubmissionid);
    }
