...
/**
 * Strings for component 'qbassignsubmission_scratch', language 'en'
 *
...
$string['privacy:metadata:textpurpose'] = 'The actual text submitted for this attempt of the qbassignment.';
$string['privacy:path'] = 'Submission Text';
$string['wordlimit'] = 'Word limit';
$string['wordlimit_help'] = 'If Scratch submissions are enabled, this is the maximum number ' .
        'of words that each student will be allowed to submit.';
$string['wordlimitexceeded'] = 'The word limit for this qbassignment is {$a->limit} words and you ' .
