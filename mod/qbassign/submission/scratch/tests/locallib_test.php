...
/**
 * Tests for mod/qbassign/submission/scratch/locallib.php
 *
 * @package   qbassignsubmission_scratch
 * @copyright 2016 Cameron Ball
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace qbassignsubmission_scratch;
...
/**
 * Unit tests for mod/qbassign/submission/scratch/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class locallib_test extends \advanced_testcase {
     ...
     * @param string $submissiontext The Scratch submission text
    ...
    public function test_submission_is_empty($submissiontext, $expected) {
        ...
        $qbassign = $this->create_instance($course, [
                'qbassignsubmission_scratch_enabled' => true,
            ]);
