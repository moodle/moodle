 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qbassignsubmission_scratch_subplugin extends restore_subplugin {
    ...
    /**
     * Processes one qbassignsubmission_scratch element
     *
     * @param mixed $data
     */
    public function process_qbassignsubmission_scratch_submission($data) {
        global $DB;
        ...
        $DB->insert_record('qbassignsubmission_scratch', $data);

        $this->add_related_files('qbassignsubmission_scratch', 'submissions_scratch', 'submission', null, $oldsubmissionid);
    }
