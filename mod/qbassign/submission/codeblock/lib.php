...
/**
 * This file contains the moodle hooks for the submission codeblock plugin
 *
 ...
 */
function qbassignsubmission_codeblock_pluginfile($course,
                                                $cm,
                                                context $context,
                                                $filearea,
                                                $args,
    ...
    $fullpath = "/{$context->id}/qbassignsubmission_codeblock/$filearea/$itemid/$relativepath";
