...
/**
 * The qbassignsubmission_codeblock assessable uploaded event.
 *
...
/**
 * The qbassignsubmission_codeblock assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has saved an code block submission with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'qbassignsubmission_codeblock');
    }
