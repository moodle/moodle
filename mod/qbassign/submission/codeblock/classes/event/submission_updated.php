...
/**
 * The qbassignsubmission_codeblock submission_updated event.
 *
...
/**
 * The qbassignsubmission_codeblock submission_updated event class.
 *
...
class submission_updated extends \mod_qbassign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' updated an code block submission with " .
