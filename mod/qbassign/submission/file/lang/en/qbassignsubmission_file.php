...
/**
 * Strings for component 'qbassignsubmission_file', language 'en'
 *
...
$string['default_help'] = 'If set, this submission method will be enabled by default for all new qbassignments.';
...
$string['maxfiles_help'] = 'If file submissions are enabled, each qbassignment can be set to accept up to this number of files for their submission.';
...
$string['privacy:metadata:filepurpose'] = 'The files loaded for this qbassignment submission';
