 ...
 * needed to restore one qbassign_submission subplugin.
 *
 * @package qbassignsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qbassignsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_qbassignsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('qbassignsubmission_file', $data);

        $this->add_related_files('qbassignsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
