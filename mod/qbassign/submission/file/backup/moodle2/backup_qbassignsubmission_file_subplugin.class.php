 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qbassignsubmission_file_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('qbassignsubmission_file',
                                            array('submission' => backup::VAR_PARENTID));

        // The parent is the submission.
        $subpluginelement->annotate_files('qbassignsubmission_file',
                                          'submission_files',
                                          'submission');
        return $subplugin;
    }
