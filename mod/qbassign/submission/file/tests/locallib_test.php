...
/**
 * Tests for mod/qbassign/submission/file/locallib.php
 *
 * @package   qbassignsubmission_file
 * @copyright 2016 Cameron Ball
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace qbassignsubmission_file;
...
/**
 * Unit tests for mod/qbassign/submission/file/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class locallib_test extends \advanced_testcase {
    ...
    public function test_submission_is_empty($data, $expected) {
        ...
        $qbassign = $this->create_instance($course, [
                ...
                'qbassignsubmission_file_maxfiles' => 12,
                'qbassignsubmission_file_maxsizebytes' => 10,
            ]);
    ...
    public function test_new_submission_empty($data, $expected) {
        ...
        $result = $qbassign->new_submission_empty($submission);
        $this->assertTrue($result === $expected);
    }
    ...
    public function test_new_submission_empty_directory_only() {
        ...
        $this->assertTrue($qbassign->new_submission_empty($submission));
    }
