...
namespace qbassignsubmission_comments\event;
...
class events_test extends \advanced_testcase {
    ...
    public function test_comment_created() {
        ...
        $this->assertInstanceOf('\qbassignsubmission_comments\event\comment_created', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new \moodle_url('/mod/qbassign/view.php', array('id' => $qbassign->get_course_module()->id));
    ...
    public function test_comment_deleted() {
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\qbassignsubmission_comments\event\comment_deleted', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new \moodle_url('/mod/qbassign/view.php', array('id' => $qbassign->get_course_module()->id));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
