...
/**
 * Custom auto-complete adapter to load users from the qbassignment list_participants webservice.
 *
 * @module     mod_qbassign/participants_selector
...
define(['core/ajax', 'jquery', 'core/templates'], function(ajax, $, templates) {
    ...
    return /** @alias module:mod_qbassign/participants_selector */ {
        ...
        transport: function(selector, query, success, failure) {
            var qbassignmentid = $(selector).attr('data-qbassignmentid');
            ...
            ajax.call([{
                ...
                $.each(results, function(index, user) {
                    ...
                    if (show) {
                        ...
                        promises.push(templates.render('mod_qbassign/list_participant_user_summary', ctx).then(function(html) {
