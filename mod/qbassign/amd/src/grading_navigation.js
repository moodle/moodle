...
define(['jquery', 'core/notification', 'core/str', 'core/form-autocomplete',
        'core/ajax', 'mod_qbassign/grading_form_change_checker'],
       function($, notification, str, autocomplete, ajax, checker) {

    /**
     * GradingNavigation class.
     *
     * @class mod_qbassign/grading_navigation
    ...
    var GradingNavigation = function(selector) {
        ...
        str.get_string('changeuser', 'mod_qbassign').done(function(s) {
                autocomplete.enhance('[data-action=change-user]', false, 'mod_qbassign/participant_selector', s);
            }
    ...
    /**
     * Load the list of all users for this qbassignment.
     *
     * @private
    ...
    GradingNavigation.prototype._loadAllUsers = function() {
        ...
        var qbassignmentid = select.attr('data-qbassignmentid');
        ...
        ajax.call([{
            methodname: 'mod_qbassign_list_participants',
            args: {qbassignid: qbassignmentid, groupid: groupid, filter: '', onlyids: true, tablesort: true},
    ...
    GradingNavigation.prototype._checkClickOutsideConfigureFilters = function(event) {
        ...
        if (!configPanel.is(event.target) && configPanel.has(event.target).length === 0) {
            ...
            $(document).unbind('click.mod_qbassign_grading_navigation');
        }
    };
    ...
    GradingNavigation.prototype._filterChanged = function() {
        ...
        filters.each(function(idx, ele) {
            ...
            preferenceNames.push('qbassign_' + element.prop('name'));
        }.bind(this));
        ...
        if (filterlist.length) {
            ...
            str.get_string('nofilters', 'mod_qbassign').done(function(s) {
    ...
    GradingNavigation.prototype._selectNoUser = function() {
        ...
        if (checker.checkFormForChanges('[data-region="grade-panel"] .gradeform')) {
            ...
            str.get_strings([
                {key: 'unsavedchanges', component: 'mod_qbassign'},
    ...
    GradingNavigation.prototype._toggleExpandFilters = function(event) {
        ...
        if (expanded) {
            ...
            $(document).on('click.mod_qbassign_grading_navigation', this._checkClickOutsideConfigureFilters.bind(this));
        }
    };
    ...
    GradingNavigation.prototype._setCountString = function(x, y) {
        ...
        var param = {x: x, y: y};
        str.get_string('xofy', 'mod_qbassign', param).done(function(s) {
