...
const update = () => {
    ...
    if (secondsLeft <= 0) {
        ...
        // Only add a notification on the qbassign submission page.
        if (document.getElementById("mod_qbassign_timelimit_block")) {
            getString('caneditsubmission', 'mod_qbassign')
