...
/**
 * This file contains the definition for the renderable classes for the qbassignment
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_submit_for_grading_page implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_gradingmessage implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_form implements renderable {
    /** @var moodleform $form is the edit submission form */
    public $form = null;
    /** @var string $classname is the name of the class to qbassign to the container */
    public $classname = '';
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_user_summary implements renderable {
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_feedback_plugin_feedback implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;

    /** @var qbassign_submission_plugin $plugin */
    public $plugin = null;
    /** @var stdClass $grade */
    public $grade = null;
    /** @var string $view */
     ...
     *
     * @param qbassign_feedback_plugin $plugin
     ...
     */
    public function __construct(qbassign_feedback_plugin $plugin,
                                stdClass $grade,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_submission_plugin_submission implements renderable {
    /** @var int SUMMARY */
    const SUMMARY                = 10;
    /** @var int FULL */
    const FULL                   = 20;
    ...
    /**
     * Constructor
     * @param qbassign_submission_plugin $plugin
     ...
     */
    public function __construct(qbassign_submission_plugin $plugin,
                                stdClass $submission,
                                $view,
                                $coursemoduleid,
                                $returnaction,
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_feedback_status implements renderable {
    ...
    /** @var stdClass qbassign_grade record */
    public $grade = null;
    /** @var int coursemoduleid */
    public $coursemoduleid = 0;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_submission_status_compact extends qbassign_submission_status implements renderable {
    // Compact view of the submission status. Not in a table etc.
}

/**
 * Used to output the attempt history for a particular qbassignment.
 *
 * @package mod_qbassign
 * @copyright 2012 Davo Smith, Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_attempt_history implements renderable {
    ...
    public $feedbackplugins = array();
    /** @var int coursemoduleid - The cmid for the qbassignment */
    public $coursemoduleid = 0;
...
/**
 * Used to output the attempt history chooser for a particular qbassignment.
 *
 * @package mod_qbassign
 * @copyright 2016 Damyon Wiese
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_attempt_history_chooser implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        foreach ($export->submissions as $i => $submission) {
            ...
            $submission->attemptsummary = get_string('attemptheading', 'qbassign', $attemptsummaryparams);
            $submission->statussummary = get_string('submissionstatus_' . $submission->status, 'qbassign');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_plugin_header implements renderable {
    /** @var qbassign_plugin $plugin */
    public $plugin = null;

    /**
     * Header for a single plugin
     *
     * @param qbassign_plugin $plugin
     */
    public function __construct(qbassign_plugin $plugin) {
        $this->plugin = $plugin;
    }
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_grading_summary implements renderable {
    /** @var int participantcount - The number of users who can submit to this qbassignment */
    ...
    /** @var int duedate - The qbassignment due date (if one is set) */
    public $duedate = 0;
    /** @var int cutoffdate - The qbassignment cut off date (if one is set) */
    public $cutoffdate = 0;
    /** @var int timelimit - The qbassignment time limit (if one is set) */
    public $timelimit = 0;
    /** @var int coursemoduleid - The qbassignment course module id */
    public $coursemoduleid = 0;
    /** @var boolean teamsubmission - Are team submissions enabled for this qbassignment */
    ...
    public $cangrade = false;
    /** @var boolean isvisible - Is the qbassignment's context module visible to students? */
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_course_index_summary implements renderable {
    /** @var array qbassignments - A list of course module info and submission counts or statuses */
    public $qbassignments = array();
     ...
     * @param int $timedue - The due date for the qbassignment - may be 0 if no duedate
     * @param string $submissioninfo - A string with either the number of submitted qbassignments, or the
     ...
     */
    public function add_qbassign_info($cmid, $cmname, $sectionname, $timedue, $submissioninfo, $gradeinfo, $cangrade = false) {
        $this->qbassignments[] = ['cmid' => $cmid,
                               'cmname' => $cmname,
...
/**
 * An qbassign file class that extends rendererable class and is used by the qbassign module.
 *
 * @package   mod_qbassign
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbassign_files implements renderable {
    /** @var context $context */
    public $context;
    /** @var string $context */
    public $dir;
    ...
    public function __construct(context $context, $sid, $filearea, $component, $course = null, $cm = null) {
        ...
        if (!empty($CFG->enableportfolios)) {
            ...
            if (count($files) >= 1 && !empty($sid) &&
                    has_capability('mod/qbassign:exportownsubmission', $this->context)) {
                $button = new portfolio_add_button();
                $callbackparams = array('cmid' => $this->cm->id,
                                        'sid' => $sid,
                                        'area' => $filearea,
                                        'component' => $component);
                $button->set_callback_options('qbassign_portfolio_caller',
                                              $callbackparams,
                                              'mod_qbassign');
    ...
    public function preprocess($dir, $filearea, $component) {
        ...
        foreach ($dir['files'] as $file) {
            ...
            if (!empty($CFG->enableportfolios)) {
                require_once($CFG->libdir . '/portfoliolib.php');
                $button = new portfolio_add_button();
                if (has_capability('mod/qbassign:exportownsubmission', $this->context)) {
