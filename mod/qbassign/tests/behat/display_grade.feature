@mod @mod_qbassign
Feature: Check that the qbassignment grade can be updated correctly
  ...
  @javascript
  Scenario: Update the grade for an qbassignment
  ...
  @javascript
  Scenario: Update the grade for a team qbassignment
    Given the following "courses" exist:
      | fullname | shortname | category | groupmode |
      | Course 1 | C1 | 0 | 1 |
    And the following "users" exist:
