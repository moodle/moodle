@mod @mod_qbassign @core_completion
Feature: View activity completion in the qbassignment activity
  In order to have visibility of qbassignment completion requirements
  As a student
  I need to be able to view my qbassignment completion progress
  ...
  Scenario: The manual completion button will not be shown on the course page if the Show activity completion conditions is set to No
    ...
    And I am on the "Music history" "qbassign activity" page
    And the manual completion button for "Music history" should exist
    And the manual completion button for "Music history" should be disabled
    And I log out
    # Student view.
  ...
  Scenario: Use manual completion from the activity page
    Given I am on the "Music history" "qbassign activity" page logged in as teacher1
    # Teacher view.
    And the manual completion button for "Music history" should be disabled
    And I log out
    # Student view.
    And I am on the "Music history" "qbassign activity" page logged in as student1
    Then the manual completion button of "Music history" is displayed as "Mark as done"
    And I toggle the manual completion state of "Music history"
    And the manual completion button of "Music history" is displayed as "Done"

  Scenario: View automatic completion items as a teacher
    Given I am on the "Music history" "qbassign activity editing" page logged in as teacher1
    And I expand all fieldsets
  ...
  Scenario: View automatic completion items as a student
    ...
    And the "Receive a grade" completion condition of "Music history" is displayed as "todo"
    And I log out
    And I am on the "Music history" "qbassign activity" page logged in as teacher1
    ...
    And I follow "View all submissions"
    And I log out
    When I am on the "Music history" "qbassign activity" page logged in as student1
  ...
  Scenario: Automatic completion items should reset when a new attempt is manually given.
    Given I am on the "Music history 2" "qbassign activity" page logged in as student1
    ...
    And I log out
    And I am on the "Music history 2" "qbassign activity" page logged in as teacher1
    And I follow "View all submissions"
    And I click on "Grade" "link" in the "Vinnie Student1" "table_row"
    And I set the field "Grade out of 100" to "33"
    And I set the field "Notify student" to "0"
    ...
    And I press "Save changes"
    And I log out
    When I am on the "Music history 2" "qbassign activity" page logged in as student1
