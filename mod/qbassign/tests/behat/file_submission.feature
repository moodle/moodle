...
Feature: In an qbassignment, students can upload files for assessment
  In order to complete my qbassignments providing files
  As a student
  ...
  Scenario: Submit a file and update the submission with another file
    ...
    And the following "activity" exists:
      ...
      | submissiondrafts                    | 0                       |
      | qbassignsubmission_onlinetex_enabled | 0                       |
