@mod @mod_qbassign
Feature: In an qbassignment, teachers can edit feedback for a students previous submission attempt
  ...
  Scenario: Edit feedback for a students previous attempt.
    ...
    And the following "mod_qbassign > submissions" exist:
      ...
      | Test qbassignment name  | student2  | I'm the student first submission  |
    ...
    And I click on ".mod-qbassign-history-link" "css_element"
