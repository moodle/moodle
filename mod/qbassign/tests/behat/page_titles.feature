@mod @mod_qbassign
Feature: In an qbassignment, page titles are informative
  In order to know I am viewing the correct page
  The page titles need to reflect the current qbassignment and action
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | course | name                 | intro                       | qbassignsubmission_onlinetex_enabled |
      | qbassign   | C1     | History of ants      | Tell me the history of ants | 1                                   |

  Scenario: I view an qbassignment as a student and take an action
  ...
  Scenario: I view an qbassignment as a teacher and take an action
