@mod @mod_qbassign
Feature: View the grading status of an qbassignment
  In order to test the grading status for qbassignments is displaying correctly
  As a student
  ...
  @javascript
  Scenario: View the grading status for an qbassignment with marking workflow enabled
    ...
    # The grade should also remain displayed as it's stored in the qbassign DB tables, but the final grade should be empty.
  ...
  @javascript
  Scenario: View the grading status for an qbassignment with marking workflow disabled
    Given the following "activity" exists:
      | activity                            | qbassign                  |
      | course                              | C1                      |
      | name                                | Test qbassignment name    |
