@mod @mod_qbassign
Feature: qbassign group override
  In order to grant a group special access to an qbassignment
  As a teacher
  ...
  Scenario: Allow a group to have a different due date
    ...
    Then the activity date in "Test qbassignment name" should contain "Due: Saturday, 1 January 2000, 8:00"
    And I log out
  ...
  Scenario: Add both a user and group override and verify that both are applied correctly
    ...
    And I log out
    And I am on the "Test qbassignment name" Activity page logged in as student1
    And the activity date in "Test qbassignment name" should contain "Opens: Wednesday, 1 January 2031, 8:00"
    And I log out
    And I am on the "Test qbassignment name" Activity page logged in as student2
    And the activity date in "Test qbassignment name" should contain "Opens: Sunday, 1 January 2040, 8:00"
    And I log out
    And I am on the "Test qbassignment name" Activity page logged in as student3
    And the activity date in "Test qbassignment name" should contain "Opens: Tuesday, 1 January 2030, 8:00"
  ...
  Scenario: A teacher without accessallgroups permission should only be able to see the group overrides for groups that he/she is a member of,
    ...
    When I am on the "qbassignment 2" Activity page logged in as teacher1
    And I navigate to "Overrides" in current page administration
    And I select "Group overrides" from the "jump" singleselect
