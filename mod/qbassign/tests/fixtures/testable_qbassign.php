 ...
 */
class mod_qbassign_testable_qbassign extends qbassign {
    ...
    public function testable_process_set_batch_marking_allocation($selectedusers, $markerid) {
        ...
        mod_qbassign_batch_set_allocatedmarker_form::mock_submit($data);
    ...
    public function testable_process_set_batch_marking_workflow_state($selectedusers, $state) {
        ...
        mod_qbassign_batch_set_marking_workflow_state_form::mock_submit($data);
    ...
    public function testable_view_batch_set_workflow_state($selectedusers) {
        global $PAGE;
        $PAGE->set_url('/mod/qbassign/view.php');
    ...
    public function testable_grading_batch_operations_form($operation, $selectedusers) {
        ...
        mod_qbassign_grading_batch_operations_form::mock_submit($data);

        // Set required variables in the form.
        $formparams = array();
        $formparams['submissiondrafts'] = 1;
        $formparams['duedate'] = 1;
        $formparams['attemptreopenmethod'] = qbassign_ATTEMPT_REOPEN_METHOD_MANUAL;
        ...
        $mform = new mod_qbassign_grading_batch_operations_form(null, $formparams);
