...
require_once($CFG->dirroot . '/mod/qbassign/submission/comments/locallib.php');

/**
 * Unit tests for the qbassignment submission subplugins API's privacy legacy_polyfill.
 *
 * @package     mod_qbassign
 * @category    test
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
...
class submission_legacy_polyfill_test extends \advanced_testcase {
    ...
    public function test_get_context_for_userid_within_submission() {
        ...
        $mock = $this->createMock(test_qbassignsubmission_legacy_polyfill_mock_wrapper::class);
    ...
    public function test_export_submission_user_data() {
        ...
        $subplugin = new \qbassign_submission_comments($qbassign, 'comment');
...
/**
 * Legacy polyfill test class for the qbassignsubmission_provider.
 *
 * @copyright   2018 Adrian Greeve <adriangreeve.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_legacy_polyfill_submission_provider implements \mod_qbassign\privacy\qbassignsubmission_provider {
    use \mod_qbassign\privacy\submission_legacy_polyfill;
    /**
     ...
     * the sql query in \mod_qbassign\privacy\provider::find_grader_info() Then you need to provide some sql to retrive those
    ...
    /**
     * This method is used to export any user data this sub-plugin has using the qbassign_plugin_request_data object to get the
     * context and userid.
     ...
     */
    public static function _export_submission_user_data(\mod_qbassign\privacy\qbassign_plugin_request_data $exportdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_submission_for_context(\mod_qbassign\privacy\qbassign_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
     ...
     */
    public static function _delete_submission_for_userid(\mod_qbassign\privacy\qbassign_plugin_request_data $requestdata) {
        static::$mock->get_return_value(__FUNCTION__, func_get_args());
    }
}
/**
 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_qbassignsubmission_legacy_polyfill_mock_wrapper {
    /**
