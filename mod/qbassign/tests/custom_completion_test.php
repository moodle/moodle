...
use mod_qbassign\completion\custom_completion;
...
/**
 * Class for unit testing mod_qbassign/activity_custom_completion.
 *
 * @package   mod_qbassign
 * @copyright Simey Lameze <simey@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class custom_completion_test extends advanced_testcase {
    ...
    public function test_get_state(string $rule, int $available, ?bool $submitted, ?int $status, ?string $exception) {
        ...
        $qbassign = $this->create_instance($course, ['completion' => COMPLETION_TRACKING_AUTOMATIC, $rule => $available]);
        ...
        $cm = cm_info::create($qbassign->get_course_module());
    ...
    public function test_get_available_custom_rules(int $status, array $expected) {
        ...
        $qbassign = $this->create_instance($course, $params);
        $cm = cm_info::create($qbassign->get_course_module());
