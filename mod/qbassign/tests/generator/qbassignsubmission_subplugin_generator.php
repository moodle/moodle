 ...
 */
abstract class qbassignsubmission_subplugin_generator extends testing_module_generator {
    /**
     ...
     */
    abstract public function add_submission_data(stdClass $submission, qbassign $qbassign, array $data): void;
}
