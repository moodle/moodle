...
/**
 * Downloader tests class for mod_qbassign.
 *
 * @package    mod_qbassign
 * @category   test
 * @copyright  2022 Ferran Recio <ferran@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_qbassign\downloader
 */
class downloader_test extends \advanced_testcase {
     ...
     *
     * @param bool $teamsubmission if the qbassign must have team submissions
     * @param array $groupmembers the groups definition
     * @param array|null $filterusers the filtered users (null for all users)
     * @param bool $blindmarking if the qbassign has blind marking
    ...
    public function test_load_filelist(
        ...
        if (!$downloadasfolder) {
            set_user_preference('qbassign_downloadasfolders', 0);
        }
        ...
        $activity = $this->getDataGenerator()->create_module('qbassign', $params);
        $cm = get_coursemodule_from_id('qbassign', $activity->cmid, 0, false, MUST_EXIST);
        $context = context_module::instance($cm->id);

        // Generate submissions.
        $datagenerator = $this->getDataGenerator()->get_plugin_generator('mod_qbassign');
        $files = [
            "mod/qbassign/tests/fixtures/submissionsample01.txt",
            "mod/qbassign/tests/fixtures/submissionsample02.txt"
        ];
        ...
        $manager = new qbassign($context, $cm, $course);
        ...
        $replace = [get_string('participant', 'mod_qbassign'), get_string('defaultteam', 'mod_qbassign')];
    ...
    private function load_filelist_downloadasfolder_scenarios(string $prefix = "Download as folders:"): array {
        return [
            ...
            $prefix . ' All users without groups' => [
                ...
                'expected' => [
                    'STUDENT1_STUDENT1.ID_qbassignsubmission_file/submissionsample01.txt',
                    'STUDENT1_STUDENT1.ID_qbassignsubmission_file/submissionsample02.txt',
                    'STUDENT2_STUDENT2.ID_qbassignsubmission_file/submissionsample01.txt',
                    'STUDENT2_STUDENT2.ID_qbassignsubmission_file/submissionsample02.txt',
                    'STUDENT3_STUDENT3.ID_qbassignsubmission_file/submissionsample01.txt',
                    'STUDENT3_STUDENT3.ID_qbassignsubmission_file/submissionsample02.txt',
                    'STUDENT4_STUDENT4.ID_qbassignsubmission_file/submissionsample01.txt',
                    'STUDENT4_STUDENT4.ID_qbassignsubmission_file/submissionsample02.txt',
                ],
            ],
            ...
            $prefix . ' All users with all users in groups' => [
                ...
                'downloadasfolder' => true,
                'expected' => [
                    'GROUP1_GROUP1.ID_qbassignsubmission_file/submissionsample01.txt',
                    'GROUP1_GROUP1.ID_qbassignsubmission_file/submissionsample02.txt',
                    'GROUP2_GROUP2.ID_qbassignsubmission_file/submissionsample01.txt',
                    'GROUP2_GROUP2.ID_qbassignsubmission_file/submissionsample02.txt',
                    'GROUP3_GROUP3.ID_qbassignsubmission_file/submissionsample01.txt',
                    'GROUP3_GROUP3.ID_qbassignsubmission_file/submissionsample02.txt',
                ],
            ],
            ...
            $prefix . ' All users with users in the default team' => [
                ...
                'expected' => [
                    'GROUP1_GROUP1.ID_qbassignsubmission_file/submissionsample01.txt',
                    'GROUP1_GROUP1.ID_qbassignsubmission_file/submissionsample02.txt',
                    'DEFAULTTEAM_qbassignsubmission_file/submissionsample01.txt',
                    'DEFAULTTEAM_qbassignsubmission_file/submissionsample02.txt',
                ],
            ],
            ...
            $prefix . ' All users without groups and blindmarking' => [
                ...
                'downloadasfolder' => true,
                'expected' => [
                    'PARTICIPANT_STUDENT1.ID_qbassignsubmission_file/submissionsample01.txt',
                    'PARTICIPANT_STUDENT1.ID_qbassignsubmission_file/submissionsample02.txt',
                    'PARTICIPANT_STUDENT2.ID_qbassignsubmission_file/submissionsample01.txt',
                    'PARTICIPANT_STUDENT2.ID_qbassignsubmission_file/submissionsample02.txt',
                    'PARTICIPANT_STUDENT3.ID_qbassignsubmission_file/submissionsample01.txt',
                    'PARTICIPANT_STUDENT3.ID_qbassignsubmission_file/submissionsample02.txt',
                    'PARTICIPANT_STUDENT4.ID_qbassignsubmission_file/submissionsample01.txt',
                    'PARTICIPANT_STUDENT4.ID_qbassignsubmission_file/submissionsample02.txt',
                ],
            ],
