...
$string['importodp'] = 'Import OpenOffice Impress';
$string['importodp_help'] = 'This feature enables a zip file of OpenOffice Impress 3.x slides saved as web pages to be imported into the lesson.';
...
$string['odpsuccessfullimport'] = 'Successfully imported pages from the uploaded OpenOffice Impress Presentation';
