...
Feature: Lesson group override
  ...
  Scenario: Add both a user and group override and verify that both are applied correctly
    ...
    And I am on "Course 1" course homepage
    And I follow "Test lesson name"
    And the activity date in "Test lesson name" should contain "Opens: 1 January 2031, 8:00 AM"
    And I log out
    And I log in as "student2"
    And I am on "Course 1" course homepage
    And I follow "Test lesson name"
    And the activity date in "Test lesson name" should contain "Opens: 1 January 2040, 8:00 AM"
    And I log out
    And I log in as "student3"
    And I am on "Course 1" course homepage
    And I follow "Test lesson name"
    And the activity date in "Test lesson name" should contain "Opens: 1 January 2030, 8:00 AM"
