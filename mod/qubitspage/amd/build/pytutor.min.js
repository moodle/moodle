define(["jquery"], function (jQuery) {
  ...
  ExecutionVisualizer.prototype.initAllAnnotationBubbles = function () {
    ...
    jqueryNew.each(codelineIDs, function (i, e) {
      myViz.allAnnotationBubbles.push(
        new AnnotationBubble(myViz, "codeline", e)
      );
    });
    ...
    jqueryNew.each(variableIDs, function (i, e) {
      myViz.allAnnotationBubbles.push(
        new AnnotationBubble(myViz, "variable", e)
      );
    });
      ...
      if (!isInstance) {
        $(d3DomElement.selector + " .typeLabel #attrToggleLink").click(
          function () {
            ...
            elt.toggle();
            $(this).html(
              (elt.is(":visible") ? "hide" : "show") + " attributes"
            );
