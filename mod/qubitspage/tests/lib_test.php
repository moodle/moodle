...
/**
 * Unit tests for mod_qubitspage lib
 *
...
class lib_test extends \advanced_testcase {
    ...
    /**
     * Test qubitspage_view
     * @return void
     */
    public function test_qubitspage_view() {
        global $CFG;
        ...
        $page = $this->getDataGenerator()->create_module('qubitspage', array('course' => $course->id),
        ...
        $this->assertInstanceOf('\mod_qubitspage\event\course_module_viewed', $event);
        $this->assertEquals($context, $event->get_context());
        $moodleurl = new \moodle_url('/mod/qubitspage/view.php', array('id' => $cm->id));
    ...
    public function test_page_core_calendar_provide_event_action() {
        ...
        $actionevent = mod_qubitspage_core_calendar_provide_event_action($event, $factory);
    ...
    /**
     * Test mod_qubitspage_core_calendar_provide_event_action with user override
     */
    public function test_page_core_calendar_provide_event_action_user_override() {
        ...
        // Decorate action event.
        $actionevent = mod_qubitspage_core_calendar_provide_event_action($event, $factory, $USER->id);

        // Decorate action with a userid override.
        $actionevent2 = mod_qubitspage_core_calendar_provide_event_action($event, $factory, $user->id);
