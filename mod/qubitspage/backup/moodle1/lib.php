 ...
 */
class moodle1_mod_qubitspage_handler extends moodle1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_qubitspage');
        ...
        // write qubitspage.xml
        $this->open_xml_writer("activities/qubitspage_{$moduleid}/qubitspage.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'qubitspage', 'contextid' => $contextid));
        $this->write_xml('qubitspage', $page, array('/qubitspage/id'));
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();

        // write inforef.xml for migrated resource file.
        $this->open_xml_writer("activities/qubitspage_{$moduleid}/inforef.xml");
