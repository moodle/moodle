...
class mod_qubitspage_mod_form extends moodleform_mod {
    function definition() {
        global $CFG, $DB;
        ...
        $mform->addElement('editor', 'page', get_string('content', 'page'), null, qubitspage_get_editor_options($this->context));
    ...
    public function data_preprocessing(&$defaultvalues) {
        if ($this->current->instance) {
            ...
            $defaultvalues['page']['text']   = file_prepare_draft_area($draftitemid, $this->context->id, 'mod_page',
                    'content', 0, qubitspage_get_editor_options($this->context), $defaultvalues['content']);
