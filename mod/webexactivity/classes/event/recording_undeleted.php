 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class recording_undeleted extends \core\event\base {
    ...
    public function get_description() {
        return 'User with id ' . $this->userid . ' undeleted webex recording with id ' . $this->objectid;
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'webexactivity', 'recording undeleted', 'view.php?id=' . $this->contextinstanceid,
    ...
    public static function get_name() {
        return get_string('event_recording_undeleted', 'webexactivity');
    }
