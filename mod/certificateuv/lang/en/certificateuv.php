...
$string['teachertosign'] = 'Teacher to sign';
$string['teachertosign_help'] = 'Select the teacher that appear like signer in the certificate, remerber that sign of this teacher will be digitalizate, if teacher dont have digital sign, please spoke with the DINTEV department';
$string['textoptions'] = 'Text Options';
$string['title'] = 'CERTIFICATE of ACHIEVEMENT';
$string['timestartcourse'] = 'Date to start course';
$string['timefinalcourse'] = 'Date to finalize course';
