...
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the Glossary activities during this analysis interval (Levels = No view, View, Submit) <a href="{$a}Learning_analytics_indicators#Cognitive_depth" target="_blank">More info</a>';
...
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the Glossary activities during this analysis interval (Levels = No participation, Participant alone) <a href="{$a}Learning_analytics_indicators#Social_breadth" target="_blank">More info</a>';
