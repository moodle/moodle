 ...
 * Output format: hp_6_jcloze_xml_findit_a
 *
 * @package   mod-hotpot
...
/**
 * mod_hotpot_attempt_hp_6_jcloze_xml_findit_a_renderer
 *
 * @copyright 2010 Gordon Bateson
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     Moodle 2.0
 */
class mod_hotpot_attempt_hp_6_jcloze_xml_findit_a_renderer extends mod_hotpot_attempt_hp_6_jcloze_xml_findit_renderer {

    public $js_object_type = 'JClozeFindItA';

    /**
     * hotpot_attempt_hp_6_jcloze_xml_findit_a
     *
    ...
    function init($hotpot)  {
        ...
        array_unshift($this->templatesfolders, 'mod/hotpot/attempt/hp/6/jcloze/xml/findit/a/templates');
