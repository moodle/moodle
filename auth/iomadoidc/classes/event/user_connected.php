...
class user_connected extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserconnected', 'auth_iomadoidc');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has switched to using OpenID Connect (auth plugin 'auth_iomadoidc').";
    }
