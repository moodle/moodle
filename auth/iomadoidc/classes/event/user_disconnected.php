...
class user_disconnected extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserdisconnected', 'auth_iomadoidc');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has disconnected from OpenID Connect (auth plugin 'auth_iomadoidc').";
    }
