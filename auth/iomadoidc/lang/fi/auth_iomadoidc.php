...
$string['cfg_iomadoidcresource_desc'] = 'IOMAD OpenID Connect -resurssi, jota lähetettävä pyyntö koskee.';
...
$string['cfg_redirecturi_desc'] = 'Tämä on rekisteröitävä uudelleenohjauksen URI. IOMAD OpenID Connect -identiteetintarjoaja pyytää tätä tietoa, kun rekisteröit Moodlen asiakkaaksi. <br /><b>HUOMAUTUS:</b> Anna URI IOMAD OpenID Connect -palveluntarjoajan palveluun *täsmälleen* tässä näkyvässä muodossa. Muussa tapauksessa kirjautuminen IOMAD OpenID Connect -palvelun avulla ei onnistu.';
...
$string['errorauthnocreds'] = 'Määritä IOMAD OpenID Connect -asiakkaan tunnistetiedot.';
$string['errorauthnoendpoints'] = 'Määritä IOMAD OpenID Connect -palvelimen päätepisteet.';
$string['errorauthnohttpclient'] = 'Määritä HTTP-asiakas.';
$string['errorauthnoidtoken'] = 'IOMAD OpenID Connectin id_token-avainta ei vastaanotettu.';
$string['errorauthunknownstate'] = 'Tuntematon tila.';
$string['errorauthuseralreadyconnected'] = 'Yhteys on jo muodostettu toiseen IOMAD OpenID Connect -käyttäjään.';
$string['errorauthuserconnectedtodifferent'] = 'Todennettu IOMAD OpenID Connect -käyttäjä on jo yhdistetty Moodle-käyttäjään.';
...
$string['erroriomadoidcnotenabled'] = 'IOMAD OpenID Connect -todennuslisäosa ei ole käytössä.';
...
$string['erroriomadoidccall'] = 'IOMAD OpenID Connect -palvelussa tapahtui virhe. Lisätietoja on lokeissa.';
$string['erroriomadoidccall_message'] = 'Virhe IOMAD OpenID Connect -palvelussa: {$a}';
$string['eventuserauthed'] = 'Käyttäjä valtuutettiin IOMAD OpenID Connectin avulla';
$string['eventusercreated'] = 'Käyttäjä luotiin IOMAD OpenID Connectin avulla';
$string['eventuserconnected'] = 'Käyttäjä yhdistettiin IOMAD OpenID Connectin avulla';
$string['eventuserloggedin'] = 'Käyttäjä kirjautui IOMAD OpenID Connectin avulla';
$string['eventuserdisconnected'] = 'Käyttäjän IOMAD OpenID Connect -yhteys katkaistiin';
$string['iomadoidc:manageconnection'] = 'IOMAD OpenID Connect -yhteyden hallinta';
