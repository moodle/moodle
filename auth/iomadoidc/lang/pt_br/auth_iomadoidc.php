...
$string['cfg_iomadoidcscope_desc'] = 'O escopo do IOMAD OIDC a ser usado.';
...
$string['erroriomadoidcclientnoauthendpoint'] = 'Nenhum ponto de extremidade de autorização definido. Defina-o com $this->setendpoints';
