...
/**
 * Implementation of \auth_classlink\httpclientinterface using Moodle CURL.
 */
class httpclient extends \curl implements \auth_classlink\httpclientinterface {
    /**
    ...
    protected function get_plugin_version() {
        global $CFG;
        $plugin = new \stdClass;
        require_once($CFG->dirroot.'/auth/classlink/version.php');
