...
/**
 * Tests classlinkclient.
 *
 * @group auth_classlink
 * @group office365
 */
class auth_classlink_classlinkclient_testcase extends \advanced_testcase {
    /**
    ...
    public function test_creds_getters_and_setters() {
        $httpclient = new \auth_classlink\tests\mockhttpclient();
        $client = new \auth_classlink\tests\mockclasslinkclient($httpclient);
