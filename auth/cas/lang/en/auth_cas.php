...
$string['auth_cas_allowedhosts'] = 'SLO allowed CAS hosts (comma delimiter)';
$string['auth_cas_allowedhosts_key'] = 'SLO Allowed hosts';
$string['auth_cas_broadcastnodes'] = 'SLO broadcast nodes if your sessions ids are not shared (comma delimiter)';
$string['auth_cas_broadcastnodes_key'] = 'SLO Broadcast nodes';
