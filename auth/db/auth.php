    ...
    function user_login($username, $password) {
        ...
        if ($this->is_internal()) {
            ...
            if ($this->config->passtype === 'plaintext') {
                ...
                // Authentication in django autentication report to https://docs.djangoproject.com/en/1.11/topics/auth/passwords/#how-django-stores-passwords in case of questions.
