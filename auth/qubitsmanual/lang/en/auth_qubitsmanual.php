...
/**
 * Strings for component 'auth_qubitsmanual', language 'en'.
 *
...
$string['auth_qubitsmanualdescription'] = 'This method removes any way for users to create their own accounts.  All accounts must be manually created by the admin user.';
...
$string['pluginname'] = 'Qubits Manual accounts';
