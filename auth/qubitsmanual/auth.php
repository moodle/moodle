 ...
 *
 * @package    auth
 * @subpackage qubitsmanual
 * @copyright  2023 Qubits Dev Team
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auth_plugin_qubitsmanual extends auth_plugin_base {

    /**
     * The name of the component. Used by the configuration.
     */
    const COMPONENT_NAME = 'auth_qubitsmanual';
    const LEGACY_COMPONENT_NAME = 'auth/qubitsmanual';

    /**
     * Constructor.
     */
    public function __construct() {
        $this->authtype = 'qubitsmanual';
     ...
     */
    public function auth_plugin_qubitsmanual() {
    ...
    function user_update_password($user, $newpassword) {
        ...
        set_user_preference('auth_qubitsmanual_passwordupdatetime', time(), $user->id);
    ...
    public function password_expire($username) {
        ...
        if (!empty($this->config->expirationtime)) {
            ...
            $lastpasswordupdatetime = get_user_preferences('auth_qubitsmanual_passwordupdatetime', $user->timecreated, $user->id);
