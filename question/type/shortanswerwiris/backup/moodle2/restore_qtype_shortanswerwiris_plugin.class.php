...
class restore_qtype_shortanswerwiris_plugin extends restore_qtype_shortanswer_plugin {
    ...
    public static function convert_backup_to_questiondata(array $backupdata): \stdClass {
        ...
        if (isset($backupdata['plugin_qtype_shortanswerwiris_question']['shortanswer'])) {
            $backupdata['plugin_qtype_shortanswerwiris_question']['shortanswerwiris'] = $backupdata['plugin_qtype_shortanswerwiris_question']['shortanswer'];
        }
        ...
        if (isset($backupdata['plugin_qtype_shortanswerwiris_question']['question_xml'][0]['xml'])) {
            $questiondata->options->wirisquestion = $backupdata['plugin_qtype_shortanswerwiris_question']['question_xml'][0]['xml'];
        }
