 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ddmarker_renderer extends qtype_with_combined_feedback_renderer {
    ...
    protected static function get_url_for_image(question_attempt $qa, $filearea, $itemid = 0) {
        ...
        $draftfiles = $fs->get_area_files($question->contextid, 'qtype_ddmarker',
                                                                    $filearea, $itemid, 'id');
        if ($draftfiles) {
            foreach ($draftfiles as $file) {
                ...
                $url = moodle_url::make_pluginfile_url($question->contextid, 'qtype_ddmarker',
