...
define(['jquery'], function($) {
    ...
    var closeAllSubMenus = function() {
        $('.core-message-menu .core-message-sub-menu').attr('aria-hidden', 'true');
    ...
    Menubar.prototype.handleClick = function(item, e) {
        ...
        if (parentUL.is('.core-message-menu')) {
    ...
    Menubar.prototype.handleFocus = function(item) {
        ...
        var parentItems = this.activeItem.parentsUntil('ul.core-message-menu').filter('li');
        ...
        if (this.isChildOpen === true) {
            ...
            // show the child menu.
            if (itemUL.is('.core-message-menu') && (item.attr('aria-haspopup') == 'true')) {
                this.openSubMenu(item.children('ul').first());
            }
        }
    ...
    Menubar.prototype.setOpenDirection = function() {
        ...
        var subMenuContainer = this.rootMenus.find('ul.core-message-sub-menu');
        ...
        if (openLeft) {
            this.menuRoot.addClass('core-message-menu-open-left');
        } else {
            this.menuRoot.removeClass('core-message-menu-open-left');
        }
    ...
    Menubar.prototype.handleKeyDown = function(item, e) {
        ...
        switch (e.keyCode) {
            ...
            case this.keys.esc: {
                ...
                if (itemUL.is('.core-message-menu')) {
    ...
    Menubar.prototype.moveToNext = function(item) {
        ...
        if (itemUL.is('.core-message-menu')) {
            ...
            if (item.attr('aria-haspopup') == 'true') {
                ...
                var parentMenus = item.parentsUntil('ul.core-message-menu').filter('ul').not('.core-message-menu');
                ...
                var rootItem = parentMenus.last().parent();
    ...
    Menubar.prototype.addAriaAttributes = function() {
        ...
        this.menuRoot.addClass('core-message-menu');
        this.allItems.addClass('core-message-menu-item');
        this.rootMenus.addClass('core-message-root-menu');
        this.subMenus.addClass('core-message-sub-menu');
    };

    return /** @alias module:core_message/menubar */ {
        /**
