...
<div id="page" class="container-fluid">
    ...
    <div id="page-content" class="row-fluid">
        <div id="<?php echo $regionbsid ?>" class="span12">
            <div class="row-fluid">
                <?php require_once(\theme_essential_uv\toolbox::get_tile_file('twocolumncontent')); ?>
            </div>
            <?php
            if ($pagebottomregion) {
                echo $OUTPUT->essential_uv_blocks('side-pre', 'row-fluid', 'aside', 'pagebottomblocksperrow');
            }
?>
        </div>
    </div>
