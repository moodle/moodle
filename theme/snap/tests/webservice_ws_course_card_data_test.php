...
class webservice_ws_course_card_data_test extends \advanced_testcase {
    ...
    public function test_service_returns() {
        $returns = \theme_snap\webservice\ws_course_cards_data::service_returns();
    ...
    public function test_service() {
        ...
        // Create course.
        $course = $this->getDataGenerator()->create_course(['startdate' => '1252304000', 'enddate' => '1462304000']);
        // Enrol student.
        $this->getDataGenerator()->enrol_user($user->id,
            $course->id,
            $sturole->id);
        ...
        $serviceresult = \theme_snap\webservice\ws_course_cards_data::service(0, 'current');
