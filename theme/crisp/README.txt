...
From your Moodle theme directory right click on Crisp and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of Crisp.
...
where the old theme name occurs, in this case Crisp. So using the above list as
a guide, search through and change all the instances of the theme name
'Crisp' to 'cleantheme'. This includes the filename of the lang/en/theme_Crisp.php.
...
The settings page for the Crisp theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > Crisp
