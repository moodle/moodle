								...
								<div id="login-body">
									<?php
											...
											<div id="info-user-login">
												...
												<a href="<?php $CFG->wwwroot?>/my/" id="btn-info-user-login">Mis Cursos</a>
												<a href="<?php $CFG->wwwroot?>/user/profile.php?id=<?php echo $USER->id;?>" id="btn-info-user-login">Perfil</a>
												<a href="<?php $CFG->wwwroot?>/login/logout.php?sesskey=<?php echo $USER->sesskey;?>" id="btn-info-user-login">Salir</a>
											</div>
											<?php
											}
											else{
							...
							<div class="forforum span4">
								...
								<div class="texts">
										 <div id="owl-slide2">
										    	...
										    	<div class="item">
										    		<a class="video" target="blank" href="https://www.youtube.com/watch?v=3lzc2WMQz48"><img src="<?php echo $CFG->wwwroot?>/theme/<?php echo $CFG->theme?>/pix/sabias1.png"></a>
										    	</div>
										    	<div class="item">
										    		<a class="video" target="blank" href="https://www.youtube.com/watch?v=gkkLl7mhicI"><img src="<?php echo $CFG->wwwroot?>/theme/<?php echo $CFG->theme?>/pix/sabias2.png"></a>
										    	</div>
										    	<div class="item">
										    		<a class="video" target="blank" href="https://www.youtube.com/watch?v=_gccI-ij0_k"><img src="<?php echo $CFG->wwwroot?>/theme/<?php echo $CFG->theme?>/pix/sabias3.png"></a>
										    	</div>
										    	<div class="item">
										    		<a class="video" target="blank" href="https://www.youtube.com/watch?v=TojD-rGmzbE"><img src="<?php echo $CFG->wwwroot?>/theme/<?php echo $CFG->theme?>/pix/sabias4.png"></a>
										    	</div>
