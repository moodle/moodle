...
class theme_elegance_core_renderer extends theme_bootstrap_core_renderer {
    ...
    protected function render_custom_menu(custom_menu $menu) {
        ...
        $menu->add(get_string('aboutus', 'theme_elegance'), new moodle_url($CFG->wwwroot."/course/view.php?id=201"), '', 3);
        $menu->add(get_string('techsupport', 'theme_elegance'), new moodle_url($CFG->wwwroot."/local/customlogin/forgot.php"), '', 4);
        $abtar = $menu->add(get_string('availability', 'theme_elegance'), null,'atbar', 5);
        $abtar->add(get_string('availability', 'theme_elegance'), new moodle_url($CFG->wwwroot . "/theme/elegance/doc/accessibility.pdf"));
/*old version   
