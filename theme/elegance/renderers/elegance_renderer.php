...
class theme_elegance_widgets_renderer extends plugin_renderer_base {
    ...
    public function navbar($hasnavbar) {
        ...
        $template->aboutustitle = get_string('aboutus', 'theme_elegance');
        $template->techsupporttitle = get_string('techsupport', 'theme_elegance');
        $template->availabilitytitle = get_string('availability', 'theme_elegance');
    ...
    public function my_courses_slick($hascoursesslick) {
       ...
       $template->leftbtn = $OUTPUT->pix_url('icons/left', 'theme_elegance');
       $template->rightbtn = $OUTPUT->pix_url('icons/right', 'theme_elegance');

	if (!empty($template->courses)){
       		return $this->render_from_template('theme_elegance/mycourses', $template);
	}else{
		return '';
	}
    ...
    public function login_overlay($hasloginoverlay) {
        ...
        $template->img = $OUTPUT->pix_url('icons/login', 'theme_elegance');
        ...
        return $this->render_from_template('theme_elegance/loginoverlay', $template);
