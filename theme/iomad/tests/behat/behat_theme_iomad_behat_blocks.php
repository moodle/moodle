...
/**
 * Step definitions related to blocks overrides for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
...
/**
 * Blocks management step definitions for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_iomad_behat_blocks extends behat_blocks {
