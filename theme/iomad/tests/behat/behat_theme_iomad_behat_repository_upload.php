...
/**
 * Override definitions for the upload repository type for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
...
/**
 * Override step definitions to deal with the upload repository in the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_iomad_behat_repository_upload extends behat_repository_upload {
