...
/**
 * Navigation step definition overrides for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
...
/**
 * Step definitions and overrides to navigate through the navigation tree nodes in the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_iomad_behat_navigation extends behat_navigation {
    /**
