...
/**
 * Step definitions related to administration overrides for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
...
/**
 * Site administration level steps definitions overrides for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_iomad_behat_admin extends behat_admin {
