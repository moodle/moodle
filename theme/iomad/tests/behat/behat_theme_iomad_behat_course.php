...
/**
 * Behat course-related step definition overrides for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
...
/**
 * Course-related step definition overrides for the Iomad theme.
 *
 * @package    theme_iomad
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_iomad_behat_course extends behat_course {
