...
function theme_iomad_css_tree_post_processor($tree, $theme) {
    error_log('theme_iomad_css_tree_post_processor() is deprecated. Required' .
        'prefixes for Bootstrap are now in theme/iomad/scss/moodle/prefixes.scss');
 ...
 * @return array[]
 */
function theme_iomad_user_preferences(): array {
    return [
        'drawer-open-block' => [
            'type' => PARAM_BOOL,
