    ...
    <div id="page-content" class="row-fluid">
        <div id="<?php echo $regionbsid ?>" class="span9">
            <div class="row-fluid">
                ...
                <?php } ?>
                    <?php
                    $context = $OUTPUT->body_attributes();
                    if (strpos($context, 'path-user')) {
                        echo $OUTPUT->lambda_participants_header();
                        
                    } else if (strpos($context, 'format-site')) {
                        echo $OUTPUT->lambda_fpsite_header();
                        
                    } else {
                        echo $OUTPUT->lambda_incourse_header();
                    }
