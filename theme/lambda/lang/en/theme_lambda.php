...
$string['section_0_open'] = 'Top Course Section Always Open';
$string['section_0_open_desc'] = 'Select this setting if you would like to have the top general course section always open. With the "Topics" or "Weekly" course format the top section of a course can no longer be collapsed.';
...
$string['bs4_layout_files'] = 'Load Bootstrap 4 layout files';
$string['bs4_layout_files_desc'] = 'Select this option to enable compatibility with the Bootstrap 4 grid layout. This setting should be used only if you previously used a Boost-based theme and your created content is now displayed differently with Lambda than before.';
...
$string['chat'] = 'Chat Application URL';
$string['chatdesc'] = 'Enter the URL for a chat application.';
$string['socials_phone'] = 'Phone Number';
$string['socials_phone_desc'] = 'Enter a contact phone number.';
...
$string['use_fa5'] = 'Font Awesome 5/6';
$string['use_fa5_desc'] = 'Use the new Font Awesome 6 Web Font icons.<br /><strong>Please note:</strong> If you already have content with Font Awesome 4 icons, please note that there are some differences from v4 to keep in mind when using v6. If you would like to upgrade, please make sure to read the <a href="https://fontawesome.com/docs/web/setup/upgrade/upgrade-from-v4" target="_blank">upgrade tutorial</a>.<br />For new projects, the latest version 6 is recommended.';
