...
$ADMIN->add('themes', new admin_category('theme_lambda', 'Theme-Lambda'));
	...
	// general course section always open
	$name = 'theme_lambda/section_0_open';
    $title = get_string('section_0_open', 'theme_lambda');
    $description = get_string('section_0_open_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
	...
	// BS4 grid
	$name = 'theme_lambda/bs4_layout_files';
    $title = get_string('bs4_layout_files', 'theme_lambda');
    $description = get_string('bs4_layout_files_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
	...
	// Phone setting.
    $name = 'theme_lambda/socials_phone';
    $title = get_string('socials_phone', 'theme_lambda');
    $description = get_string('socials_phone_desc', 'theme_lambda');
    $default = '';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    // Chat url setting.
    $name = 'theme_lambda/chat';
    $title = get_string('chat', 'theme_lambda');
    $description = get_string('chatdesc', 'theme_lambda');
    $default = '';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $default = 'shortname';
    $choices = array(
        'shortname' => get_string('home_button_shortname','theme_lambda'),
        'home' => get_string('home'),
        'icon' => get_string('home_button_icon','theme_lambda'));
    $setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
	...
	// hide breadcrumb for guest users
