...
class theme_iomadbootstrap_core_renderer extends core_renderer {
    ...
    public function content_zoom() {
        $zoomin = html_writer::span(get_string('fullscreen', 'theme_iomadbootstrap'), 'zoomin');
        $zoomout = html_writer::span(get_string('closefullscreen', 'theme_iomadbootstrap'), 'zoomout');
