...
/**
 * Creates a navbar for iomadboost that allows easy control of the navbar items.
 *
 * @package    theme_iomadboost
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class iomadboostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_iomadboost();
    }

    /**
     * Prepares the navigation nodes for use with iomadboost.
     */
    protected function prepare_nodes_for_iomadboost(): void {
        global $PAGE;
    ...
    /**
     * Get all the iomadboostnavbaritem elements.
     *
     * @return iomadboostnavbaritem[] IOMAD Boost navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this iomadboost navbar
     */
    ...
    /**
     * Remove a iomadboostnavbaritem from the iomadboost navbar.
     *
     * @param  string|int $itemkey An identifier for the iomadboostnavbaritem
     * @param  int|null $itemtype An additional type identifier for the iomadboostnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the iomadboostnavbaritem.
     */
