...
require_once(__DIR__ . '/behat_theme_noname_behat_navigation.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_noname_behat_backup extends behat_backup {

    protected function navigate_to_course_settings_link($langstring, $component = '') {
        $behatnavigation = new behat_theme_noname_behat_navigation();
