...
namespace aiplacement_courseassistimprove\external;

use aiplacement_courseassistimprove\utils;
use core_external\external_api;
use core_external\external_function_parameters;
use core_external\external_value;

/**
 * External API to call improve text action for this placement.
 *
 * @package    aiplacement_courseassistimprove
 * @copyright  2024 Huong Nguyen <huongnv13@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class improve_text extends external_api {

    /**
     * Improve text parameters.
     *
    ...
    /**
     * Improve text from the AI placement.
     *
    ...
    public static function execute(
        ...
        // error_log("apeeeeeeeee" . $prompttext);
        if (!utils::is_course_assist_available($context)) {
            throw new \moodle_exception('nocourseassist', 'aiplacement_courseassistimprove');
        }

        // Prepare the action.
        $action = new \core_ai\aiactions\improve_text(
            contextid: $contextid,
            userid: $USER->id,
            prompttext: $prompttext,
        );
