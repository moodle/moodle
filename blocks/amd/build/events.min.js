...
/**
   ...
   * });
   */
var eventTypes={blockContentUpdated:"core_block/contentUpdated"};_exports.eventTypes=eventTypes;_exports.notifyBlockContentUpdated=function(element){return(0,_event_dispatcher.dispatchEvent)(eventTypes.blockContentUpdated,{instanceId:element.dataset.instanceId},element)};var legacyEventsRegistered=!1;legacyEventsRegistered||(Y.use("event","moodle-core-event",(function(Y){document.addEventListener(eventTypes.blockContentUpdated,(function(e){Y.Global.fire(M.core.event.BLOCK_CONTENT_UPDATED,{instanceid:e.detail.instanceId})}))})),legacyEventsRegistered=!0)}));
