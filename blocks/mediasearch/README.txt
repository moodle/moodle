...
* Rename the mediasearch/ folder to the name of your module (eg "widget").
...
all the instances of the string "mediasearch" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/mediasearch/widget/g' {} \;

* Rename the file lang/en/mediasearch.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_mediasearch.php
...
and you should find that this mediasearch has been added to the list of
installed modules.
