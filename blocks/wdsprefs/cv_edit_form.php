...
class wdsprefs_cps_edit_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text',
            ...
            ['class' => 'wds-text-input wds-first']
        );
        $mform->setType('wdspref_createprior', PARAM_INT);
        $mform->addRule('wdspref_createprior', null, 'required', null, 'client');

        // Add a help button.
        $mform->addHelpButton('wdspref_createprior', 'wdsprefs:cdaysprior', 'block_wdsprefs');
        ...
        // Add a help button.
        $mform->addHelpButton('wdspref_courselimit', 'wdsprefs:courselimit', 'block_wdsprefs');
