...
use block_learnerscript\Spout\Reader\Wrapper\SimpleXMLElement;
use block_learnerscript\Spout\Reader\Wrapper\XMLReader;
use block_learnerscript\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyFactory;
use block_learnerscript\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyInterface;
...
class SharedStringsHelper
{
     ...
     *
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If sharedStrings.xml can't be read
     */
    public function extractSharedStrings()
    {
        ...
        $escaper = \block_learnerscript\Spout\Common\Escaper\XLSX::getInstance();
     ...
     *
     * @param \block_learnerscript\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @return int|null Number of unique shared strings in the sharedStrings.xml file
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     */
     ...
     *
     * @param \block_learnerscript\Spout\Reader\Wrapper\XMLReader $xmlReader
     * @return \block_learnerscript\Spout\Reader\Wrapper\SimpleXMLElement
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If the current node cannot be read
     */
     ...
     *
     * @param \block_learnerscript\Spout\Reader\Wrapper\SimpleXMLElement $parentNode Parent node that may contain nodes to remove
     * @return \block_learnerscript\Spout\Reader\Wrapper\SimpleXMLElement Cleaned parent node
     */
     ...
     *
     * @param \block_learnerscript\Spout\Reader\Wrapper\SimpleXMLElement $textNode The text node element (<t>) whitespace may be preserved
     ...
     * @throws \block_learnerscript\Spout\Reader\Exception\SharedStringNotFoundException If no shared string found for the given index
     */
