...
namespace block_learnerscript\Spout\Reader\ODS\Helper;

/**
 * Class CellValueFormatter
 * This class provides helper functions to format cell values
 *
 * @package block_learnerscript\Spout\Reader\ODS\Helper
 */
class CellValueFormatter
{
    ...
    /** @var \block_learnerscript\Spout\Common\Escaper\ODS Used to unescape XML data */
    protected $escaper;
    ...
    public function __construct($shouldFormatDates)
    {
        ...
        $this->escaper = \block_learnerscript\Spout\Common\Escaper\ODS::getInstance();
    }
