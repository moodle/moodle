...
use block_learnerscript\Spout\Writer\Common\Helper\AbstractStyleHelper;
use block_learnerscript\Spout\Writer\Style\Color;
use block_learnerscript\Spout\Writer\Style\Style;
...
class StyleHelper extends AbstractStyleHelper
{
     ...
     *
     * @param \block_learnerscript\Spout\Writer\Style\Style $style
     * @return \block_learnerscript\Spout\Writer\Style\Style
     */
...
EOD;
    ...
    protected function getFontsSectionContent()
    {
        ...
        /** @var \block_learnerscript\Spout\Writer\Style\Style $style */
        ...
        foreach ($this->registeredBorders as $styleId) {
            ...
            foreach ($sortOrder as $partName) {
                if ($border->hasPart($partName)) {
                    /** @var $part \block_learnerscript\Spout\Writer\Style\BorderPart */
