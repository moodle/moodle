...
namespace block_learnerscript\Spout\Writer\XLSX\Helper;
 ...
 *
 * @package block_learnerscript\Spout\Writer\XLSX\Helper
 */
class SharedStringsHelper
{
...
EOD;
    ...
    /** @var \block_learnerscript\Spout\Common\Escaper\XLSX Strings escaper */
    ...
    public function __construct($xlFolder)
    {
        ...
        $this->stringsEscaper = \block_learnerscript\Spout\Common\Escaper\XLSX::getInstance();
    }
     ...
     *
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If the sheet data file cannot be opened for writing
     */
