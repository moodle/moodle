...
class assignmentfield_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'crformheader', get_string('assignmentfield', 'block_learnerscript'), '');

        $columns = $DB->get_columns('qbassign');
