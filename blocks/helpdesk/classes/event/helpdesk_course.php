...
/**
 * The helpdesk_course event class.
 *
...
class helpdesk_course extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventhelpdeskcourse', 'blocks_helpdesk');
    }
