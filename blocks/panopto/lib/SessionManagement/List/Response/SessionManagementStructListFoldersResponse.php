 ...
 */
 /**
 * File for class SessionManagementStructListFoldersResponse
 ...
 */
/**
 * This class stands for SessionManagementStructListFoldersResponse originally named ListFoldersResponse
 ...
 * @date 2017-01-19
 */
class SessionManagementStructListFoldersResponse extends SessionManagementWsdlClass
{
    /**
     * The Results
     * Meta informations extracted from the WSDL
     ...
     * @param SessionManagementStructArrayOfFolder $_results
    ...
    {
        parent::__construct(array('Results'=>($_results instanceof SessionManagementStructArrayOfFolder)?$_results:new SessionManagementStructArrayOfFolder($_results),'TotalNumberResults'=>$_totalNumberResults),false);
    }
    /**
     * Get Results value
    ...
    /**
     * Set Results value
     * @param SessionManagementStructArrayOfFolder $_results the Results
