 ...
 */
 /**
 * File for class SessionManagementStructGetExtendedCreatorFoldersList
 ...
 */
/**
 * This class stands for SessionManagementStructGetExtendedCreatorFoldersList originally named GetCreatorFoldersList
 ...
 * @date 2017-01-19
 */
class SessionManagementStructGetExtendedCreatorFoldersList extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $searchQuery;
    /**
     * Constructor method for GetCreatorFoldersList
     ...
     * @return SessionManagementStructGetExtendedCreatorFoldersList
     */
