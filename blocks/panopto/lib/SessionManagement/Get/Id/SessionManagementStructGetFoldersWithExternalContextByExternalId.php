 ...
 */
 /**
 * File for class SessionManagementStructGetFoldersWithExternalContextByExternalId
 ...
 */
/**
 * This class stands for SessionManagementStructGetFoldersWithExternalContextByExternalId originally named GetFoldersWithExternalContextByExternalId
 ...
 * @date 2017-01-19
 */
class SessionManagementStructGetFoldersWithExternalContextByExternalId extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetFoldersWithExternalContextByExternalId
     * @see parent::__construct()
     * @param SessionManagementStructAuthenticationInfo $_auth
     * @param SessionManagementStructArrayOfstring $_folderExternalIds
     * @return SessionManagementStructGetFoldersWithExternalContextByExternalId
     */
