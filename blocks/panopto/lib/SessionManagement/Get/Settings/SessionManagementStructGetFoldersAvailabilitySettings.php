 ...
 */
 /**
 * File for class SessionManagementStructGetFoldersAvailabilitySettings
 ...
 */
/**
 * This class stands for SessionManagementStructGetFoldersAvailabilitySettings originally named GetFoldersAvailabilitySettings
 ...
 * @date 2017-01-19
 */
class SessionManagementStructGetFoldersAvailabilitySettings extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $folderIds;
    /**
     * Constructor method for GetFoldersAvailabilitySettings
     * @see parent::__construct()
     * @param SessionManagementStructAuthenticationInfo $_auth
     * @param SessionManagementStructArrayOfguid $_folderIds
     * @return SessionManagementStructGetFoldersAvailabilitySettings
     */
