 ...
 */
 /**
 * File for class SessionManagementStructSessionAvailabilitySettings
 ...
 */
/**
 * This class stands for SessionManagementStructSessionAvailabilitySettings originally named SessionAvailabilitySettings
 ...
 * @date 2017-01-19
 */
class SessionManagementStructSessionAvailabilitySettings extends SessionManagementWsdlClass
{
    /**
     * The EndSettingDate
     * Meta informations extracted from the WSDL
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var SessionManagementEnumSessionStartSettingType
     */
    public $StartSettingType;
    /**
     * Constructor method for SessionAvailabilitySettings
     * @see parent::__construct()
     * @param SessionManagementStructDateTimeOffset $_endSettingDate
     * @param SessionManagementEnumSessionEndSettingType $_endSettingType
     * @param string $_sessionId
     * @param SessionManagementStructDateTimeOffset $_startSettingDate
     * @param SessionManagementEnumSessionStartSettingType $_startSettingType
     * @return SessionManagementStructSessionAvailabilitySettings
     */
    public function __construct($_endSettingDate = NULL,$_endSettingType = NULL,$_sessionId = NULL,$_startSettingDate = NULL,$_startSettingType = NULL)
    {
        parent::__construct(array('EndSettingDate'=>$_endSettingDate,'EndSettingType'=>$_endSettingType,'SessionId'=>$_sessionId,'StartSettingDate'=>$_startSettingDate,'StartSettingType'=>$_startSettingType),false);
    }
    /**
     ...
     * @param SessionManagementEnumSessionEndSettingType $_endSettingType the EndSettingType
     * @return SessionManagementEnumSessionEndSettingType
     */
    public function setEndSettingType($_endSettingType)
    {
        if(!SessionManagementEnumSessionEndSettingType::valueIsValid($_endSettingType))
        {
            return false;
        }
     ...
     * @return SessionManagementEnumSessionStartSettingType|null
     */
     ...
     * @uses SessionManagementEnumSessionStartSettingType::valueIsValid()
     * @param SessionManagementEnumSessionStartSettingType $_startSettingType the StartSettingType
     * @return SessionManagementEnumSessionStartSettingType
     */
    public function setStartSettingType($_startSettingType)
    {
        if(!SessionManagementEnumSessionStartSettingType::valueIsValid($_startSettingType))
        {
            return false;
        }
