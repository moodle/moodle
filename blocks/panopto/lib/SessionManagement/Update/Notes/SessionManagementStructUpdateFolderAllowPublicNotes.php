 ...
 */
 /**
 * File for class SessionManagementStructUpdateFolderAllowPublicNotes
 ...
 */
/**
 * This class stands for SessionManagementStructUpdateFolderAllowPublicNotes originally named UpdateFolderAllowPublicNotes
 ...
 * @date 2017-01-19
 */
class SessionManagementStructUpdateFolderAllowPublicNotes extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for UpdateFolderAllowPublicNotes
     * @see parent::__construct()
     * @param SessionManagementStructAuthenticationInfo $_auth
     * @param string $_folderId
     * @param boolean $_allowPublicNotes
     * @return SessionManagementStructUpdateFolderAllowPublicNotes
     */
    public function __construct($_auth = NULL,$_folderId = NULL,$_allowPublicNotes = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'folderId'=>$_folderId,'allowPublicNotes'=>$_allowPublicNotes),false);
    }
    /**
     * Get auth value
