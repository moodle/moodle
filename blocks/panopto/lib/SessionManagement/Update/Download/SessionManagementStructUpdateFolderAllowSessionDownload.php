 ...
 */
 /**
 * File for class SessionManagementStructUpdateFolderAllowSessionDownload
 ...
 */
/**
 * This class stands for SessionManagementStructUpdateFolderAllowSessionDownload originally named UpdateFolderAllowSessionDownload
 ...
 * @date 2017-01-19
 */
class SessionManagementStructUpdateFolderAllowSessionDownload extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for UpdateFolderAllowSessionDownload
     * @see parent::__construct()
     * @param SessionManagementStructAuthenticationInfo $_auth
     * @param string $_folderId
     * @param boolean $_allowSessionDownload
     * @return SessionManagementStructUpdateFolderAllowSessionDownload
     */
    public function __construct($_auth = NULL,$_folderId = NULL,$_allowSessionDownload = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'folderId'=>$_folderId,'allowSessionDownload'=>$_allowSessionDownload),false);
    }
    /**
     * Get auth value
