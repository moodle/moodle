 ...
 */
 /**
 * File for class SessionManagementStructSetExternalCourseAccessForRoles
 ...
 */
/**
 * This class stands for SessionManagementStructSetExternalCourseAccessForRoles originally named SetExternalCourseAccessForRoles
 ...
 * @date 2017-01-19
 */
class SessionManagementStructSetExternalCourseAccessForRoles extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $roles;
    /**
     * Constructor method for SetExternalCourseAccessForRoles
     ...
     * @return SessionManagementStructSetExternalCourseAccessForRoles
     */
    public function __construct($_auth = NULL,$_name = NULL,$_externalId = NULL,$_folderIds = NULL,$_roles = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'name'=>$_name,'externalId'=>$_externalId,'folderIds'=>($_folderIds instanceof SessionManagementStructArrayOfguid)?$_folderIds:new SessionManagementStructArrayOfguid($_folderIds),'roles'=>($_roles instanceof SessionManagementStructArrayOfAccessRole)?$_roles:new SessionManagementStructArrayOfAccessRole($_roles)),false);
    }
    /**
     * Get auth value
