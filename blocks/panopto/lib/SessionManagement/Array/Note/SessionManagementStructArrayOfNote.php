 ...
 */
 /**
 * File for class SessionManagementStructArrayOfNote
 ...
 */
/**
 * This class stands for SessionManagementStructArrayOfNote originally named ArrayOfNote
 ...
 * @date 2017-01-19
 */
class SessionManagementStructArrayOfNote extends SessionManagementWsdlClass
{
    /**
     * The Note
     * Meta informations extracted from the WSDL
     ...
     * @param SessionManagementStructNote $_note
     * @return SessionManagementStructArrayOfNote
     */
    public function __construct($_note = NULL)
    {
        parent::__construct(array('Note'=>$_note),false);
    }
    /**
     * Get Note value
    ...
    /**
     * Set Note value
     * @param SessionManagementStructNote $_note the Note
