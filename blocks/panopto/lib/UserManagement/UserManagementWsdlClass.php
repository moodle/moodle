...
/**
 * File for UserManagementWsdlClass to communicate with SOAP service
 ...
 */
/**
 * UserManagementWsdlClass to communicate with SOAP service
 *
 * @package UserManagement
 * @author Panopto
 * @version 20150429-01
...
class UserManagementWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    ...
    /**
     * Constructor
     * @uses UserManagementWsdlClass::setLastError()
     * @uses UserManagementWsdlClass::initSoapClient()
     * @uses UserManagementWsdlClass::initInternArrayToIterate()
     * @uses UserManagementWsdlClass::_set()
     ...
     * @return UserManagementWsdlClass
     */
     ...
     * @return UserManagementWsdlClass|null
     */
    public static function __set_state(array $_array)
    {
        ...
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'UserManagementWsdlClass'))
            {
     ...
     * @uses UserManagementClassMap::classMap()
     * @uses UserManagementWsdlClass::getDefaultWsdlOptions()
     * @uses UserManagementWsdlClass::getSoapClientClassName()
     * @uses UserManagementWsdlClass::setSoapClient()
     ...
     * If a class is named as {UserManagement}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('UserManagementSoapClient') && is_subclass_of('UserManagementSoapClient','PanoptoTimeoutSoapClient'))
            return 'UserManagementSoapClient';
        else
            return 'PanoptoTimeoutSoapClient';
    }
    /**
     * Method returning all default options values
     * @uses UserManagementWsdlClass::WSDL_CACHE_WSDL
     * @uses UserManagementWsdlClass::WSDL_COMPRESSION
     * @uses UserManagementWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses UserManagementWsdlClass::WSDL_ENCODING
     * @uses UserManagementWsdlClass::WSDL_EXCEPTIONS
     * @uses UserManagementWsdlClass::WSDL_FEATURES
     * @uses UserManagementWsdlClass::WSDL_LOGIN
     * @uses UserManagementWsdlClass::WSDL_PASSWORD
     * @uses UserManagementWsdlClass::WSDL_SOAP_VERSION
     * @uses UserManagementWsdlClass::WSDL_STREAM_CONTEXT
     * @uses UserManagementWsdlClass::WSDL_TRACE
     * @uses UserManagementWsdlClass::WSDL_TYPEMAP
     * @uses UserManagementWsdlClass::WSDL_URL
     * @uses UserManagementWsdlClass::WSDL_USER_AGENT
     * @uses UserManagementWsdlClass::WSDL_PROXY_HOST
     * @uses UserManagementWsdlClass::WSDL_PROXY_PORT
     * @uses UserManagementWsdlClass::WSDL_PROXY_LOGIN
     * @uses UserManagementWsdlClass::WSDL_PROXY_PASSWORD
     * @uses UserManagementWsdlClass::WSDL_LOCAL_CERT
     * @uses UserManagementWsdlClass::WSDL_PASSPHRASE
     * @uses UserManagementWsdlClass::WSDL_AUTHENTICATION
     * @uses UserManagementWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses UserManagementWsdlClass::getSoapClient()
     * @uses UserManagementWsdlClass::getFormatedXml()
     ...
     * @uses UserManagementWsdlClass::getSoapClient()
     * @uses UserManagementWsdlClass::convertStringHeadersToArray()
     ...
     * @uses UserManagementWsdlClass::count()
     * @return int
     */
     ...
     * @uses UserManagementWsdlClass::getInternArrayToIterate()
     * @uses UserManagementWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses UserManagementWsdlClass::getInternArrayToIterateOffset()
     * @uses UserManagementWsdlClass::setInternArrayToIterateOffset()
     * @return void
     */
     ...
     * @uses UserManagementWsdlClass::getInternArrayToIterateOffset()
     * @uses UserManagementWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see UserManagementWsdlClass::offsetGet()
     * @uses UserManagementWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses UserManagementWsdlClass::getAttributeName()
     * @uses UserManagementWsdlClass::__toString()
     * @uses UserManagementWsdlClass::_set()
     * @uses UserManagementWsdlClass::_get()
     * @uses UserManagementWsdlClass::setInternArrayToIterate()
     * @uses UserManagementWsdlClass::setInternArrayToIterateIsArray()
     * @uses UserManagementWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses UserManagementWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses UserManagementWsdlClass::item()
     * @uses UserManagementWsdlClass::length()
     * @return mixed
     */
...
*/
class UserManagementSoapClient extends PanoptoTimeoutSoapClient {
