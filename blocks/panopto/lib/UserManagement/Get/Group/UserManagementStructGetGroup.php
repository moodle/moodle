 ...
 */
 /**
 * File for class UserManagementStructGetGroup
 ...
 */
/**
 * This class stands for UserManagementStructGetGroup originally named GetGroup
 ...
 * @date 2017-01-19
 */
class UserManagementStructGetGroup extends UserManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $groupId;
    /**
     * Constructor method for GetGroup
     * @see parent::__construct()
     * @param UserManagementStructAuthenticationInfo $_auth
     * @param string $_groupId
     * @return UserManagementStructGetGroup
     */
    public function __construct($_auth = NULL,$_groupId = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'groupId'=>$_groupId),false);
    }
    /**
     * Get auth value
