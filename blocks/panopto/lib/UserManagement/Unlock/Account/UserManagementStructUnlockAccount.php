 ...
 */
 /**
 * File for class UserManagementStructUnlockAccount
 ...
 */
/**
 * This class stands for UserManagementStructUnlockAccount originally named UnlockAccount
 ...
 * @date 2017-01-19
 */
class UserManagementStructUnlockAccount extends UserManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $userId;
    /**
     * Constructor method for UnlockAccount
     * @see parent::__construct()
     * @param UserManagementStructAuthenticationInfo $_auth
     * @param string $_userId
     * @return UserManagementStructUnlockAccount
     */
    public function __construct($_auth = NULL,$_userId = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'userId'=>$_userId),false);
    }
    /**
     * Get auth value
