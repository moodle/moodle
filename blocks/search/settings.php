...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('block_search_text', get_string('configsearchtext', 'block_search'),
                       get_string('headingofsearchblock', 'block_search'), get_string('searchmoodle', 'block_search'), PARAM_ALPHANUM));

    //Button Label
    $settings->add(new admin_setting_configtext('block_search_button', get_string('configbuttonlabel', 'block_search'),
                       get_string('labelofsearchbutton', 'block_search'), get_string('go', 'block_search'), PARAM_ALPHANUM));
    ...
    $settings->add(new admin_setting_configtext('block_search_filetypes', get_string('configfiletypes', 'block_search'),
                       get_string('listoffiletypes', 'block_search'), $defaultfiletypes, PARAM_ALPHANUM));
    ...
    $settings->add(new admin_setting_configtext('block_search_pdf_to_text_cmd', get_string('configpdftotextcmd', 'block_search'),
                       get_string('pdftotextcmd', 'block_search'), $default_pdf_to_text_cmd, PARAM_INT, 60));

    //word_to_text_cmd
    $settings->add(new admin_setting_configtext('block_search_word_to_text_cmd', get_string('configwordtotextcmd', 'block_search'),
                       get_string('wordtotextcmd', 'block_search'), $default_word_to_text_cmd, PARAM_INT, 60));
