...
function buildMenu($cid) {
    ...
    $outputhtml = '<div class = "floatright">'
                . '<form action="'.$CFG->wwwroot. '/blocks/rollsheet/genpics/show.php?cid='.$cid.'" method="post"> '
    ...
    $outputhtml .= '<input type="hidden" name="orderby" value="'.$orderby.'">'
                    . '<input type="submit" value="'.get_string('printbutton', 'block_rollsheet').'"></span></form></div></div>';
    return $outputhtml;
}
