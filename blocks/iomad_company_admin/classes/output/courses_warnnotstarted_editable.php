 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class courses_warnnotstarted_editable extends \core\output\inplace_editable {
    ...
    public function __construct($company, $companycontext, $course, $currentvalue) {
        ...
        parent::__construct('block_iomad_company_admin', 'courses_warnnotstarted', $itemid, $editable, $value, $value);
    ...
    public static function update($itemid, $newvalue) {
        ...
        $warnnotstarted = json_decode($newvalue);
        $warnnotstarted = clean_param($warnnotstarted, PARAM_INT);
        if ($warnnotstarted < 0) {
            $warnnotstarted = 0;
        }
        ...
        return new self($company, $companycontext, $courserec, $warnnotstarted);
    }
}
