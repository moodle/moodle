...
class courses_warnexpire_editable extends \core\output\inplace_editable {
    ...
    public function __construct($company, $context, $course, $currentvalue) {
        ...
        parent::__construct('block_iomad_company_admin', 'courses_warnexpire', $itemid, $editable, $value, $value);
    ...
    public static function update($itemid, $newvalue) {
        ...
        $warnexpire = json_decode($newvalue);
        $warnexpire = clean_param($warnexpire, PARAM_INT);
        if ($warnexpire < 0) {
            $warnexpire = 0;
        }
        ...
        return new self($company, $context, $courserec, $warnexpire);
    }
}
