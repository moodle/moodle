...
/**
 * The block_iomad_company_admin company deleted event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companydeleted', 'block_iomad_company_admin');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted company with id'" . s($this->other['companyid']);
    }
