...
/**
 * The block_iomad_company_admin company user unsuspended event.
 *
...
/**
 * The block_iomad_company_user company user unsuspended event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_user_unsuspended extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companyuserunsuspended', 'block_iomad_company_admin');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' was unsuspended in the company " . $this->other['companyname'];
    }
