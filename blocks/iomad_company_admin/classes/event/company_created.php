...
/**
 * The block_iomad_company_admin company created event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companycreated', 'block_iomad_company_admin');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->userid, 'iomad', 'company created ', '/blocks/ioamd_company_admin/editcompanies.php',
