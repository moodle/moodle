...
/**
 * The block_iomad_company_admin company license created event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_license_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companylicensecreated', 'block_iomad_company_admin');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created license id'" . s($this->other['licenseid']);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->userid, 'iomad', 'license created ', '/blocks/ioamd_company_admin/company_license_edit_form.php',
