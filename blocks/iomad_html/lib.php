 ...
 */
function block_iomad_html_pluginfile($course, $birecord_or_cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    global $DB, $CFG, $USER;
    ...
    if (!$file = $fs->get_file($context->id, 'block_iomad_html', 'content', 0, $filepath, $filename) or $file->is_directory()) {
        send_file_not_found();
    }
 ...
 * @return void
 */
function block_iomad_html_global_db_replace($search, $replace) {
    global $DB;
