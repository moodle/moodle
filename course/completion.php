...
require_once($CFG->dirroot.'/completion/completion_criteria_self.php');
require_once($CFG->dirroot.'/completion/completion_criteria_date.php');
require_once($CFG->dirroot.'/completion/completion_criteria_unenrol.php');
require_once($CFG->dirroot.'/completion/completion_criteria_activity.php');
require_once($CFG->dirroot.'/completion/completion_criteria_duration.php');
require_once($CFG->dirroot.'/completion/completion_criteria_grade.php');
require_once($CFG->dirroot.'/completion/completion_criteria_role.php');
require_once($CFG->dirroot.'/completion/completion_criteria_course.php');
