...
if(vert){slides=4.5;for(var i=0;i<brakepoints.length;i++){if(brakepoints[i]==768){brp={breakpoint:brakepoints[i],settings:'unslick'};resp.push(brp);}else{brp={breakpoint:brakepoints[i],settings:{slidesToShow:slides,slidesToScroll:1,rtl:false,focusOnSelect:true,focusOnChange:true}};resp.push(brp);}}}else{slides=4;for(var i=0;i<brakepoints.length;i++){brp={breakpoint:brakepoints[i],settings:{slidesToShow:slides-i-1,slidesToScroll:1,rtl:dir,}};resp.push(brp);}}
var slickConfig={dots:false,autoplay:false,arrows:true,vertical:vert,verticalSwiping:vert,rtl:dir,slidesToShow:slides,slidesToScroll:1,focusOnSelect:true,focusOnChange:true,responsive:resp,};elem.slick(slickConfig);}
