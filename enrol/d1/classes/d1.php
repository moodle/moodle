...
class lsud1 {
    ...
    /**
     * Updates the user record with the universal id.
     *
     * @param @object $user
     * @param @string $uid
     *
    ...
    */
    ...
    /**
     * Grabs students without universal ids in configured categories.
     *
    ...
    */
    ...
    /**
     * Grabs student universal id for an email.
     *
     * @param @string $token
     * @param @string $email
     *
