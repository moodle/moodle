...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.createScheduleModal=_exports.createReportModal=void 0,_modalform=(obj=_modalform)&&obj.__esModule?obj:{default:obj};const createModalForm=(triggerElement,modalTitle,formClass,formArgs)=>new _modalform.default({modalConfig:{title:modalTitle},formClass:formClass,args:formArgs,saveButtonText:(0,_str.get_string)("save","moodle"),returnFocus:triggerElement});_exports.createReportModal=function(triggerElement,modalTitle){return createModalForm(triggerElement,modalTitle,"core_reportbuilder\\form\\report",{id:arguments.length>2&&void 0!==arguments[2]?arguments[2]:0})};_exports.createScheduleModal=function(triggerElement,modalTitle,reportId){return createModalForm(triggerElement,modalTitle,"core_reportbuilder\\form\\schedule",{reportid:reportId,id:arguments.length>3&&void 0!==arguments[3]?arguments[3]:0})}}));
