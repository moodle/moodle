...
if ($courseid and $scales = grade_scale::fetch_all_local($courseid)) {
    ...
    $table->attributes['class'] = 'scaletable localscales generaltable table table-hover';
    $table->data  = $data;
}
...
if ($scales = grade_scale::fetch_all_global()) {
    ...
    $table->attributes['class'] = 'scaletable globalscales generaltable table table-hover';
