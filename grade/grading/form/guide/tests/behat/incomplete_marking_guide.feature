...
Feature: Verify incomplete marking guides
  ...
  Background:
    Given the following "users" exist:
      ...
      | teacher2 | Non-edit  | Teacher  | teacher2@example.com |
  ...
  @javascript
  Scenario Outline: Grading an assignment with an incomplete marking guide
    Given I am on the "Assignment 1" "assign activity" page logged in as "<teacher>"
    ...
    When I am on the "Assignment 1" "assign activity" page logged in as "teacher1"
    ...
    And I am on the "Assignment 1" "assign activity" page logged in as "<teacher>"
    And I go to "Student 1" "Assignment 1" activity advanced grading page
    And I should see "Grade out of 100"
    And I set the following fields to these values:
      | Grade out of 100  | 25                         |
