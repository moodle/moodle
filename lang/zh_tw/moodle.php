...
$string['alllogs'] = '所有紀錄';
$string['allow'] = '允&#65533; ';
$string['allowguests'] = '本課程允陬L帳號者進入';
$string['allownot'] = '不允&#65533; ';
$string['allparticipants'] = '所有參加者';
$string['alphanumerical'] = '只允鹵擗J英文字母或數字';
...
$string['continue'] = '下一頁';
$string['cookiesenabled'] = '瀏覽器必須啟動 Cookies 弁&#65533;';
...
$string['doyouagree'] = '你是否已經奮�以上說明條件並且同意所有內容?';
$string['edit'] = '編輯 $a';
...
$string['emailconfirmsent'] = '   <p>本系統已經送出電子郵件到 <b>$a</b>
   ...
   </p><p>請奮�你的私人郵件 按下確認連結後 便可登入本系統, 若是有問題請和系統管理者連絡.</p>';
$string['emaildisplay'] = '電子郵件訊息';
$string['emaildisplaycourse'] = '僅允釣銗L修課成員觀看我的電子郵件';
$string['emaildisplayno'] = '隱藏我的電子郵件,任何人都不能觀看';
$string['emaildisplayyes'] = '允釧狾酗H觀看我的電子郵件';
...
$string['error'] = '錯誤';
$string['errortoomanylogins'] = '抱歉, 已經超過允釭滬娃せ擗J次數. 請重新啟動瀏覽器 否則無效.';
...
$string['grade'] = '分數';
$string['grades'] = '分數';
$string['guestskey'] = '允釵魚珛{密碼者進入(不需註冊也可以)';
$string['guestsno'] = '只允陬虪U者進入';
$string['guestsnotallowed'] = '報歉, \'$a\' 不允野撐虪U者進入.';
$string['guestsyes'] = '本課程完全不設限(所有人均可進入)';
$string['guestuser'] = '旁聽帳號';
$string['guestuserinfo'] = '本使用者在某些課程僅有奮�權限 無法輸入資料.';
$string['help'] = '說明';
$string['helphtml'] = '如何編寫教學網頁';
$string['helppicture'] = '如何上載圖片';
$string['helpquestions'] = '如何洽當的問問題';
$string['helpreading'] = '請仔細奮&#65533;';
...
$string['htmleditordisabled'] = '你關閉使用線上編輯介面的弁&#65533; ';
$string['htmleditordisabledadmin'] = '系統管理者關閉了線上編輯介面的弁&#65533; ';
$string['htmleditordisabledbrowser'] = '線上編輯介面的弁鉞L效 因為你的瀏覽器不支援(請用IE5.5以上)';
...
$string['loginsteps'] = '你好! 若要使用本網站弁鄑A必須先在本網站註冊.
...
$string['loginstepsnone'] = '<p>嗨!</p><p>需要完成註冊手續才可能進入本課程.
</p>
...
$string['missingstudent'] = '至少須選擇某弁&#65533;';
$string['missingsummary'] = '缺少 綜合說明';
$string['missingteacher'] = '至少須選擇某弁&#65533;';
...
$string['someallowguest'] = '部分課程允野H 訪客 身分瀏覽';
