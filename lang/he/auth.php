...
$string['auth_dbextrafields'] = 'שדות אלו הינם אופציונלים. אתה יכול לבחור למלא מראש חלק משדות המשתמש של Moodle עם <b>שדות בסיס נתונים חיצוני</a> שתגדיר כאן. <P>אם תשאיר שדה זה ריק, אז יופעלו ברירות מחדל .<P>בכל מקרה, המשתמש יוכל לשנות את כל השדות הללו לאחר התחברות.';
...
$string['auth_ldapextrafields'] = 'שדות אלו הם אופציונליים. אתה יכול לבחור למלט מראש שדות משתמש שתפרט פה עם מידע מה<B>LDAP fields</B>. <P> אם תשאיר שדות אלו ריקים  אז דבר לא יעבור מ  LDAP וברירות מחדל של Moodle ישומשו במקום.<P>בכל מקרה, המשתמש יוכל לערוךאל כל השדות הללו לאחר התחברות.';
