...
$string['noteusercannotrolldatesoncontext'] = '<strong>Note:</strong> User lacks the required permissions to be able to roll dates when restoring this backup. This setting has been disabled for you.';
