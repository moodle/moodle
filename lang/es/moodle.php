...
$string['configcreatornewcourse'] = "Los creadores de cursos tienen derecho a modificar los cursos existentes y cambiar sus variables de configuración. Si se habilita esta función, los creadores de cursos TAMBIÉN podrán crear nuevos cursos.";
...
$string['creatinglogentries'] = "Crear entradas de registro";
...
$string['scalescustom'] = "Escalas personles";
...
$string['selectednowmove'] = "\$a archivos seleccionados. Ahora vaya al destino y presione 'Mover archivos aquí'";
...
$string['wordforteachereg'] = "por ejemplo: maestro, profesor, asesor, etc.";
