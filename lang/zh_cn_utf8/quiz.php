...
$string['alreadysubmitted'] = '似乎你已经提交过这个试答';
...
$string['categorynoedit'] = '你没有编辑类别“$a”的权限。';
...
$string['confirmclose'] = '你将要关闭这次试答。一旦你关闭试答，你将不能再修改你的答案。';
...
$string['countdownfinished'] = '测试就要结束了，你应该现在提交答案。';
$string['countdowntenminutes'] = '测试将于10分钟后结束';
$string['coursetestmanager'] = '课程测试管理者格式';
$string['createfirst'] = '你必须先建立一些填空题';
...
$string['deletequestionscheck'] = '你真的确定要删除下面的题目吗？
<div>$a</div>';
...
$string['duplicateresponse'] = '你提交过相同的答案，因此本次提交被忽略。';
...
$string['errorsdetected'] = '已检测到{$a}个错误';
...
$string['filloutoneanswer'] = '你至少必须填写一个答案。空白的答案将不被使用。';
$string['filloutthreequestions'] = '你必须至少填写三个题目。空白的题目将作废。';
$string['fillouttwochoices'] = '你至少必须填写两个选项。空白的选项将作废。';
$string['finishattempt'] = '提交所有答案并结束';
$string['fractionsaddwrong'] = '你选的得分总和不等于100%%<br />而是等于{$a}%%<br />你想回去改正这个问题吗？';
...
$string['penalty'] = '罚分';
$string['penaltyfactor'] = '罚分因子';
$string['penaltyscheme'] = '使用罚分';
$string['numerical'] = '数字题';
$string['pleaseclose'] = '你的请求已经被处理，现在可以关闭这个窗口了';
$string['penalty'] = '惩罚';
...
$string['readytosend'] = '你正在发送整份测验去评分。你确定要继续吗？';
...
$string['subneterror'] = '抱歉，本测验被锁定为只能从特定位置登录。现在，你的计算机不在允许范围内。';
$string['subnetnotice'] = '抱歉，本测验被锁定为只能从特定位置登录。现在，你的计算机不在允许的子网范围内。但作为教师，你可以浏览题目。';
$string['time'] = '时间';
...
$string['upgradesure'] = '<div style=\"color: red;\">测验模块将大幅改动测验表，但是升级功能还没有被充分测试。强烈建议你在此之前备份你的数据库中相应的表。</div>';
...
$string['wildcard'] = '通配符';
$string['withselected'] = '把选择的题目';
$string['withsummary'] = '纵览';
$string['wronggrade'] = '错误的成绩（行{$a}之后）:';
$string['wronguse'] = '你不能这样使用此页';
