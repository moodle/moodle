...
$string['addingquestions'] = 'この部分ではデータベース内の質問を管理します。質問は整理しやすいようにカテゴリ毎に保存されます。質問はコース内の全ての小テストに利用できます。「公開」を選んだ場合は他のコースでも利用できます。<br /><br />質問のカテゴリを選択又は作成した後に質問を作成・編集してください。このページの反対側にある小テストにどの質問でも追加することができます。';
...
$string['createmultiple'] = '複合質問を作成する';
...
$string['editingtruefalse'] = '○/×方式問題を編集する';
...
$string['functiontakesoneortwoargs'] = '関数 $a は1つ又は2つの引数を持つ必要があります。';
...
$string['publish'] = '公開';
$string['publishedit'] = 'このカテゴリへの質問の追加・編集を行うためにはコース公開に関する権限を有する必要があります。';
...
$string['requirepassword'] = '制限用パスワード';
$string['requirepasswordmessage'] = '小テストを行うためにパスワードを入力してください。';
$string['requiresubnet'] = '制限用ネットワークアドレス';
