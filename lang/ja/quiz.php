...
$string['editingtruefalse'] = "○/×式の質問を編集する";
$string['false'] = "×";
$string['feedback'] = "フィードバック";
$string['filloutoneanswer'] = "一つ以上の解答可能な質問を入力してください。文字の左側に空白は使用できません。";
$string['fillouttwochoices'] = "二つ以上の選択を入力してください。文字の左側に空白は使用できません。";
$string['fractionsaddwrong'] = "評価の合計が100%%に達していません。
<BR>現在合計 \$a%%　です。
<BR>質問を修正しますか?";
$string['fractionsnomax'] = "この質問に対する評価を与えるために、<BR>解答の一つは 100%% でなければなりません。 
<BR>質問を修正しますか?";
$string['gradeaverage'] = "平均点";
$string['gradehighest'] = "最高点";
...
$string['multichoice'] = "複数選択";
$string['noanswers'] = "回答が選択されていません!";
