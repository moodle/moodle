...
$string['resourcetypedirectory'] = 'ディレクトリを表示';
$string['resourcetypefile'] = 'ファイル又はウェブにリンク';
$string['resourcetypehtml'] = '新しいウェブページを作成';
$string['resourcetypelabel'] = 'ラベルを挿入';
$string['resourcetypetext'] = '新しいテキストページを作成';
