...
$string['categoryadded'] = "Le programme « \$a » a été ajouté";
$string['categorydeleted'] = "Le programme « \$a » a été supprimé";
$string['categoryduplicate'] = "Le programme \$a existe déjà!";
...
$string['configsessiontimeout'] = "Lorsqu'un utilisateur n'est plus actif, il sera automatiquement déconnecté après ce délai : ";
...
$string['emaildisplayno'] = "Cacher mon adresse de couenregistréerriel à tous";
$string['emaildisplayyes'] = "Autoriser tout le monde à voir mon adresse courriel";
...
$string['updatethis'] = "Mise à jour en date du \$a";
$string['updatethiscourse'] = "Mettre à jour ce cours";
$string['updatinga'] = "Mettre à jour un \$a";
$string['updatingain'] = "Mettre à jour un \$a->what dans \$a->in";
$string['upload'] = "Téléverser";
$string['uploadafile'] = "Téléverser un fichier";
