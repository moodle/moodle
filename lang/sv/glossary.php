...
$string['explainalphabet'] = 'Välj den sida Du vill söka efter';
...
$string['explainimport'] = 'Du måste ange vilken fil som ska importeras och villkoren för processen.<br />Skicka in Din förfrågan och titta på resultaten igen.';
$string['explainspecial'] = '<b>Special</b> kommer att visa alla begrepp som inte börjar med en bokstav';
