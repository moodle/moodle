...
$string['dbname'] = 'Den specifika databas som ska användas';
$string['dbpass'] = 'Lösenord för att få tillgång till servern';
...
$string['remoteuserfield'] = 'Det fält i fjärrdatabasen där vi förväntar oss att hitta användarens ID.';
