...
$string['analysistitle'] = 'Tabelle der analysierten Werte';
...
$string['facilitytitle'] = '%% korrekte<br>Möglichkeiten';
...
$string['reportanalysis'] = 'Auswertungsbericht';
$string['responsestitle'] = 'Antworttexte';
$string['rfractiontitle'] = 'Teil-<br>Guthaben';
