...
$string['addinganew'] = "Füge ein ";
$string['addinganewto'] = "Füge ein  zu ";
...
$string['categoryadded'] = "Die Kategorie '' wurde angelegt";
$string['categorydeleted'] = "Die Kategorie '' wurde gelöscht";
...
$string['databasechecking'] = "Moodle Datenbank von Version  auf  aktualisieren...";
...
$string['deletecheck'] = " löschen?";
$string['deletecheckfull'] = "Sind Sie sich wirklich sicher,  löschen?";
...
$string['deletedactivity'] = " gelöscht";
$string['deletedcourse'] = " wurde erfolgreich gelöscht";
$string['deletednot'] = "Kann  nicht löschen!";
$string['deletingcourse'] = "Lösche ";
...
$string['emailconfirmsent'] = "   <P>Eine Email sollte an Ihre Adresse <B></B>
...
$string['enrolmentkeyfrom'] = "Für diesen Kurs benötigen Sie einen 'Zugangs-Schlüssel' - ein einmaliges Passwort,<br>das Sie von  bekommen haben sollten<BR>
...
(Hier ist ein Hinweis - Er strtet mit ''";
...
$string['guestsnotallowed'] = "'' erlaubt Gästen keinen Zugang";
...
$string['location'] = "Ort";
$string['loggedinas'] = "Sie sind angemeldet als  ";
...
$string['makeeditable'] = "Sofern Sie '' durch den Internet-Server bearbeitbar machen (beispielsweise Apache) können Sie diese Datei direkt auf dieser Seite bearbeiten";
$string['managedatabase'] = "Datenbank verwalten";
$string['markthistopic'] = "Dieses Thema als das gegenwärtige Thema kennzeichnen";
$string['maximumchars'] = "Höchstens  Buchstaben";
...
$string['modulesuccess'] = " Tabellen wurden korrkt angelegt";
...
$string['newpasswordtext'] = "Hallo ,

Ihr Zugangskennwort auf '' wurde zurückgesetzt und Ihnen ist ein neues temporäres Kennwort zugewiesen worden.
...
$string['notenrolled'] = " nimmt nicht an diesem Kurs teil.";
...
$string['numdays'] = " Tage";
$string['numminutes'] = " Minuten";
$string['numviews'] = " Einsichten";
$string['numweeks'] = " Wochen";
$string['numwords'] = " Wörter";
$string['numyears'] = " Jahre";
$string['ok'] = "OK";
...
$string['passwordsenttext'] = "   <P>Eine Email wurde an Ihre Adresse  gesendet.

   <P><B>Schauen Sie bitte in Ihre Email nach Ihrem neuen Kennwort

   <P>Das Kennwort wurde automatisch erzeugt.
Sicherlich möchten Sie es <A HREF=>ändern</a>, um es sich leichter zu merken.";
$string['people'] = "Leute";
...
$string['showonlytopic'] = "Nur Thema  anzeigen";
$string['showonlyweek'] = "Nur Woche  anzeigen";
...
$string['unenrolme'] = "Abmelden von ";
$string['unenrolsure'] = "Sind Sie siche, dass Sie  von diesem Kurs abmelden möchten?";
...
$string['updatesevery'] = "Aktualisiere alle  Sekunden ";
$string['updatethis'] = "Aktualisiere deisen ";
$string['updatethiscourse'] = "Diesen Kurs aktualisieren";
$string['updatinga'] = "Aktualisiere ";
$string['updatingain'] = "Aktualisiere  in ";
...
$string['userprofilefor'] = "Benutzer-Profil für ";
$string['users'] = "Benutzer";
$string['webpage'] = "Internet-Seite";
$string['week'] = "Woche";
$string['weeklyoutline'] = "Wöchentlich ausstehend";
$string['welcometocourse'] = "Willkommen zu ";
$string['welcometocoursetext'] = "Willkommen zu !
