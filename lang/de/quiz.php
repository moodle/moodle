...
$string['adaptive'] = 'Angepasster Modus';
...
$string['confirmserverdelete'] = 'SindSie sicher, dass Sie den Server <b>$a</b> von der Liste löschen wollen?';
...
$string['duplicateresponse'] = 'Ihre Lösung wurde ignoriert, weil Sie früher bereits eine identische/ähnliche Antwort gegeben haben.';
...
$string['editcatquestions'] = 'Fragekategorien bearbeiten';
...
$string['errornotnumbers'] = 'Fehler - die Antwort muß eine Zahl sein.';
$string['errorsdetected'] = '$a Fehler entdeckt';
$string['event1'] = 'Automatische Sicherung';
$string['event2'] = 'Sichern';
$string['event3'] = 'Note';
$string['event5'] = 'Überprüfen';
$string['event6'] = 'Schließen';
...
$string['finishattempt'] = 'Alle bestätigen und beenden';
...
$string['mark'] = 'Einreichungen';
$string['markall'] = 'Einreichungsseite';
$string['marks'] = 'Punkte';
...
$string['noconnection'] = 'Es gibt derzeit keien Verbindung zu einem Webservice, der diese Anfrage beantworten kann. Nehmen Sie Kontakt mit der Administration auf.';
...
$string['notavailabletostudents'] = 'Anmerkung: Der Test kann von den Teilnehmer/innen zur Zeit nicht durchgeführt werden. ';
...
$string['notimedependentitems'] = 'Zeitabhängige Einzelwerte können zur Zeit vom Test nicht eingerichtet werden. Stellen Sie ein Zeitlimit für den gesamten Test fest. Wollen Sie einen anderen Wert auswählen (oder den derzeitigen Wert unverändert nutzen)?';
$string['numberabbr'] = '#';
...
$string['previous'] = 'Vorherige Einstellung';
...
$string['reportanalysis'] = 'Wertanalyse';
...
$string['serveridentifier'] = 'Inditifikation';
$string['serverinfo'] = 'Server Information';
$string['serverinuse'] = 'Der Server $a, den Sie löschen wollen, ist der letzte verbleibende Server. Darauf sind Fragen gespeichert, die verloen gehen, wenn Sie die Verbindung löschen.';
...
$string['subnetnotice'] = 'Der Zugang zum Test ist nur von einer Reihe festgelegter Rechner möglich. Ihr Rechner hat dieses Recht nicht. Trainer/innen könenn von jedem Rechner aus zugreifen.';
