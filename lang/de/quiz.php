...
$string['pagesize'] = 'Versuche, die pro Seite angezeigt werden:';
...
$string['response'] = 'Eingaben TN';
$string['responses'] = 'Eingaben  |<br />der TN';
