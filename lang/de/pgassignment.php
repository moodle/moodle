...
$string['acceptassessment'] = "Sind Sie glücklich, diese Bewertung anzunehmen?";
...
$string['assignmentawaitinggrading'] = "Aufgabe awaiting grading (Frist endet \$a)";
$string['assignmenthasbeengraded'] = "Aufgabe wurde benotet";
$string['assignmentsgivento'] = "Aufgabe(n) given to \$a for grading";
...
$string['deadlineforsubmissionis'] = "Frist für die Einreichung ist \$a";
...
$string['graded'] = "Bewertung und Feedback von anderen Kursteilnehmern";
$string['gradedawaitingacceptance'] = "Graded, awaiting acceptance (on iteration \$a)";
$string['gradedawaitingreply'] = "Benotet, wartet auf Antwort (\$a)";
$string['gradedawaitingreplydeadline'] = "Benotet, wartet auf Antwort (Frist endet \$a)";
