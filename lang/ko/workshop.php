...
$string['alreadyinphase'] = '이미 $a 는 실시 중입니다. ';
$string['amendassessmentelements'] = '평가요소수정';
$string['amendtitle'] = '표제수정하기';
$string['analysis'] = '분석';
$string['analysisofassessments'] = '평가분석';
$string['assess'] = '평가';
$string['assessedon'] = '$a 는 평가중';
$string['assessment'] = '성적평가';
$string['assessmentby'] = '$a 로부터평가';
$string['assessmentdropped'] = '시험에 낙제';
$string['assessmentend'] = '마지막 학업평가';
$string['assessmentendevent'] = '$a 를 위한 마지막 학업평가';
...
$string['assessmentstartevent'] = '$a 를 위한 평가의 시작';
$string['assessmentwasagreedon'] = '평가가 $a 에 동의 되었습니다.';
$string['assessor'] = '평가인';
$string['assessthisassessment'] = '성과에 대해 성적매기다';
...
$string['clearlateflag'] = '늦음 표식을 지우시오';
$string['closeassignment'] = '숙제 마감';
$string['comment'] = '논평';
$string['commentbank'] = '논평은행';
$string['commentby'] = '논평자';
$string['comparisonofassessments'] = '비교평가';
$string['confirmdeletionofthisitem'] = '$a 의 삭제획인';
$string['correct'] = '교정하다';
$string['count'] = '계산하다';
$string['criterion'] = '기준';
$string['currentphase'] = '현황';
$string['date'] = '날짜';
...
$string['edit'] = '수정';
$string['editacomment'] = '의견 수정';
$string['editingassessmentelements'] = '평가요소 수정';
$string['editsubmission'] = '제안 수정';
$string['element'] = '요소';
$string['elementweight'] = '가중치 요소';
...
$string['gradeforstudentsassessment'] = '학생성적평가';
...
$string['includeteachersgrade'] = '선생의 성적을 포함';
$string['incorrect'] = '틀린';
$string['info'] = '정보';
...
$string['namesnotshowntostudents'] = '$a에게 이름을 감춥니다';
...
$string['optionforpeergrade'] = '동료 평가에 관한 사항';
$string['optionsusedinanalysis'] = '분석에 사용된 사항';
$string['overallgrade'] = '총점';
$string['overallocation'] = '배분초과';
$string['overallpeergrade'] = '전체 동료평가점수: $a';
$string['overallteachergrade'] = '전체 교사평가점수: $a';
...
$string['returntosubmissionpage'] = '제출페이지로 돌려보내다';
$string['rubric'] = '주의사항';
$string['savedok'] = '저장완료';
$string['saveleaguetableoptions'] = '리그표옵션저장';
...
$string['showsubmission'] = '제출보여주기:$a';
...
$string['teachersubmissionsforassessment'] = '평가에 대한 $a 교사의 의견 ';
...
$string['unassessed'] = '$a 자기힘으로 스스로 하는';
$string['ungradedassessments'] = '성적계산이 되지않은 평가 $a';
$string['ungradedassessmentsofstudentsubmissions'] = '성적계산이 되지 않은 학생평가 제안 $a';
$string['ungradedassessmentsofteachersubmissions'] = '성적계산이 되지 않은 교사 평가 제안 $a';
...
$string['viewassessmentofteacher'] = '$a의 평가관점';
$string['viewotherassessments'] = '다른평가관점';
$string['warningonamendingelements'] = '경고 : 이곳의 평가제안이 있으니 숫자나 스케일, 중요요소를 바꾸지 마시오';
$string['weight'] = '가중치';
$string['weightederrorcount'] = '가중된 오류수: $a';
$string['weightforbias'] = '경향의비중';
$string['weightforgradingofassessments'] = '시험성적계산의 가중치';
$string['weightforpeerassessments'] = '응시시험의 가중치';
$string['weightforreliability'] = '신뢰의 가중치';
$string['weightforteacherassessments'] = '교사평가의 가중치';
$string['weights'] = '가중치';
$string['weightsusedforfinalgrade'] = '기말성적의 가중치';
$string['weightsusedforsubmissions'] = '제안들의 가중치';
...
$string['yourassessments'] = '당신의성과에 대한 동료 평가';
