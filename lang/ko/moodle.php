...
$string['activitysince'] = '$a 이후 활동 이력 ';
...
$string['adminhelpconfiguration'] = '사이트의 외양과 작동 기능 설정하기';
$string['adminhelpconfigvariables'] = '사이트의 일반적 작동에 영향을 미치는 변수 설정하기';
$string['adminhelpcourses'] = '배움터와 범주를 설정하고 사람들을 참여시기기';
...
$string['allowinternal'] = '내부적 방법 역시 허용';
...
$string['assignstudentsnote'] = '노트: 이 페이지가 사용되지 않을 수도 있습니다. 왜냐하면 학생들 스스로 이 배움터에 참여하는 것이 가능하기 때문입니다.';
$string['assignstudentspass'] = '이 배움터에 참여하려는 학생들에게 참여키를 알려줘야 할 것입니다. 현재의 참여키는 \'$a\' 입니다.';
...
$string['backupkeephelp'] = '배움터를 백업할 때 백업파일을 몇 개까지 서버에 보관할까요? (오래된 것은 자동으로 삭제됩니다.)';
$string['backuplogdetailed'] = '자세한 실행기록';
$string['backuploglaststatus'] = '지난 실행기록';
$string['backuplogshelp'] = '배움터 로그파일을 포함하여 백업하려면 선택하세요.';
$string['backupmetacoursehelp'] = '이를 활성화 시키면, 메타코스의 정보를 포함하여 백업됩니다.';
$string['backupnameformat'] = '%%Y%%m%%d-%%H%%M';
$string['backupnoneusersinfo'] = '주의: \"무 사용자\"를 백업 하도록 선택하셨습니다. 따라서 모든 모듈 백업들이 \"사용자 없음\" 상태로 전환 되었습니다. \"연습\"과 \"워크숍\" 모듈을 바르게 사용하기 위해서는  이러한 형태의 백업은 바람직하지 않음을 염두에 두기 바랍니다.';
...
$string['blockconfigbad'] = '정보가 정확하지 않아 설정할 수 있는 창을 열 수 없습니다.';
$string['blockdeleteconfirm'] = '\'$a\'블럭을 완전히 지우시겠습니까. 이 블럭과 관계된 모든 것이 데이터베이스에서 삭제됩니다. 정말 지우시겠습니까?';
$string['blockdeletefiles'] = '\'$a->block\' 블럭과 관계된 모든 정보가 삭제되었습니다. 삭제를 완료하기 위해(그리고 스스로 다시 설치되는것을 막기위해)당신의 서버에서 $a->directory 를 삭제하셔야 합니다';
$string['blocks'] = '블럭';
$string['blocksaddedit'] = '블록 첨가/편집';
...
$string['choosereportfilter'] = '보고서에 관계된 필터를 선택하시오';
$string['choosetheme'] = '테마 선택';
$string['chooseuser'] = '사용자 선택';
$string['city'] = '도시';
$string['clambroken'] = '관리자가 업로드파일에 대해 바이러스 체크를 활성화시킨 상태입니다만 설정제어에 문제가 있습니다.<br />당신의 파일 업로드는 실패했습니다. 관리자가 그것을 알리고 고치기 위한 메일을 보낸상태입니다.<br />다음에 업로드해 보십시오.';
$string['clamdeletedfile'] = '파일이 삭제 되었습니다';
$string['clamdeletedfilefailed'] = '파일을 삭제할 수 없습니다';
$string['clamemailsubject'] = '$a :: Clam 오디오 비주얼 공지';
$string['clamfailed'] = 'Clam AV의 실행이 되지 않았습니다. 오류 메세지는 $a 였습니다. 여기에 Clam의 결과가 있습니다 :';
$string['clamlost'] = 'Moodle은 calm이 파일을 업로드할 수 있도록 설정되었습니다만, Clam AV, $a 에게 배정된 경로가 부정확합니다.';
$string['clamlostandactinglikevirus'] = '추가로, moodle은 clam 실행이 실패할 경우, 파일이 바이러스로 취급되도록 설정되었습니다. 이는 당신이 이것을 교정하기 전까지는 어떠한 학생도 파일을 성공적으로 올릴 수 없다는 것을 뜻 합니다.';
$string['clammovedfile'] = '이 파일은 지정된 격리디렉토리로 옮겨졌습니다. 새로운 장소는 $a입니다.';
...
$string['continue'] = '계속';
$string['continuetocourse'] = '배움터에 들어가려면 이곳을 누르세요';
...
$string['coursecategories'] = '배움터 범주';
...
$string['coursehidden'] = '이 배움터는 현재 학생들이 사용할 수 없습니다. ';
...
$a';
$string['courserejectreason'] = '이 교육과정 수강이 거절된 이유의 개요입니다.<br />(이 것은 신청자에게 이메일로 통보될 것입니다)';
$string['courserejectsubject'] = '당신의 교육과정 신청이 거부되었습니다.';
$string['courserequest'] = '배움터 신청';
...
$string['courserequestintro'] = '이 양식을 사용해 당신이 원하는 교육과정 개설을 요청하십시오.<br /> 운영자가 왜 당신이 이 교육과정을 등록하려고 하는지 충분히 이해할수 있도록 많은 정보를 써주세요.';
$string['courserequestreason'] = '교육과정 개설을 원하는 이유';
$string['courserequestsuccess'] = '당신의 교육과정 신청은 성공적으로 저장되었습니다. 그 결과가 며칠안에 이메일로 보내질 것입니다.';
$string['courserestore'] = '배움터 복원';
$string['courses'] = '배움터 마당';
$string['coursescategory'] = '동일 범주의 배움터';
$string['coursespending'] = '유보되었던 교육과정 승인';
$string['coursestaught'] = '내가 가르치는 배움터';
...
$string['enrolenddate'] = '끝나는날';
$string['enrolenddaterror'] = '등록기간 마감날짜는 등록기간 시작날짜보다 먼저일 수 없습니다. ';
$string['enrollable'] = '강좌 등록';
$string['enrolledincourse'] = '배움터 \"$a\" 에  참여함';
$string['enrolledincoursenot'] = '배움터 \"$a\" 에  참여하지 않음';
$string['enrollfirst'] = '당신은 사이트에서 활동을 시작하기 전에 미리 배움터에 등록해야함';
$string['enrolme'] = '이 배움터에  등록시켜 주세요';
$string['enrolmentconfirmation'] = '당신은 이 배움터의 구성원으로 등록하려고 합니다.<br />확실합니까?';
$string['enrolmentend'] = '등록기간 마감';
$string['enrolmentkey'] = '참여 키';
$string['enrolmentkeyfrom'] = '이 배움터는 \'참여키\'가 필요합니다.<br /> 참여키는 $a 에게서 받을 수 있습니다.';
...
$string['expirynotifyemail'] = '교육과정에 소속된 아래의 학생들은 정확히 $a->threshold 일 이후에 이용권한이 없어집니다:
$a->current

교육과정에 소속된 다음 학생들은 $a->threshold 일 이전에 이용권한이 없어집니다.

$a->past

당신은 다음의 페이지로 가서 등록기간을 연장할 수 있습니다 : $a->extendurl';
$string['expirynotifystudents'] = '학생에게 알리기';
$string['expirynotifystudentsemail'] = '학생들에게:

당신이 등록한 교육과정 $a->course 이 $a->threshold 이내에 종료될 것임을 공지합니다. 의문이 있으면 담당자에게 연락하시기 바랍니다.';
$string['expirythreshold'] = '종료기한';
...
$string['frontpagetopiconly'] = '임의의 HTML 이나 활동(토픽) 보기';
...
$string['groupmodeforce'] = '무조건 모둠 모드로 ';
$string['groupmy'] = '나의 모둠';
$string['groupnonmembers'] = '모둠에 속하지 않은 사람';
$string['groupnotamember'] = '죄송합니다, 당신은 모둠의 구성원이 아닙니다.';
$string['grouprandomassign'] = '모든 사람을 임의로 모둠에 배정하기';
...
$string['import'] = '가져옴';
$string['importactivities'] = '다른 배움터에서 활동을 불러옴';
$string['importdata'] = '불러올 배움터 정보 입력';
$string['importdataexported'] = '배움터로부터 내보낸 정보를 성공적으로 불러들였습니다.<br />불러오기를 계속합니다. ';
$string['importdatafinished'] = '불러오기 완료!  계속 진행하세요.';
$string['importdatafrom'] = '데이터를 가져올 배움터 찾기';
...
$string['loginalready'] = '당신은 이미 로그인 되있습니다';
...
<br /> 배움터를 제대로 이용하기 위해서는 계정을 생성하여야 합니다.
<br /> 사용자 아이디와 비밀번호를 입력해야 합니다.
<br /> 만약 누군가 입력한 아이디를 사용하고 있다면 다른 아이디를 사용해야 합니다.';
...
$string['newpasswordfromlost'] = '당신의 현재 비밀번호가 당신의 이메일로 전송될것이고 그 다음에 잊어버린 비밀번호 복구 프로세스 부분이 두통의 이메일로 보내질 것입니다. 화면을 진행시키기 전에 당신이 받은 비밀번호로 대체하시기 바랍니다.';
...
$string['noticenewerbackup'] = '이 백업파일은 무들 $a->backuprelease ($a->backupversion) 판에 의해 만들어진 것이고 현재 구동되고 있는 무들 $a->serverrelease ($a->serverversion)보다 새 것입니다. 이경우 약간의 불일치를 촉발 할 수 있으며, 구판으로의 되돌릴 때 작동을 확신할 수 없습니다.';
...
$string['passwordforgotteninstructions'] = '당신의 상세정보는 반드시 사용자 데이터 베이스에서 발견 되어야 합니다. 당신의 무들 사용자 이름이나 등록된 이메일 주소를 기입란에 입력해주시기 바랍니다. 두개 다 입력하실 필요는 없습니다.';
...
$string['paymentsorry'] = '당신의 지불에 감사드립니다! 불행하게도 당신의 지불은 아직 완료되지 않았으며 배움터에 \"$a->fullname\" 로 완전히 등록되지 않았습니다. 몇 초 후에 계속 배움터 진입을 시도해 보시길 바랍니다. 만일 지속적으로 문제가 있다면 사이트 관리자나 $a->teacher 에게 연락하시기 바랍니다.';
...
$string['previeworchoose'] = '테마 선택하여 미리보기';
...
$string['recreatedcategory'] = '범주 $a 재설정';
...
$string['savepreferences'] = '택한 내용 저장';
$string['saveto'] = '저장하기';
$string['scale'] = '척도';
$string['scales'] = '척도';
$string['scalescustom'] = '일반적 척도';
$string['scalescustomcreate'] = '새로운 척도 추가';
$string['scalescustomno'] = '일반적 척도가 생성되지 않았습니다.';
$string['scalesstandard'] = '표준 척도';
$string['scalestip'] = '일반적 척도를 생성하기 위해서는 배움터 관리자 메뉴의 \'척도\'링크를 사용하세요.';
$string['schedule'] = '일정';
...
$string['separateandconnected'] = '학습자의 고립과 연대 유형';
...
$string['shortnametaken'] = '짧은 이름이 다른 곳( $a )에서 사용되었습니다. ';
...
$string['sitepartlist0'] = '참여자 목록은 사이트선생님만 볼 수 있습니다';
$string['sitepartlist1'] = '참여자 목록은 선생님만 볼 수 있습니다';
$string['sites'] = '사이트';
...
$string['statsreport11'] = '가장 활동적인 교육과정';
$string['statsreport12'] = '가장 활동적인 교육과정 (평균)';
$string['statsreport13'] = '가장  많이 등록된 교육과정 (등록)';
$string['statsreport14'] = '가장  많이 등록된 교육과정 (보기와 글쓰기)';
...
$string['unenrol'] = '탈퇴하다';
$string['unenrolallstudents'] = '모든 학생을 탈퇴시킨다';
...
$string['unusedaccounts'] = '$a 일이상 사용하지 않으면 자동적으로 탈퇴 처리됩니다.';
$string['unzip'] = '압축풀기';
...
$string['updatethiscourse'] = '배움터 업데이트';
...
$string['usernameemailmatch'] = '사용자 이름과 이메일 주소는 다른 사용자와 연관될수 없습니다.';
$string['usernameexists'] = '이 아이디는 이미 사용중입니다. 다른 아이디를 사용하세요.';
$string['usernamenotfound'] = '사용자 이름이 데이터 베이스에 없습니다.';
...
여기 이 파일에 무슨 일이 일어났는지에 대한 요약이 있음:
$a->action';
