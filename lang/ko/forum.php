...
$string['configlongpost'] = '이 길이를 초과한 게시물(HTML코드 제외)은 긴 것으로 여겨집니다. 초기화면, 일반적 과정 화면 또는 사용자 정보화면은 이미 지정된 길이로 조절됩니다.';
...
$string['unsubscribed'] = '구독하지 않음';
$string['unsubscribeshort'] = '구독하지 않음';
