...
$string['auth_dbextrafields'] = 'Эти поля дополнительные. Вы можете выбрать предварительное заполнение некоторых полей пользовательских данных из полей внешней базы данных, указанной здесь. <p>Не заполняйте поле, для использования настроек по умолчанию.</p>
