...
$string['adminprimarynoedit'] = 'Primární správce nemù¾e být ostatními upravován';
...
$string['errorcleaningdirectory'] = 'Chyba pøi èi¹tìní adresáøe \"$a\"';
$string['errorcopyingfiles'] = 'Chyba pøi kopírování souborù';
$string['errorcreatingdirectory'] = 'Chyba pøi vytváøení adresáøe \"$a\"';
$string['errorcreatingfile'] = 'Chyba pøi vytváøení souboru \"$a\"';
$string['erroronline'] = 'Chyba na øádku $a';
$string['errorreadingfile'] = 'Chyba pøi ètení souboru \"$a\"';
$string['errorunzippingfiles'] = 'Chyba pøi rozbalování ZIP souborù';
...
$string['onlyeditingteachers'] = 'Toto mohou dìlat pouze uèitelé s právem editace.';
$string['onlyeditown'] = 'Mù¾ete upravovat pouze své vlastní informace';
...
$string['sessionerroruser'] = 'Va¹e pøihlá¹ení vypr¹elo. Prosím, pøihla¹te se znovu.';
$string['sessionerroruser2'] = 'Objevila se chyba na serveru, která ovlivòuje va¹e pøihlá¹ení. Prosím, pøihla¹te se znovu nebo restartujte vá¹ prohlí¾eè.';
