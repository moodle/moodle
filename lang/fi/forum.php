...
$string['deletedposts'] = 'Viestit on poistettu';
...
$string['edit'] = 'Muokkaa';
$string['editedby'] = 'Muokattu $a->name:n toimesta $->date';
...
$string['markalldread'] = 'Merkite kaikki keskustelun viestit luetuiksi';
$string['markallread'] = 'Merkite kaikki alueen viestit luetuiksi';
...
$string['search'] = 'Etsi';
$string['searchdatefrom'] = 'Viestin tulee olla uudempi kuin';
$string['searchdateto'] = 'Viestin tulee olla vanhempi kuin';
$string['searchforumintro'] = 'Täytä hakuehto yhteen tai tai usempaan kenttään:';
$string['searchforums'] = 'Etsi viesteistä';
$string['searchfullwords'] = 'Nämä sanat tulee olla kokonaisina';
$string['searchnotwords'] = 'Älä huomioi näitä sanoja';
$string['searcholderposts'] = 'Selaa vanhoja viestejä';
$string['searchphrase'] = 'Tämä fraasi tulee olla viestissä';
$string['searchresults'] = 'Haun tulokset';
$string['searchsubject'] = 'Näitä sanoja viestin aiheessa';
$string['searchuser'] = 'Viestin kirjoittajan nimi  tulisi olla';
$string['searchuserid'] = 'Viestin kirjoittajan tunnus tulisi olla';
$string['searchwhichforums'] = 'Valitse haettavat alueet';
$string['searchwords'] = 'Näitä sanoja viestin sisällöstä';
$string['seeallposts'] = 'Kaikki tämän käyttäjän viestit';
...
$string['trackforum'] = 'Seuraa lukamatta olevia viestejä';
$string['tracking'] = 'Seuraa';
$string['trackingoff'] = 'Pois';
$string['trackingon'] = 'Päällä';
$string['trackingoptional'] = 'Valinnainen';
$string['trackingtype'] = 'Seuraa tämän alueen lukemista';
$string['unread'] = 'Lukematta';
$string['unreadposts'] = 'Lukemattomat viestit';
$string['unreadpostsnumber'] = '$a lukematonta viestiä';
$string['unreadpostsone'] = '$a lukematon viesti';
