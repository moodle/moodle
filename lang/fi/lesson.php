...
$string['answersfornumerical'] = 'Numeeristen kysymysten vastauksia pitäisi verrata minimi- ja maksimiarvoihin.';
$string['attempt'] = 'Yritys: $a';
$string['attempts'] = 'Yritykset';
$string['available'] = 'Tehtävissä';
$string['canretake'] = '$a voi aloittaa uudelleen';
$string['casesensitive'] = 'Kirjainten koko merkityksellinen (case sensitive)';
