...
$string['cronwarning'] = '<a href=\"cron.php\">cron.php скрыпт падтрымкі</a> не выкарыстоўваўся сама меней 24 гадзіны. <br /> <a href=\"../doc/?frame=install.html&amp;sub=cron\">дакументацыя па ладаванні</a> тлумачыць як гэта можна аўтаматызаваць.';
