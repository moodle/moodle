...
$string['auth_dbextrafields'] = '<p>Гэтыя палі дадатковыя. Вы можаце выбраць папярэдняе запаўненне некаторых палёў карыстальніцкіх дадзеных ад палёў знешняй базы дадзеных, паказанай тут. </p><p>Не запаўняйце поле, для выкарыстання настроек па-змаўчанні.</p>
...
$string['auth_ldapextrafields'] = '<p>Гэтыя палі дадатковыя. Вы можаце выбіраць папярэдняе запаўненне некаторых палёў карыстальніцкіх дадзеных ад палёў LDAP, паказанага тут. </p><p>Не запаўняйце гэтае поле, для таго, каб не пераносіць дадзеныя з LDAP.</p><p>У любым выпадку, карыстальнік зможа рэдагаваць усе палі пасля таго, як ён зойдзе ў сістэму.</p>';
