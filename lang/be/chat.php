...
$string['beep'] = 'Сігнал';
$string['chatintro'] = 'Уступны тэкст';
$string['chatname'] = 'Назва пакою чата';
$string['chatreport'] = 'Чат-сесія';
$string['chattime'] = 'Наступны час чату';
$string['configmethod'] = 'Звычайны метад для правядзення чату дазваляе кліентам далучацца рэгулярна да сервера для аднаўленняў. Ён не патрабуе настройкі і працуе ўсюды, але ён можа прывесці да вялікай загрузкі сервера пры вялікай колькасці размаўляючых у чаце. Выкарыстанне сервера чату ў якасці дэмана патрабуе доступу да каманднага працэссара Unix (shell), але ён дазволіць зрабіць працу абалонкі чата лепш маштабіруемым.';
$string['configoldping'] = 'Які максімальны час павінен прайсці, каб можна было вызначыць, што карыстальнік адлучыўся (у сякундах)? Гэта толькі ліміт. Адлучэнні вызначаюцца вельмі хутка. Нізкая велічыня можа прывесці да парушэння працы вашага сервера. Калі Вы выкарыстоўваеце звычайны метад, <strong>ніколі</strong> не пазначайце яе ніжэй чым 2 * chat_refresh_room.';
...
$string['explaingeneralconfig'] = 'Гэтыя настройкі <strong>заўсёды</strong> ўступаюць у сілу';
$string['explainmethoddaemon'] = 'Гэтыя настройкі маюць значэнне <strong>толькі</strong>, калі Вы ў якасці метада чата выбралі дэман чат-сэрвера';
$string['explainmethodnormal'] = 'Гэтыя настройкі маюць значэнне <strong>толькі</strong>, калі Вы ў якасці метада чата выбралі звычайны метад';
