...
<p>Predpokladá sa, ¾e kurzy sú definované ako skupiny v LDAP a ka¾dá skupina má viacero u¾ívateµských polí (<em>èlen</em> alebo <em>Uidèlena</em>), ktoré zabezpeèujú jednoznaènú identifikáciu u¾ívateµa.</p>
<p>Aby ste mohli pou¾i» LDAP zapisovanie, Va¹i u¾ívatelia  <strong>musia</strong> ma» platné pole idnumber. LDAP skupiny musia ma» idnumber v poliach pre u¾ívateµa, aby sa mohli zapisova» do kurzov. Toto bude pravdepodobne fungova» bez problémov, ak u¾ pou¾ívate LDAP Autentifikáciu.</p>
<p>Zápisy sa budú aktualizova», keï sa u¾ívateµ prihlási. Na synchronizáciu uchovávania zápisov, mô¾ete pou¾i» aj skript. Pozrite sa do  <em>enrol/ldap/enrol_ldap_sync.php</em>.</p>
...
$string['enrol_ldap_bind_dn'] = 'Ak chcete pou¾i» spoluu¾ívateµa na vyhµadávanie u¾ívateµov, definujte to tu. Nieèo ako: \'cn=ldapuser,ou=public,o=org\'';
$string['enrol_ldap_bind_pw'] = 'Heslo pre spoluu¾ívateµa.';
$string['enrol_ldap_category'] = 'Kategória pre automaticky vytvorené kurzy.';
$string['enrol_ldap_course_fullname'] = 'Nepovinné: LDAP pole, z ktorého sa má vybra» celé meno u¾ívateµa.';
...
$string['enrol_ldap_course_shortname'] = 'Nepovinné: LDAP pole, z ktorého sa má vybra» skrátené menou u¾ívateµa.';
