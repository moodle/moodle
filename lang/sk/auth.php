...
$string['auth_cas_create_user'] = 'Pokiaµ chcete vlo¾i» do Moodle databázy u¾ívateµov overených pomocou CAS, musíte zapnú» túto voµbu. Pokiaµ ju nezapnete, budú sa môc» prihlási» len tí u¾ívatelia, ktorí u¾ existujú v databáze Moodle.';
...
$string['auth_casdescription'] = 'Táto metóda pou¾íva CAS server (Central Authentication Service) pre overovanie u¾ívateµov v prostredí jednotného systému prihlasovania (Single Sign On - SSO). Tie¾ mô¾ete pou¾i» jednoduché LDAP overovanie. Pokiaµ je zadané meno a heslo platné na serveri CAS, Moodle vytvorí záznam pre nového u¾ívateµa v databáze, prièom si potrebné u¾ívateµské údaje vezme z databázy LDAP. Pri nasledujúcich prihláseniach sú u¾ kontrolované len prihlasovacie meno a heslo.';
...
$string['auth_dbdescription'] = 'Táto metóda vyu¾íva tabuµku v externej databáze na kontrolu platnosti daného u¾ívateµského mena a hesla. Ak je to nové konto, mô¾u by» do prostredia Moodle skopírované informácie aj z iných políèok.';
...
V obidvoch prípadoch, bude môc» u¾ívateµ po prihlásení upravova» v¹etky tieto políèka.</p>';
...
$string['auth_fcdescription'] = 'Táto metóda pou¾íva FirstClass server na skontrolovanie správnosti u¾ívateµského mena a hesla.';
...
$string['auth_ldap_bind_dn'] = 'Ak chcete pou¾íva» spoluu¾ívateµov na vyhµadávanie u¾ívateµov, uveïte to tu. Napríklad: \'ou=users,o=org; ou=others,o=org\'';
$string['auth_ldap_bind_pw'] = 'Heslo pre spoluu¾ívateµa.';
$string['auth_ldap_bind_settings'] = 'Spoloèné nastavenia ';
$string['auth_ldap_contexts'] = 'Zoznam kontextov, v ktorých sa nachádzajú u¾ívatelia. Oddeµte rozlièné kontexty bodkoèiarkou. Napríklad: \'ou=users,o=org; ou=others,o=org\'';
...
<b>Pozor!</b> Musíte upravi» funkciu auth_user_create() v súbore auth/ldap/lib.php, aby mohli by» takýmto spôsobom vytváraní noví u¾ívatelia.';
...
$string['auth_ldap_gracelogins_desc'] = 'Umo¾ni» podporu LDAP gracelogin (tzv. prihlásenie z milosti). Po tom, ako vypr¹í platnos» hesla, u¾ívateµ sa mô¾e prihlási», pokým nie je hodnota gracelogin 0. Ak povolíte toto nastavenie, u¾ívatelia budú informovaní, v prípade, ¾e im vypr¹í platnos» hesla.';
...
$string['auth_ldap_memberattribute'] = 'Nepovinné: voµba potlaèí názov atribútu èlena skupiny, ak u¾ívateµ patrí do skupiny. Obyèajne je to \'member\'';
$string['auth_ldap_objectclass'] = 'Nepovinné: voµba potlaèí funkciu objectClass pou¾ívanú na vyhµadávanie u¾ívateµov na ldap_user_type. Zvyèajne túto voµbu nepotrebujete meni».';
...
$string['auth_ldap_update_userinfo'] = 'Aktualizova» informácie o u¾ívateµovi (krstné meno, priezvisko, adresa...) z LDAP do Moodle. Hµada» v /auth/ldap/attr_mappings.php pre priraïujúce informácie. Ak potrebujete, definujte nastavenia pre \"Mapovanie údajov\". ';
$string['auth_ldap_user_attribute'] = 'Nepovinné: voµba potlaèí vlastnos» pou¾ívanú na hµadanie mien u¾ívateµov. Zvyèajne \'cn\'.';
$string['auth_ldap_user_settings'] = 'Nastavenia prehµadávania u¾ívateµov';
$string['auth_ldap_user_type'] = 'Vyberte si, ako budú u¾ívatelia uchovávaní v LDAP. Toto nastavenie tie¾ ¹pecifikuje, ako bude fungova» vytváranie nových u¾ívateµov, grace loginy a vypr¹anie platnosti hesla.';
$string['auth_ldap_version'] = 'Verzia LDAP protokolu, ktorú pou¾íva vá¹ server';
$string['auth_ldapdescription'] = 'Táto metóda poskytuje overovanie u¾ívateµov proti  LDAP serveru. 

Ak je u¾ívateµské meno a heslo správne, Moodle vytvorí nového u¾ívateµa vo svojej databáze. 	  

Tento modul doká¾e naèíta» u¾ívateµské vlastnosti z LDAP a predvyplni» po¾adované políèka v Moodle. 

Pre nasledujúce prihlasovania sa kontrolujú u¾ iba u¾ívateµské meno a heslo.';
$string['auth_ldapextrafields'] = 'Tieto políèka sú nepovinné. Mô¾ete predvyplni» niektoré políèka v profile u¾ívateµa v Moodle s informáciami z <b>LDAP políèok</b>, ktoré tu uvediete.
<p>Ak tu niè neuvediete, informácie z LDAP nebudú prenesené a namiesto toho bude uvádzané ¹tandardné Moodle nastavenie.</p>
<p>V obidvoch prípadoch bude môc» u¾ívateµ po prihlásení upravova» v¹etky tieto políèka.</p>';
$string['auth_ldaptitle'] = 'Pou¾i» LDAP server';
$string['auth_manualdescription'] = 'Táto metóda neumo¾òuje u¾ívateµom vytvára» vlastné kontá. V¹etky kontá musí ruène vytvori» administrátor.';
...
$string['auth_nntpdescription'] = 'Táto metóda pou¾íva na kontrolu správnosti u¾ívateµského mena a hesla NNTP server.';
...
$string['auth_nonedescription'] = 'U¾ívatelia sa mô¾u prihlási» a okam¾ite si vytvori» kontá bez nutnosti overovania proti externým serverom a bez potvrdzovania prostredníctvom emailu. Buïte opatrní pri tejto voµbe - myslite na bezpeènos» a problémy pri administrácii, ktoré tým mô¾u vzniknú».';
...
$string['auth_pop3description'] = 'Táto metóda pou¾íva na kontrolu správnosti u¾ívateµského mena a hesla POP3 server.';
...
$string['auth_shibbolethdescription'] = 'Táto metóda umo¾òuje vytvára» a overova» u¾ívatelov pomocou systému <a href=\"http://shibboleth.internet2.edu/\" target=\"_blank\">Shibboleth</a>.<br />
...
$string['auth_updatelocal_expl'] = '<p><b>Aktualizova» miestne údaje:</b> Ak je táto voµba aktívna, políèko bude aktualizované (z externého overovacieho zdroja) zaka¾dým, keï sa u¾ívateµ prihlási, alebo pri synchronizácii u¾ívateµov. Políèka urèené na miestnu aktualizáciu by mali by» uzamknuté.</p>';
$string['auth_updateremote'] = 'Aktualizova» externé údaje';
$string['auth_updateremote_expl'] = '<p><b>Aktualizova» externé údaje:</b> Ak je táto voµba aktívna, externý overovací zdroj bude aktualizovaný zaka¾dým, keï dôjde k aktualizácii profilu u¾ívateµa. Políèka urèené na miestnu aktualizáciu by nemali by» uzamknuté, aby sa mohli upravova».</p>';
$string['auth_updateremote_ldap'] = '<p><b>Poznámka:</b> Aktualizácia externých LDAP údajov si vy¾aduje nastavenie binddn a bindpw spoluu¾ívateµom s právom úpravy v¹etkých záznamov o u¾ívateµoch. Momentálne systém nepodporuje vlastnosti s viacerými hodnotami a pri aktualizácii sa preto odstránia nadbytoèné hodnoty.</p>';
$string['auth_user_create'] = 'Umo¾ni» vytváranie u¾ívateµov';
$string['auth_user_creation'] = 'Noví (anonymní) u¾ívatelia mô¾u vytvára» u¾ívateµské kontá v externom zdroji a overova» ich cez email. Ak to umo¾níte, nezabudnite tie¾ konfigurova» ¹pecifické voµby pre vytváranie u¾ívateµských úètov v danom externom zdroji.';
$string['auth_usernameexists'] = 'Zvolené u¾ívateµské meno u¾ existuje. Prosím, vyberte si iné.';
