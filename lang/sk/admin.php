...
$string['configcountry'] = 'Ak si tu vyberiete krajinu, tak bude táto krajina nastavá aj pre nové u¾ívateµské kontá. Ak chcete, aby si u¾ívatelia sami vybrali krajinu, nenastavujte ju tu.';
...
$string['configdigestmailtime'] = '¥uïom, ktorí sa rozhodnú pre zasielanie emailov v ¹truktúrovanej forme, bude ka¾dý deò prichádza» email struène informujúci o najnov¹ích udalostiach v kurze. Toto nastavenie urèuje tú èas» dòa, kedy bude tento email zasielaný u¾ívateµom (odo¹le ho nasledujúci cron po ukonèení tejto hodiny).  ';
$string['configdisplayloginfailures'] = 'Toto zobrazí vybraným u¾ívateµom informácie o predchádzajúcich neúspe¹ných pokusoch o prihlásenie.';
...
$string['configextendedusernamechars'] = 'Ak povolíte toto nastavenie, ¹tudenti mô¾u vo svojich u¾ívateµských menách pou¾íva» akékoµvek znaky (to v¹ak neovplyvní ich skutoèné mená). ©tandardné nastavenie je \'Nesprávne\', ktoré obmedzuje pou¾ívané znaky v menách len na alfanumerické znaky.';
...
$string['configforcelogin'] = 'Normálne mô¾e by» hlavná stránka s uvedeným zoznamom kurzov (nie s konkrétnymi kurzami) prezeraná u¾ívateµmi bez toho, aby sa predtým prihlásili. Ak chcete, aby sa u¾ívatelia prihlásili predtým, ako èokoµvek urobia na stránke, potom by ste mali aktivova» toto nastavenie. ';
$string['configforceloginforprofiles'] = 'Aktivovaním tohto nastavenia sa ka¾dý reálny u¾ívateµ (nie hos») bude musie» najskôr prihlási», ak si chce prezera» profily u¾ívateµov. Táto voµba je ¹tandardne deaktivovaná (\'Nesprávne\'), aby si perspektívni ¹tudenti mohli preèíta» informácie o uèiteµoch jednotlivých kurzov. Znamená to v¹ak tie¾, ¾e webové vyhµadávaèe ich doká¾u vyhµada» a prezera».';
...
$string['confightmleditor'] = 'Vyberte si, èi chcete povoli» pou¾ívanie zakomponovaného HTML textového editora alebo nie. Aj keï si vyberiete povoli», tento editor sa objaví iba keï u¾ívateµ pou¾íva kompatibilný prehliadaè (IE 5.5 alebo nov¹ie verzie). U¾ívatelia sa ale mô¾u tie¾ rozhodnú» nepou¾íva» tento prehliadaè.';
$string['configidnumber'] = '©pecifické nastavenia èi (a)U¾ívatelia nebudú po¾iadaní o zadanie ID èísla vôbec, (b)U¾ívatelia budú po¾iadaní o zadanie ID èísla, ale nemusia ho vyplni», (c)U¾ívatelia budú po¾iadaní o zadanie ID èísla a musia ho vyplni». Ak bude zadané ID èíslo u¾ívateµa, bude zobrazované v profile.';
...
$string['configintroadmin'] = 'Na tejto stránke by ste mali konfigurova» Va¹e hlavné administrátorské konto. Administrátor má plnú kontrolu nad celou stránkou. Dbajte na to, aby mal bezpeèné u¾ívateµské meno, heslo a tie¾ platnú emailovú adresu. Neskôr mô¾ete vytvori» viac administrátorských úètov.';
...
$string['configlang'] = 'Vyberte si východzí jazyk pre celú stránku. U¾ívatelia mô¾u neskôr toto nastavenie zmeni».';
...
$string['configlanglist'] = 'Nechajte túto voµbu prázdnu, ak chcete, aby si u¾ívatelia mohli vybra» µubovoµný jazyk z tejto verzie Moodle. Tento zoznam mô¾ete skráti», ak uvediete zoznam jazykov, oddelených èiarkou, napr.

sk,cz,en,es_es,fr,it.';
$string['configlangmenu'] = 'Vyberte si, èi chcete zobrazi» menu pre voµbu jazyka na www stránkach Moodle (domovská stránka, autorizaèná stránka a podobne). To neovplyvní u¾ívateµove mo¾nosti nastavenia preferovaného jazyka vo svojom vlastnom profile.';
...
$string['configloglifetime'] = 'Táto voµba ¹pecifikuje då¾ku èasového intervalu, poèas ktorého si chcete uchova» záznamy o u¾ívateµských aktivitách. Záznamy, ktoré sú star¹ie, sa automaticky vyma¾ú. Je dobré uchováva» si záznamy tak dlho, ako je to mo¾né, ale ak máte veµmi zaneprázdnený server a máte problémy s jeho rýchlos»ou, potom si vyberte krat¹í èas pre uchovávanie záznamov.';
...
$string['confignoreplyaddress'] = 'Emaily sa niekedy posielajú v mene u¾ívateµa (napr. prispievanie do fór). Emailová adresa, ktorú tu ¹pecifikujete, bude pou¾ívaná ako adresa \'Od koho\' v prípade, ak prijímatelia nie sú schopní priamo odpoveda» u¾ívateµovi (napr. keï si u¾ívateµ vyberie zachovanie súkromnej adresy).';
...
$string['confignotifyloginthreshold'] = 'Ak sú aktívne oznámenia o neúspe¹ných pokusoch o prihlásenie do systému, koµko takýchto prihlásení od jedného u¾ívateµa alebo jednej IP adresy sa má zobrazova» v oznámeniach?';
...
$string['configsecureforms'] = 'Moodle mô¾e pou¾i» dodatoèné bezpeènostné opatrenia pri akceptovaní vstupov z web formulárov. Ak to umo¾níte, potom sa bude overova» premenná HTTP_REFERER, ktorú po¹le browser a porovná sa s aktuálnou adresou formulára. Toto mô¾e spôsobi» (vo veµmi zriedkavých prípadoch) problémy, napr. ak je u¾ívateµ pou¾íva firewall, ktorý je konfigurovaný tak, ¾e odstráni premennú HTTP_REFERER. Vtedy sa mô¾e sta», ¾e formulár Vám \'zmrzne\'. Ak sa na to u¾ívatelia s»a¾ujú, mô¾ete deaktivova» toto nastavenie. V tomto prípade sa v¹ak vystavujete väè¹ím útokom zvonku (brute force password attacks).
...
$string['configsitepolicy'] = 'Ak máte definovanú podmienku, ktorú v¹etci u¾ívatelia musia vidie» a s òou súhlasi» pred pou¾ívaním tejto stránky, potom sem vlo¾te danú URL adresu; v opaènom prípade túto voµbu nevypåòajte. URL adresa mô¾e by» nastavená v ktoromkoµvek mieste - jedno z najvhodnej¹ích miest by bol súbor v súboroch stránky, napr. http://yoursite/file.php/1/policy.html ';
...
$string['configtimezone'] = 'Tu mô¾ete nastavi» východzie èasové pásmo. Toto je len VÝCHODZIE èasové pásmo pre zobrazovanie dátumov - ka¾dý u¾ívateµ toto mô¾e zmeni» nastavením svojho preferovaného zobrazovania dátumu v profile u¾ívateµa. \'Èas servera\' na Moodle bude implicitne nastavený podµa operaèného systému servera ale \'Èas servera\' v profile u¾ívateµa bude nastavený podµa nastavenia èasového pásma.';
...
$string['helpforcetimezone'] = 'Mô¾ete povoli» u¾ívateµom, aby si individuálne zvolili ich vlastné èasové pásmo, alebo nastavi» jedno èasové pásmo pre ka¾dého.';
...
$string['helpupcomingmaxevents'] = 'Koµko nadchádzajúcich udalostí (maximum) sa má ¹tandardne zobrazova» u¾ívateµom?';
...
$string['timezoneisforcedto'] = 'Nastavi» rovnaké pou¾itie pre v¹etkých u¾ívateµov';
