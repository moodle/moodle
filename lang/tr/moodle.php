...
$string['thislanguage'] = "Türkçe";  // Name of this language in the native language eg Français 
$string['thischarset'] = "iso-8859-9";  // The best charset to use for this language
...
$string['checklanguage'] = "Dil saðlama";
$string['choose'] = "Seç";
$string['choosecourse'] = "Bir ders seçiniz";
$string['chooselivelogs'] = "Yada mevcut etkinlikleri izleyiniz";
...
$string['defaultcourseshortname'] = "BDTA101";
...
$string['editmyprofile'] = "Profili düzenle";
...
$string['emailconfirmsent'] = "
   <P>Bu adresinize bir eposta gönderildi: <B>\$a</B>
...
$string['hitsoncourse'] = "\$a->username 'ün \$a->coursename dersini izlemeleri";
$string['hitsoncoursetoday'] = "\$a->username 'ün \$a->coursename dersini bugünkü izlemeleri";
$string['home'] = "Ana Sayfa";
$string['hour'] = "saat";
$string['hours'] = "saat";
$string['htmleditor'] = "Richtext HTML editörü kullanýnýz (IE only, 5.5 or later)";
$string['htmleditoravailable'] = "Richtext editörü var";
$string['htmleditordisabled'] = "Kullanýcý profilinizdeki Richtext editörünü kapattýnýz";
$string['htmleditordisabledadmin'] = "Yönetici bu sitedeki Richtext editörünü kapatmýþtýr";
$string['htmleditordisabledbrowser'] = "Internet Explorer 5.5 ve yukarýsý olmadýðý için Richtext editörünü kullanamazsýnýz";
...
$string['min'] = "dk";
$string['mins'] = "dk";
$string['miscellaneous'] = "Çeþitli";  // Default course category
...
$string['passwordsenttext'] = "
   <P>\$a->email adresinize bir eposta gönderildi.
...
$string['texteditor'] = "Standart web formlarý kullanýnýz";
...
$string['unsafepassword'] = "Güvenilmeyen þifre - baþka birini deneyin";
