...
$string['addingquestions'] = 'Sayfanýn bu tarafý soru bankasýný yöneteceðiniz yerdir. Sorularý daha kolay sýnýflandýrmanýz için sorular kategorik olarak ayrýlýrlar. Ayrýca \'yayýnla\' yý seçerseniz bu sorular herhangi bir sýnavda veya diðer derslerde kullanýlabilir.<br /><br /> Bir  soru kategorisi seçtikten veya oluþturduktan sonra sorularý düzenleyebilirsiniz. Sayfanýn diðer tarafýnda sorularý sýnavýnýza ekleyebilirsiniz.';
