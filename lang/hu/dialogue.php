...
$string['dialogueopened'] = 'Párbeszéd megnyitva a következõ személlyel: $a';
$string['dialoguewith'] = 'Párbeszéd a következõ személlyel: $a';
...
$string['openadialoguewith'] = 'Párbeszéd megnyitása a következõvel';
...
$string['pane1'] = '$a párbeszéd vár választ Öntõl';
$string['pane1one'] = '1 párbeszéd vár választ Öntõl';
$string['pane2'] = '$a párbeszéd vár választ a másik személytõl';
$string['pane2one'] = '1 párbeszéd vár választ a másik személytõl';
$string['pane3'] = '$a lezárt párbeszéd';
$string['pane3one'] = '1 lezárt párbeszéd';
$string['seen'] = 'Megtekintve $a ezelõtt';
$string['sendmailmessages'] = 'Üzenetek küldése új szövegeimrõl';
...
$string['typefirstentry'] = 'Az elsõ szöveget ide írja be';
