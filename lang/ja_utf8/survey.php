...
$string['attls5'] = '私自身のアイデンティティを得るためには様々な人々との相互理解が必要である思います。';
...
$string['attls7'] = '議論で他の人と意見が合わない時は、自分の立場を強くすることができます。';
...
$string['attlsintro'] = 'この調査の目的は、あなたの考え方と学び方に対する姿勢を評価することにあります。

回答には「正解」「不正解」はありません。私達はあなたの意見にのみ関心を持っています。あなたの回答内容は守秘義務を厳守して取り扱われ、評価に影響を与えることはありません。';
