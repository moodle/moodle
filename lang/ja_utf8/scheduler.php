...
$string['conflict'] = 'この期間にはすでに面会予約時間枠が登録されています。';
$string['date'] = '日付';
...
$string['moreslots'] = 'あなたは面会予約時間枠より多い学生を持っています。面会予約時間枠をさらに追加した方が良いでしょう。';
$string['move'] = '変更';
...
$string['welcomenewstudent'] = '下記のテーブルには、すべての利用可能な面会予約時間を表示しています。ラジオボタンを選択して、忘れずに「私の面会予約を保存」をクリックしてください。後で内容を変更したい場合は、このページを再度訪問してください。';
