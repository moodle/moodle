...
$string['date'] = '日付';
$string['divide'] = '面会予約時間枠を分割しますか?';
$string['duration'] = '面会時間';
$string['emptyslot'] = '空の面会予約時間枠';
$string['end'] = '終了時間';
$string['endtime'] = '終了時間';
...
$string['moreslots'] = 'あなたは面会予約時間枠より多い学生を持っています。面会予約時間枠をさらに追加してください。';
$string['move'] = '変更';
...
$string['slotwarning'] = '<b>警告: </b>選択された面会予約時間枠を指定した時間に移動するには、次の面会予約時間枠も移動する必要があります...';
$string['start'] = '開始時間';
