...
$string['configopentogoogle'] = 'この設定を「Yes」にした場合、Googleはあなたのサイトにゲストとして入ることができます。さらにGoogleがゲストとして自動的に記録したデータを元に、他の人があなたのサイトにアクセスできます。これは既にゲストアクセスを許可している場合の透過アクセスのみを提供します。';
...
$string['configsitepolicy'] = 'このサイトを使用する前に、全てのユーザがサイト使用許諾に同意する必要がある場合は、サイト使用許諾のURLを指定してください。同意する必要が無い場合は空白のままにしてください。URLは自由に指定することができます - 便利な場所はサイトファイルの中です。<br />
