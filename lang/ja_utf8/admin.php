...
$string['upgradeforumreadinfo'] = 'Moodle1.5では、フォーラムの既読/未読記事を追跡するために新しい機能が追加されました。この機能を有効にするには、投稿内容のトラッキングを含むテーブルをアップデートする必要があります。あなたのサイトのサイズにより、この作業は長時間かかる場合があります。また、データベースに非常に負荷がかかる可能性がありますので、閑散期のアップデート作業をお勧めします。このアップデート期間中も、あなたのサイトは動作し続け、ユーザは影響を受けません。この処理を開始した場合は処理が終わるまでブラウザを開いたままにしてください。ウインドウを閉じて処理を終わらせてしまった場合でも心配しないでください。アップデート処理を再開することができます。<br /><br />本当に今からアップデート処理を始めてもよろしいですか?';
