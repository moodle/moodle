...
$string['configsitepolicy'] = 'このサイトを使用する前に、全てのユーザがサイト使用許諾に同意する必要がある場合は、サイト使用許諾のURLを指定してください。同意する必要が無い場合は空白のままにしてください。URLは自由に指定することができます - 便利な場所はサイトファイルの中です。例 http://yoursite/file.php/1/policy.html';
...
$string['configteacherassignteachers'] = '一般の教師は自分が教えるコースに他の教師を割当てることができますか? 「No」の場合、コース作成者および管理者のみが教師の割当てを行うことができます。';
