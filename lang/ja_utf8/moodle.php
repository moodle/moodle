...
$string['adminhelpcourses'] = 'コース・カテゴリの設定および人の割り当て、承認審査中コースの編集を行います。';
...
$string['alreadyconfirmed'] = '登録作業はすでに完了しています。';
$string['always'] = '常に';
$string['answer'] = '回答';
$string['approve'] = '承認';
...
$string['backupincludemoduleshelp'] = '自動バックアップのコースモジュールにユーザデータを含めるか選択してください。';
...
$string['edhelpcleanword'] = 'ここでは、Word特有のフォーマットをフィルタするかどうかを設定します。';
$string['edhelpenablespelling'] = 'スペルチェックを行うかどうかを設定します。スペルチェックを行う場合、<strong>aspell</strong>が自動的にサーバにインストールされます。';
...
$string['metaalreadycourses'] = 'コースがすでに割り当てられています。';
