...
$string['addingquestions'] = 'ここではデータベース内の質問を管理します。質問は整理しやすいようカテゴリ毎に保存されます。また、「公開」を選択した場合、コース内または他のコースの小テストで使用することができます。<br /><br />問題カテゴリの作成を選択した後、問題の作成または編集を行うことができます。ページの反対側にある問題一覧から問題を選択して、小テストに追加することができます。';
...
$string['confirmstartattempttimelimit'] = 'この小テストには時間制限があります。また、受験回数が $a 回に制限されています。小テストへのアクセスは受験回数としてカウントされます。続けてもよろしいですか?';
...
$string['review'] = '再閲覧';
$string['reviewafter'] = '小テスト終了後に再閲覧を許可する';
$string['reviewalways'] = '常に再閲覧を許可する';
$string['reviewbefore'] = '小テスト実施中に再閲覧を許可する';
$string['reviewclosed'] = '小テスト終了後';
$string['reviewimmediately'] = '受験後すぐに';
$string['reviewnever'] = '再閲覧を許可しない';
$string['reviewofattempt'] = '$a 回の受験結果を再閲覧';
$string['reviewopen'] = '後で、クイズが開いている最中';
$string['reviewoptions'] = '学生の再閲覧可';
$string['reviewresponse'] = '解答の再閲覧';
$string['rqp'] = 'リモート問題';
$string['rqps'] = 'リモート問題';
$string['save'] = '保存';
