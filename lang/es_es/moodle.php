...
$string['adminhelplogs'] = "Navegar por los registro de toda la actividad del sitio";
$string['adminhelpmanagedatabase'] = "Acceso a la base de datos directamente (¡tenga cuidado!)";
$string['adminhelpmanagemodules'] = "Gestiona los módulos instalados y su configuración";
$string['adminhelpsitefiles'] = "Para publicar archivos o cargar copias de respaldo externas";
$string['adminhelpsitesettings'] = "Definir el aspecto de la página de entrada";
$string['adminhelpthemes'] = "Escoger el aspecto del sitio";
...
$string['backupfilename'] = "copia de respaldo";
$string['backupfinished'] = "Copia de respaldo completada con éxito";
