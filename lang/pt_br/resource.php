...
$string['configparametersettings'] = 'Isto define o valôr padrão dos parâmetros do formulário do painel de configuração quando são criados novos recursos. Depois da primeira vez, passa a ser uma preferência individual do usuário.';
...
$string['localfilepath'] = 'Para definir o percurso de acesso deste recurso, escolha qualquer arquivo do dispositivo do seu computador que contém o material (normalmente um CD-ROM) . Este arquivo não será enviado, mas a informação sobre o dispositivo será arquivada e usada para futuros acesso a recursos locais.';
...
$string['notallowedlocalfileaccess'] = 'O acesso a arquivos locais está disabilitado, portanto este recurso não pode ser acessado';
$string['note'] = 'Nota';
