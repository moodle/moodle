...
$string['missingfirstname'] = "姓没填";
$string['missingfullname'] = "全名没填";
$string['missinglastname'] = "名没填";
...
$string['topic'] = "主题";
$string['topichide'] = "从 \$a 隐藏该话题";
$string['topicoutline'] = "主题目录";
$string['topicshow'] = "显示该话题于 \$a";
$string['total'] = "总计";
...
$string['updatesevery'] = "每隔 \$a 秒更新一次";
$string['updatethis'] = "更新这个 \$a";
$string['updatethiscourse'] = "更新该课程";
$string['updatinga'] = "正在更新一个 \$a";
