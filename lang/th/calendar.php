...
$string['explain_timeformat'] = 'คุณสามารถเลือกที่จะแสดงเวลาเป็นแบบ 12 ชั่วโมง (เช้า/เย็น) หรือแบบ 24 ชั่วโมงก็ได้  ถ้าคุณเลือก \"ค่าที่ตั้งไว้\" เวลาจะถูกแสดงตามภาษาที่คุณใช้บนเว็บไซต์';
...
$string['tt_hidecourse'] = 'กิจกรรมของรายวิชา(คลิ้กเพื่อซ่อน)';
$string['tt_hideglobal'] = 'กิจกรรมของเว็บไซต์(คลิ้กเพื่อซ่อน)';
$string['tt_hidegroups'] = 'กิจกรรมของกลุ่ม (คลิ้กเพื่อซ่อน)';
$string['tt_hideuser'] = 'กิจกรรมของสมาชิก (คลิ้กเพื่อซ่อน)';
$string['tt_showcourse'] = 'ซ่อนกิจกรรมของรายวิชา (คลิ้กเพื่อแสดง)';
$string['tt_showglobal'] = 'ซ่อนกิจกรรมของเว็บ(คลิ้กเพื่อแสดง)';
$string['tt_showgroups'] = 'ซ่อนกิจกรรมของกลุ่ม(คลิ้กเพื่อแสดง)';
$string['tt_showuser'] = 'ซ่อนกิจกรรมของสมาชิก(คลิ้กเพื่อแสดง)';
$string['tue'] = 'อ.';
