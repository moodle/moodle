...
$string['admindirerror'] = 'ไดเรกทอรี่ admin ที่ระบุไม่ถูกต้อง';
$string['admindirname'] = 'ไดเรกทอรี่ admin';
...
$string['configfilenotwritten'] = 'ตัวติดตั้งอัตโนมัติไม่สามารถสร้างไฟล์ config.php ได้ อาจเป็นเพราะว่าไม่สามารถเขียนลงไดเรกทอรี่ moodle ได้ คุณสามารถสร้างไฟล์ดังกล่าวได้เองโดยการก้อปปี้โค้ดต่อไปนี้ลงในไฟล์ที่ต้องการสร้างใหม่';
...
<b>ชื่อฐานข้อมูล:</b> ชื่อฐานข้อมูล, เช่นอmoodle<br />
...
$string['dataroot'] = 'ไดเรกทอรี่ข้อมูล';
$string['datarooterror'] = 'ไม่พบไดเรกทอรี่ข้อมูลที่คุณระบุไว้หรือไม่สามารถสร้างได้ กรุณาแก้ไข Path ให้ถูกต้องหรือสร้างไดเรกทอรี่นี้ใหม่';
...
ระบุที่อยู่ของเว็บไซต์ที่คุณจะนำ Moodle ไปใช้ ถ้าหากเว็บของคุณเข้าผ่าน URLs หลายขั้นให้เลือกที่นักเรียนของคุณจะเข้าไปใช้ ไม่ต้องใส่เครื่องหมาย /  ปิดท้าย

<b>ไดเรกทอรี่ moodle </b>

ระบุ path ของไดเรกทอรี่เต็ม ๆ ที่ใช้ในการติดตั้ง ระวังเรื่องการใช้ชื่อตัวพิมพ์ใหญ่พิมพ์เล็กให้ดี ให้แน่ใจว่าถูกต้อง </p>

<p><b>ไดเรกทอรี่ข้อมูล:</b>

ไดเรกทอรี่นี้จะเป็นที่เก็บไฟล์ที่ moodle จะทำการบันทึกไว้ เป็นข้อมูลของเว็บ ดังนั้นควรให้สิทธิ์ในการอ่าน และ เขียนลงไดเรกทอรี่นี้  (ทั่วไปแล้ว \'nobody\' หรือ \'apache\'), แต่ไม่ควรเข้าไปตรง ๆ ผ่านเว็บได้
</p>';
$string['dirroot'] = 'Moodle ไดเรกทอรี่';
$string['dirrooterror'] = 'การตั้งค่า ไดเรกทอรี่ moodle ไม่ถูกต้อง ไม่พบไฟล์ติดตั้งที่ระบุ  ระบบทำการรีเซ็ตค่าด้านล่างนี้ ';
...
<p>ถ้าคุณไม่สามารถแก้ไขไฟล์ php.ini ได้ด้วยตนเองคุณสามารถทำการปิดฟังก์ชั่นนี้โดยการเพิ่มไฟล์ .htaccess ภายใต้ไดเรกทอรี่ moodle โดยสร้างไฟล์ที่มีการตั้งค่าดังนี้
...
$string['pass'] = 'สำเร็จ';
$string['phpversion'] = 'PHP เวอร์ชั่น';
$string['phpversionerror'] = 'เวอร์ชั่นของ PHP ควรเป็นอย่างน้อย 4.1.0';
$string['phpversionhelp'] = '<p>Moodle จำเป็นต้องใช้ PHP เวอร์ชั่น 4.1.0 เป็นอย่างน้อย</p>

<p>คุณกำลังใช้เวอร์ชั่น $a</p>

<p>คุณต้องอัพเกรด  PHP หรือย้ายโฮสต์ใหม่ที่มี PHP เวอร์ชั่นใหม่กว่า</p>';
