...
$string['auth_emaildescription'] = 'ในการสมัครเป็นสมาชิกนั้น ผู้สมัครจะได้รับการอนุมัติ ผ่านอีเมล์ ซึ่งเป็นค่าที่ตั้งไว้ของระบบ เมื่อผู้สมัครเลือก ชื่อ และ รหัสผ่านแล้ว ระบบจะทำการส่งอีเมล์ไปยัง อีเมล์ของสมาชิกนั้น อีเมล์นี้จะมีลิงก์กลับไปยังหน้าหลักของหน้า ซึ่งจะเป็นการยืนยันว่า อีเมล์ดังกล่าวใช้ได้จริง  หลังจากนั้นสมาชิก สามารถล็อกอินโดยใช้ชื่อและรหัสผ่านเว็บ';
...
$string['auth_ldap_create_context'] = 'เปิดให้สมาชิกสามารถสร้างข้อความตอบรับทางอีเมล์ด้วยตนเองได้ 
...
$string['auth_nonedescription'] = 'สมาชิกสามารถ ล็อกอิน และสร้าง account ใหม่ทันที โดยไม่ต้องใช้วิธีการขออนุมัติ การเป็นสมาชิกจากฐานข้อมูลนอก ไม่ต้องยืนยันผ่านอีเมล์  ควรระวังในการเลือกใช้วิีธี นี้ เพราะ ว่า ระบบความปลอดภัยนั้นมีน้อย ';
...
$string['authinstructions'] = 'คุณสามารถให้ข้อมูลกับสมาชิก และแนะนำวิธีการใช้ ผ่านส่วนนี้ ทำให้สมาชิกทราบว่า username และ รหัสผ่าน ของตัวเองคืออะไร ข้อความที่คุณระบุในส่วนนี้จะปรากฎ ใน หน้า login  ถ้าหากคุณปล่อยว่างไว้ จะไม่มีวิธีการใช้ปรากฎ';
$string['changepassword'] = 'เปลี่ยนรหัส URL';
$string['changepasswordhelp'] = 'คุณสามารถระบุลิงก์ ที่สมาชิกสามารถจะเปลี่ยน หรือ หา ชื่อ และ รหัสผ่านได้ เมื่อมีการลืม ลิงก์ดังกล่าวจะนำสมาชิกไปยังหน้า ล็อกอิน และหน้าข้อมูลส่วนตัว แต่หากไม่เติมอะไร ปุ่มดังกล่าวจะไม่ปรากฎ';
...
$string['showguestlogin'] = 'คุณสามารถซ่อนหรือแสดงปุ่ม Login สำหรับบุคคลทั่วไปในหน้าล็อกอินได้ ';
