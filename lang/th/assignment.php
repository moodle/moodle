...
$string['modulenameplural'] = "การบ้านทั้งหมด";
$string['newsubmissions'] = "การบ้านที่ส่งแล้ว";
$string['notsubmittedyet'] = "การบ้านที่ยังไม่ได้ส่ง";
$string['overwritewarning'] = "คำเตือน:  คุณส่งไฟล์ซ้ำค่ะ ถ้าส่งขึ้นไประบบจะทำการบันทึกไฟล์นี้ ทับไฟล์เดิมที่มีอยู่";
...
$string['yoursubmission'] = "งานที่คุณส่ง";
