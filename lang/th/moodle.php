...
$string['categoryduplicate'] = "'\$a'   ประเภทนี้มีอยู่แล้วค่ะ";
...
$string['configsessiontimeout'] = "ถ้าผู้ใช้ล็อกอินแล้วไม่ได้ใช้งานบนคอมพิวเตอร์เป็นเวลานาน (เช่นว่าไม่ได้เปิดดูหน้าไหนเลยบนเว็บ) ระบบจะทำการ logout ให้โดยอัตโนมัติ ค่านี้เป็นการกำหนดเวลาว่า ควรเป็นเท่าไหร่";
...
$string['hitsoncoursetoday'] = "จำนวนเข้าชมวันนี้  \$a->coursename โดย \$a->username  ";
