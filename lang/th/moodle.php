<?PHP // $Id$ 
      // moodle.php - created with Moodle 1.4.2 (2004083125)
...
$string['blockconfigin'] = 'รายวิชา : ตั้งค่าบล็อคใน$a';
...
$string['emailconfirmsent'] = '   <p>อีเมลส่งไปให้คุณที่ <b>$a</b></p>
   <p>ประกอบไปด้วยวิธีการลงทะเบียนขั้นสุดท้าย <p>ถ้าหากคุณมีปัญหาในการลงทะเบียน กรุณาติดต่อผู้ดุแลระบบ</p>';
...
<br /> ระบบได้ส่งรหัสผ่านใหม่ไปให้คุณที่ <b>$a->email</b>
<br /> รหัสผ่านใหม่ของคุณเป็นการกำหนดขึ้นโดยระบบ คุณควรเข้าไปทำการแก้ใขให้จำได้ง่ายที่ <a href=\"$a->link\">เปลี่ยนรหัสผ่าน</a>';
...
$string['loginsteps'] = '<p>สวัสดี </p><p> กรุณาสมัครสมาชิกใหม่เพื่อที่คุณจะสามารถ เข้าไปยังบทเรียนต่างๆได้ในแต่ละรายวิชานั้นอาจจะต้องการ รหัสผ่านซึ่งคุณยังไม่จำเป็นต้องไปกังวลจนกว่าจะได้เป็นสมาชิกแล้วกรุณาทำตามขั้นตอนต่อไปนี้</p>

<ol>
   <li>กรอกแบบฟอร์ม<a href=\"$a\">สมัครสมาชิกใหม่</a></li> 
   <li>ระบบจะทำการส่งอีเมลไปยังอีเมลที่คุณให้ไว้<li>อ่านอีเมล จากนั้นคลิกที่ ลิงก์ในอีเมลนั้น .</li>
   <li>account ของคุณจะได้รับการยืนยัน และคุจะสามารถล็อกอินได้ทันที</li>
   <li> เลือกรายวิชาที่ต้องการเข้าไปเรียน </li>
   <li>ถ้าหากคุณถูกถามให้ใส่รหัสในการเข้าเรียนให้ใส่ รหัสที่อาจารย์ของคุณให้ไว้ </li>
<li> นับจากนี้คุณสามารถเข้าอ่านและใช้ข้อมูลในแต่ละรายวิชาได้ โดย ครั้งต่อไปเพียงแต่ใส่ username และ password เท่านั้น จากหน้านี้ </li></ol>';
$string['loginstepsnone'] = '<p>สวัสดี</p><p>กรุณาสมัครสมาชิกใหม่เพื่อที่คุณจะสามารถ เข้าไปยังบทเรียนต่างๆได้ </p><p>ถ้าหากมีคนเลือกชื่อผู้ใช้ที่คุณต้องการไปแล้วกรุณาเลือกชื่อใหม่</p>';
...
$string['passwordsenttext'] = '   <p>อีเมลส่งไปให้คุณแล้วที่    $a->email. </p><p><b>กรุณาเช็คอีเมลเพื่อเช็ครหัสผ่านใหม่</b>
</p>   <p>หาต้องการเปลี่ยนรหัสผ่าน <a href=\"$a->link\">ให้คลิกที่ลิงก์นี้<</a>.</p>';
...
$string['registrationinfo'] = '<p>คุณสามารถลงทะเบียนเว็บไซต์ Moodle ของคุณกับทาง moodle.org โดยไม่เสียค่าใช้จ่ายใด ๆ ประโยชน์ของการลงทะเบียนคือคุณจะได้รับอีเมลแจ้งข่าวที่สำคัญ อาทิแจ้งเกี่ยวกับระบบความปลอดภัยของ Moodle หรือเมื่อมีเวอร์ชันใหม่พร้อมให้ดาวน์โหลด </p>

<p>ทาง Moodle.org จะเก็บข้อมูลของท่านไว้เป็นความลับและไม่มีการส่งต่อข้อมูลให้กับเว็บไซต์อื่นใด แต่จะเก็บเป็นข้อมูลสำหรับสถิติผู้ใช้งาน Moodle  ทั้งหมดที่มีอยู่ </p>

<p>คุณสามารถเลือกที่จะให้ชื่อเว็บไซต์ ประเทศ และ URL ปรากฎอยู่ในหน้ารวมลิงก์ของ Moodle.org</p>
<p>ทาง Moodle.org จะทำการตรวจสอบแบบฟอร์มการลงทะเบียนแต่ละอันก่อนที่จะเพิ่มชื่อลงในเว็บไซต์ หลังจากที่เว็บของคุณปรากฎอยู่บน Moodle.org แล้วคุณสามารถทำการเปลี่ยนแปลงข้อมูลต่าง ๆ ได้ในภายหลัง</p>';
...
$string['searchhelp'] = 'คุณสามารถค้นหาคำหลาย ๆ คำในครั้งเดียว  <br /> คำ : ค้นหาคำที่อยู่ในข้อความให้ตรงกับคำที่ใส่ <br /> +คำ : ค้นหาเฉพาะคำที่ตรงกับที่ระบุเท่านั้น <br />-คำ: ไม่รวมผลการค้นหาที่มีคำ ๆ นี้อยู่';
