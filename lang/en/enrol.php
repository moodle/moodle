...
$string['edituserenrollment'] = 'Edit {$a}\'s enrollment';
$string['enrol'] = 'Enrol';
...
$string['enrolmentupdatedforuser'] = 'The enrollment for user "{$a->fullname}" has been updated';
...
$string['eventuserenrolmentupdated'] = 'User enrollment updated';
...
$string['none'] = 'None';
$string['notenrollable'] = 'You cannot enroll yourself in this course.';
...
$string['unenrolnotpermitted'] = 'You do not have permission to unenroll this user from the course.';
...
$string['extremovedaction_help'] = 'Select action to carry out when user enrollment disappears from external enrollment source. Please note that some user data and settings are purged from course during course unenrolment.';
