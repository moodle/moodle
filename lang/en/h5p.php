...
$string['h5penablelangplugin'] = 'Enable language plugin';
$string['h5penablelangplugin_help'] = 'If enabled, a button for marking language for a given text will appear in the editor toolbar.';
