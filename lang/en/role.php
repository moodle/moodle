...
$string['ltix:grade'] = 'View grades returned by the external tool';
...
$string['ltix:requesttooladd'] = 'Request a tool is configured site-wide';
$string['ltix:view'] = 'Launch external tool activities';
