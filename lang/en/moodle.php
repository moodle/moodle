...
$string['uid'] = 'UID';
$string['ration'] = 'Ration Card No.';
$string['license'] = 'License No.';
$string['passport'] = 'Passport No.';
$string['pan'] = 'PAN No.';
$string['middlename'] = 'Middle name';
$string['marital_status'] = 'Marital Status';
$string['ph_challenged'] = 'Physically Challenged';
$string['pr_address'] = 'Present Address';
$string['pe_address'] = 'Permanent Address';
$string['c_home'] = 'Contact No: (Home)';
$string['c_mobile'] = 'Contact No: (Mobile)';
$string['c_office'] = 'Contact No: (Office/School)';
$string['alt_mailid'] = 'Alternate Email id';
$string['m_address'] = 'Mailing address';
$string['school_add'] = 'School address/ Current Office';
$string['doj'] = 'Date of Joining';
$string['designation'] = 'Current Designation';
$string['qualification_grad'] = 'Qualification Graduation';
$string['qualification_post_grad'] = 'Qualification Post Graduation';
$string['exp'] = 'Experience';
$string['training_attened'] = 'Training courses attended';
$string['expert_in'] = 'Expert in subjects:';
$string['p_career_info'] = 'Previous Career Info';
$string['grade'] = 'Grade';
$string['hobbies'] = 'Interests and Hobbies';
$string['sport'] = 'Sports Proficiency';
$string['cultural'] = 'Cultural Proficiency';
$string['other_achievements'] = 'Other achievements';
