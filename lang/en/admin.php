...
$string['configsimplereturnloginas'] = 'Allow users to return to their original session after being logged in as without re-entering password. This is not recommended for production servers as there could be potential risk of other users taking control over admin\'s session. If user has visited pages marked as dangerous for the session they will still need to enter password. {$a}';
$string['configsimplereturnloginasexperimental'] = 'This setting is marked as experimental until all dangerous pages are marked in core and contributed plugins';
...
$string['simplereturnloginas'] = 'Simple return from login as';
