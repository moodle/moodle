...
$string['configcourseoverviewfilessizelimit'] = 'The total size of files that can be displayed next to the course summary on the list of courses page. Determined in bytes.';
