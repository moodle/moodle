...
$string['coursepublished'] = 'This course has been published successfully on \'{$a}\', although it still needs to be approved by the hub administrator before it will appear in the course listing.';
