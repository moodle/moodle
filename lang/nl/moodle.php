...
$string['backupmetacoursehelp'] = 'Als dit ingeschakeld is, dan zal de informatie voor overkoepelende vakken (overgeërfde aanmeldingen) meegenomen worden in automatische backups';
...
$string['childcoursenotfound'] = 'Onderliggend vak niet gevonden!';
$string['choose'] = 'Kies';
...
$string['coursehidden'] = 'Dit vak is nu niet ter beschikking voor leerlingen';
...
$string['creatingcoursemodules'] = 'Vakmodules maken';
...
$string['creatingmetacoursedata'] = 'Informatie voor overkoepelend vak maken';
...
$string['deletecoursecheck'] = 'Weet je zeker dat je dit vak en alle gegevens die erin zitten volledig wilt verwijderen?';
...
$string['managemetaexplan'] = '(Dit betekent dat aanmeldingen overgeërfd worden van andere vakken)';
...
$string['metacourse'] = 'Overkoepelend vak';
...
$string['parentcoursenotmetacourse'] = 'Bovenliggend vak is geen overkoepelend vak!';
...
$string['virusfoundlateradmin'] = 'Opgelet beheerder! Een bestand dat geüpload werd op $a->date met als bestandsnaam $a->filename voor het vak $a->course is  besmet met een virus. Hier is een samenvatting van wat er sinds toen met het bestand gebeurd is:
...
$string['writingcoursedata'] = 'Vakdata schrijven';
