<?PHP // $Id$ 
      // scheduler.php - created with Moodle 1.3 - (2004052400)


$string['action'] = 'Action';
$string['addsession'] = 'Voeg sessie toe';
$string['addslot'] = 'Op elk moment kun je meer afspraakmomenten toevoegen.';
$string['cantfit'] = 'Een afspraak van $a minuten past niet in deze sessie';
$string['choice'] = 'Keus';
$string['composeemail'] = 'Stuur e-mail:';
$string['conflict'] = 'Er was al een afspraakmoment op het tijdsblok dat je nu weer probeert toe te voegen';
$string['date'] = 'Datum';
...
$string['moreslots'] = 'Je hebt meer studenten dan afspraakmomenten, waarschijnlijk wil je dus meer sessies toevoegen.';
$string['move'] = 'Wijzig';
$string['moveslot'] = 'Verplaats afspraakmoment';
...
$string['seen'] = 'Gezien';
$string['slots'] = 'Afspraakmomenten';
$string['slotsadded'] = '$a afpraakmomenten zijn toegevoegd';
$string['start'] = 'Start';
