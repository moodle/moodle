...
$string['editevent'] = 'Bewerk gebeurtenis';
$string['errorbeforecoursestart'] = 'Je kunt geen gebeurtenis plannen voor de startdatum van het vak';
...
$string['tt_hideglobal'] = 'Globale activiteiten worden getoond (klik om te verbergen)';
$string['tt_hidegroups'] = 'Groepsactiviteiten worden getoond (klik om te verbergen)';
$string['tt_hideuser'] = 'Gebruikersactiviteiten worden getoond (klik om te verbergen)';
$string['tt_showcourse'] = 'Vakactiviteiten zijn  verborgen (klik om te tonen)';
$string['tt_showglobal'] = 'Globale activiteiten zijn verborgen (klik om te tonen)';
...
$string['typeuser'] = 'Gebruiker';
$string['upcomingevents'] = 'Komende activiteit';
$string['userevents'] = 'Gebruiker';
$string['wed'] = 'Wo';
