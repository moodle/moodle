...
$string['reviewday'] = 'Collecter les données de la carte de crédit automatiquement, à moins qu\'un enseignant ou un administrateur ne contrôle la commande dans les <b>$a</b> jours. LE CRON DOIT ÊTRE ACTIF.<br />(0 = désactiver la collecte automatique. Un contrôle par un enseignant ou administrateur est nécessaire. La transaction sera annulée si elle n\'est pas contrôlée dans les 30 jours)';
