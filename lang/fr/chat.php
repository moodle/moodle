...
$string['explainmethoddaemon'] = 'Ces réglages sont appliquŽs <strong>uniquement</strong> si vous avez choisi la méthode de chat « Utilisation d\'un démon »';
$string['explainmethodnormal'] = 'Ces réglages sont appliquŽs <strong>uniquement</strong> si vous avez choisi la méthode de chat « Méthode normale »';
