...
$string['dbmigratewarning'] = 'Veuillez vous assurer de bien avoir effectuer un copie de sauvegarde de votre base de données Moodle avant de commencer cette procédure. Si vous n\'êtes pas sûr de la façon dont le faire, veuillez contacter votre administrateur système. Votre site Moodle sera placé en mode de maintenance mode après le début du processus de migration.';
...
$string['importlangreminder'] = 'Le processus de migration de la base de données commence. Il vous sera nécessaire de <b>vous connecter à nouveau</b> pour que la mise à jour prenne effet. Veuillez installer les fichiers de langue en Unicode aussitôt que possible en suivant Administration -> Langue -> Utilitaire d\'importation de langue <b>après</b> que le processus de migration de la base de données est terminé. ';
