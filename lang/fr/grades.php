...
$string['displaylettergrade'] = 'Afficher les notes sous forme de lettres';
$string['displaypercent'] = 'Afficher en pourcent';
$string['displaypoints'] = 'Afficher les points';
$string['displayweighted'] = 'Afficher les notes pondérées';
$string['dropped'] = 'Ignoré';
$string['dropxlowest'] = 'Ignorer les X plus basses';
$string['dropxlowestwarning'] = 'Reamrque&nbsp;: si vous utilisez l\'option d\'ignorer les X plus basses notes, tous les éléments de la catégorie seront considérés comme valant le même nombre de points. Si ces valeurs varient, les résultats seront imprévisibles&nbsp;!';
...
$string['extracredit'] = 'Point supplémentaire';
$string['extracreditwarning'] = 'Remarque&nbsp;: si vous placez tous les éléments d\'une catégorie comme bonus, cela aura pour effet de les retirer complètement du calcul des notes, puisqu\'il n\'y aura pas de point au total.';
...
$string['gradeexceptions'] = 'Exceptions de note';
...
$string['gradeletternote'] = 'Pour supprimer une note lettre, effacer simplement tout<br />le contenu des trois zones de texte correspondantes et cliquer sur Enregistrer.';
...
$string['viewgrades'] = 'Afficher le notes';
