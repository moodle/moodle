...
$string['dropxlowestwarning'] = 'Reamrque&nbsp;: si vous utilisez l\'option «&nbsp;ignorer les n notes les plus basses&nbsp;»,<br />tous les éléments de la catégorie seront considérés comme valant<br />le même nombre de points. Si ces valeurs varient, les résultats seront imprévisibles&nbsp;!';
