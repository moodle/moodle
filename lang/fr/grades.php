...
$string['dropxlowest'] = 'Ignorer les n plus basses notes';
$string['dropxlowestwarning'] = 'Reamrque&nbsp;: si vous utilisez l\'option d\'ignorer les n notes les plus basses, tous les éléments de la catégorie seront considérés comme valant le même nombre de points. Si ces valeurs varient, les résultats seront imprévisibles&nbsp;!';
...
$string['gradeletternote'] = 'Pour supprimer une note lettre, effacer simplement le contenu<br />des trois zones de texte correspondantes et cliquer sur Enregistrer les changements.';
