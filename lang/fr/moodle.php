...
$string['deletecategorycheck'] = 'Voulez-vous vraiment supprimer la categorie <strong>« $a »</strong>?<br />Tous les cours de cette catégorie seront déplacés la catégorie mère, si elle existe existe, ou à défaut dans la catégorie Divers.';
...
$string['forcepasswordchange'] = 'Imposerle changement du mot de passe';
...
$string['managemetaexplan'] = '(Ceci signifie que les inscriptions sont héritées d\'autres cours)';
...
$string['metaalreadycourses'] = 'Dse cours ont déjà été assignés';
$string['metaalreadyhascourses'] = 'Ce méta-cours a déjà des cours fils.';
...
$string['metanoalreadycourses'] = 'Aucun cours n\'a encore été assigné';
