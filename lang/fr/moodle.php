...
$string['clamdeletedfile'] = 'Le fichier a t supprim';
...
$string['configrunclamonupload'] = 'Lancer clam AV lors du dépôt de fichiers&nbsp;? Il est indispensable d\'indiquer en outre le chemin d\'accès correct dans le champ « pathtoclam » pour un fonctionnement correct. (Clam AV est un antivirus libre et gratuit que vous pouvez obtenir ici&nbps;: http://www.clamav.net/)';
...
$string['missingstrings'] = 'Vérifier les textes manquant';
...
$string['site'] = 'Site';
$string['siteerrors'] = 'Erreur du site';
...
$string['sitepartlist1'] = 'Yous devez être un enseignant pour être autorisé à voir la liste des participants';
$string['sites'] = 'Sites';
