...
$string['configcleanreadtime'] = ' Godzina i dzieñ oczyszczania starych posów w tablicy przeczytanych';
...
$string['configtrackreadposts'] = 'Ustaw \"tak\" je¿eli chcesz ¶ledziæ przeczytane/nieprzeczytane posty dla ka¿dego u¿ytkownika';
$string['configusermarksread'] = 'Je¿eli \"tak\" u¿ytkownik musi sam zaznaczyæ post jako przeczytany. Je¿eli \"nie\", to post wy¶wietlony jest zaznaczany jako przeczytany.';
...
$string['deletedposts'] = 'Posty zosta³y usuniête';
$string['deletesure'] = 'Czy masz pewno¶æ, ¿e chcesz usun±æ te post?';
$string['deletesureplural'] = 'Czy napewno chcesz usun±æ ten post i wszystkie odpowiedzi? ($a postów)';
...
$string['noguestsubscribe'] = 'Niestety go¶cie nie mog± ustawiæ przysy³ania postów na e-mail';
$string['noguesttracking'] = 'Niestety go¶cie nie mog± zmieniæ opcji obserwowania postów.';
...
$string['postadded'] = 'Twój post zosta³ dodany. <br />Je¿eli chcesz co¶ jeszcze zmieniæ masz $a na edycjê.';
...
$string['searchdatefrom'] = 'Post nowszy ni¿';
$string['searchdateto'] = 'Post starszy ni¿';
$string['searchforumintro'] = 'Wprawad¼ szukane s³owo/s³owa. Mo¿esz uzupe³niæ jedno lub wiêcej pól.';
$string['searchforums'] = 'Szukaj w forach';
$string['searchfullwords'] = 'Ze s³owami';
$string['searchnotwords'] = 'Bez nastêpuj±cych s³ów';
$string['searcholderposts'] = 'Przeszukaj dawniejsze posty...';
$string['searchphrase'] = 'Z fraz±';
$string['searchresults'] = 'Szukaj w rezultatach';
$string['searchsubject'] = 'S³owa w polu tytu³';
$string['searchuser'] = 'S³owa w polu autor';
$string['searchuserid'] = 'Id autora';
$string['searchwhichforums'] = 'Wybierz forum';
$string['searchwords'] = 'S³owa które maj± wyst±piæ w postach';
$string['seeallposts'] = 'Poka¿ wszystkie posty tego u¿ytkownika';
...
$string['trackforum'] = 'Poka¿ nieprzeczytane';
