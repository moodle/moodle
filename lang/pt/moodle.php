...
$string['allowguests'] = "Este curso permite acesso a todos os utilizadores";
...
$string['categories'] = "Categorias dos Cursos";
...
$string['configauth'] = "Escolha o método de autenticação que quer usar. O mais seguro é 'email' que é o valor por omissão. O método 'none' não envia qualquer verificação - evite esse método, a menos que saiba muito bem o que você está a fazer.";
...
$string['configlongtimenosee'] = "Se um aluno não entrar durante muito tempo na página de um curso, será excluído automaticamente do curso. Este parâmetro especifica esse limite de tempo.";
...
$string['courseupdates'] = "Actualizações ao Curso";
...
$string['day'] = "dia";
$string['days'] = "dias";
$string['defaultcoursefullname'] = "Nome completo e código do curso";
$string['defaultcourseshortname'] = "CURSO101";
$string['defaultcoursestudent'] = "Aluno";
$string['defaultcoursestudents'] = "Alunos";
$string['defaultcoursesummary'] = "Escreva aqui um parágrafo que explique em forma concisa e interessante o que este curso é.";
...
$string['deletecoursecheck'] = "Tem certeza absoluta que quer apagar completamente este curso e todos os dados contidos nele?";
...
$string['editcoursesettings'] = "Editar configuração do curso";
...
<li>Já pode ter acesso completo ao curso. A partir de agora só
...
$string['nofilesyet'] = "O seu curso ainda não tem nenhum ficheiro";
$string['nograde'] = "Nenhuma nota";
$string['noimagesyet'] = "O seu curso ainda não tem nenhuma imagem";
$string['none'] = "Nenhum";
$string['nopotentialadmins'] = "Nenhum candidato a administrador";
$string['nopotentialteachers'] = "Nenhum candidato a professor";
$string['normal'] = "Normal";
$string['nostudentsyet'] = "Ainda não nenhum aluno inscrito neste curso";
$string['nosuchemail'] = "Esse endereço de correio não existe";
$string['noteachersyet'] = "Este curso ainda não tem professor";
...
$string['requireskey'] = "Este curso precisa da chave de acesso";
...
$string['someallowguest'] = "Alguns cursos podem aceitar visitantes";
...
$string['unenrolsure'] = "Tem certeza que quer excluir \$a deste curso?";
