...
$string['addresource'] = 'Arbeitsmittel hinzufügen';
$string['editingaresource'] = 'Arbeitsmittel bearbeiten';
...
$string['modulename'] = 'Arbeitsmittel';
$string['modulenameplural'] = 'Arbeitsmittel';
