...
$string['emailconfirmsent'] = "
   ...
   <P>que conté unes instruccions senzilles per completar el registre en aquest lloc.
...
$string['htmleditordisabledbrowser'] = "L'editor Richtext no està disponible perquè no esteu utilitzant l'Internet Explorer versió 5.5 o posterior";
...
$string['latestlanguagepack'] = "Comprova l'últim paquet d'idioma en moodle.org";
...
$string['loginsteps'] = "Hola! L'accés complet als cursos requereix que dediqueu un minut a la creació d'un nou compte d'usuari vàlid per a aquest lloc web. Cada curs pot requerir també una &quot;clau d'inscripció&quot; que se us demanaria només la primera vegada que entreu. Els passos que heu de donar són els següents:
   <OL size=2>

   <LI>Ompliu el formulari de <A HREF=\$a>Nou compte</A> amb les dades que se us demanaran.

   <LI>El sistema us enviarà inmediatament un missatge a la vostra adreça de correu.

   <LI>Llegiu el correu i feu clic en l'enllaç web inclòs.

   <LI>S'activarà el vostre compte i us connectareu.

   <LI>Llavors, trieu el curs en el qual voleu participar.

   <LI>Si se us demana una &quot;clau d'inscripció&quot;, utilitzeu la que us ha donat el professor. Amb això quedareu inscrit al curs.

   <LI>En aquest moment ja tindreu accés complet al curs. En endavant només haureu d'introduir el vostre nom d'usuari i la contrasenya (en el formulari d'aquesta pàgina) per tal de connectar-vos i tenir accés a qualsevol curs en el qual estigueu inscrit.

   </OL>";
$string['loginstepsnone'] = "Hola!<P>Per tal de tenir accés complet als cursos us heu de crear 

un compte d'usuari.<P>Consisteix simplement a triar un nom d'usuari i una contrasenya amb els quals us identificareu, després, en aquesta pàgina.<P>Si algú ja ha triat abans el mateix nom d'usuari, n'haureu de provar un altre diferent.";
$string['loginto'] = "Entrar en\$a";
$string['loginusing'] = "Entreu aquí utilitzant el vostre nom d'usuari i contrasenya";
$string['logout'] = "Sortida";
$string['logs'] = "Registres";
$string['mainmenu'] = "Menú principal";
$string['makeafolder'] = "Crea una carpeta";
$string['makeeditable'] = "Si feu '\$a' editable pel procés del servidor web (p.e. apache) aleshores podreu editar aquest fitxer directament des d'aquesta pàgina";
$string['managedatabase'] = "Gestió de la base de dades";
$string['managemodules'] = "Gestiona els mòduls";
...
$string['moduledeleteconfirm'] = "Aneu a esborrar completament el mòdul '\$a'.  Això eliminarà tots els registres de la base de dades associats amb aquest mòdul d'activitat. Esteu segur que voleu continuar?";
$string['moduledeletefiles'] = "S'han eliminat de la base de dades totes les dades associades amb el mòdul '\$a->module'. Per completar la supressió del mòdul (i impedir que es reinstal·li per si mateix), ara hauríeu d'esborrar aquest directori del servidor: \$a->directory";
$string['modulesetup'] = "S'estan ajustant les taules de mòduls";
...
$string['movefilestohere'] = "Traslladeu els fitxers aquí";
...
anul·lada i se us n'ha assignat una de nova provisionalment.
Les dades per a fer la connexió són ara les següents:
   nom d'usuari: \$a->username

   contrasenya: \$a->newpassword
Si us plau, aneu a aquesta pàgina i canvieu la vostra contrasenya:
   \$a->link
...
s'hauria de presentar com un enllaç blau i només caldrà clicar-lo.
Si això no funciona, copieu i enganxeu l'adreça a la línea
...
$string['notincluded'] = "No inclòs";
$string['nousersmatching'] = "No s'han trobat usuaris que compleixin la condició '\$a'";
...
$string['passwordsenttext'] = "   <P>S'ha enviat un missatge per correu electrònic a la vostra adreça \$a->email.

   <P><B>Si us plau, busqueu en el vostre correu la contrasenya nova</B>

   <P>Aquesta nova contrasenya ha estat generada automàticament, de manera que potser voldreu <A HREF=\$a->link>canviar-la per una altra més fàcil de recordar</A>.";
$string['people'] = "Gent";
...
$string['publicdirectory2'] = "Publica el nom del lloc i l'enllaç";
$string['publicsitefileswarning'] = "Nota: els fitxers situats aquí són accessibles per tothom";
...
El principal benefici del registre és que sereu afegit a una llista de correu amb poca activitat 
per rebre les notificacions més importants, com ara alertes de seguretat o l'aparició de noves versions de Moodle.
<p>Per defecte la vostra informació serà privada i mai serà venuda o cedida a ningú més.  L'única 
...
$string['searchhelp'] = "Podeu buscar per diferents paraules de cop.<p>paraula : troba qualsevol coincidència d'aquesta paraula al text.<br>+paraula : troba només coincidències exactes amb la paraula.<br>-paraula : exclou els resultats que continguin aquesta paraula.";
...
$string['selectednowmove'] = "\$a fitxers seleccionats per moure'ls. Ara aneu a la destinació i premeu 'Trasllada els fitxers aquí'";
...
$string['updatinga'] = "S'està actualitzant un \$a";
$string['updatingain'] = "S'està actualitzant un \$a->what en \$a->in";
...
$string['usingexistingcourse'] = "S'està usant un curs existent";
...
Una de les primeres coses que hauríeu de fer és editar el vostre

perfil de manera que hom us pugui conèixer-te una mica més:
  \$a->profileurl";
...
$string['yes'] = "Sí";
$string['youareabouttocreatezip'] = "Esteu a punt de crear un fitxer comprimit que conté";
