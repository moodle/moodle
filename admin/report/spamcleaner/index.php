...
$strspamcleaner = get_string('spamcleaner', 'admin'); 
$strnav = '<a href="'.$CFG->wwwroot.'/'.$CFG->admin.'/index.php">'.get_string('administration').'</a> -> <a href="'.$CFG->wwwroot.'/'.$CFG->admin.'/report.php">'. get_string('reports') .'</a> -> '.$strspamcleaner;
// Print headers and things
print_header($strspamcleaner, $strspamcleaner, $strnav);
