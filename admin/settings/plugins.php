...
if ($hassiteconfig) {
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('allowaccountssameemail_desc', 'core_auth'),
        0
    ));
    ...
    $setting = new admin_setting_configtext(
        'allowemailaddresses',
        new lang_string('allowemailaddresses', 'admin'),
        new lang_string('configallowemailaddresses', 'admin'),
        '',
        PARAM_NOTAGS
    );
    ...
    $setting = new admin_setting_configtext(
        'denyemailaddresses',
        new lang_string('denyemailaddresses', 'admin'),
        new lang_string('configdenyemailaddresses', 'admin'),
        '',
        PARAM_NOTAGS
    );
    $setting->set_force_ltr(true);
    ...
    $temp->add(
        new admin_setting_configselect(
            'antivirus/notifylevel',
            get_string('notifylevel', 'antivirus'),
            '',
            core\antivirus\scanner::SCAN_RESULT_ERROR,
            [
    ...
    if ($ADMIN->fulltree) {
        ...
        $items[] = new admin_setting_configselect(
            'filteruploadedfiles',
            new lang_string('filteruploadedfiles', 'admin'),
            new lang_string('configfilteruploadedfiles', 'admin'),
            0,
        ...
        $items[] = new admin_setting_configcheckbox(
            'filternavigationwithsystemcontext',
            new lang_string('filternavigationwithsystemcontext', 'admin'),
            new lang_string('configfilternavigationwithsystemcontext', 'admin'),
            1
        );
    ...
    $temp->add(new admin_setting_heading(
        'mediaformats',
        get_string('mediaformats', 'core_media'),
    ...
    $temp->add(new admin_setting_configtext(
        'media_default_width',
        new lang_string('defaultwidth', 'core_media'),
        new lang_string('defaultwidthdesc', 'core_media'),
        640,
        PARAM_INT,
        10
    ));
    $temp->add(new admin_setting_configtext(
        ...
        new lang_string('defaultheight', 'core_media'),
        new lang_string('defaultheightdesc', 'core_media'),
        360,
        PARAM_INT,
        10
    ));
    ...
    $ADMIN->add('repositorysettings', new admin_externalpage(
        'repositorynew',
        new lang_string('addplugin', 'repository'),
        $url,
        'moodle/site:config',
        true
    ));
    $ADMIN->add('repositorysettings', new admin_externalpage(
        'repositorydelete',
        new lang_string('deleterepository', 'repository'),
        $url,
        'moodle/site:config',
        true
    ));
    $ADMIN->add('repositorysettings', new admin_externalpage(
        ...
        new lang_string('manage', 'repository'),
        $url,
        'moodle/site:config',
        true
    ));
    $ADMIN->add('repositorysettings', new admin_externalpage(
        'repositoryinstancenew',
        new lang_string('createrepository', 'repository'),
        $url,
        'moodle/site:config',
        true
    ));
    $ADMIN->add('repositorysettings', new admin_externalpage(
        'repositoryinstanceedit',
        new lang_string('editrepositoryinstance', 'repository'),
        $url,
        'moodle/site:config',
        true
    ));
...
if ($hassiteconfig || has_capability('moodle/question:config', $systemcontext)) {
    ...
    $settings->add(new admin_setting_heading(
        'qdefaultsetting_preview_options',
        '',
    ...
    $settings->add(new admin_setting_question_behaviour(
        'question_preview/behaviour',
    ...
    $settings->add(new admin_setting_configselect(
        'question_preview/generalfeedback',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'questiondefaultssave',
        get_string('questiondefaultssave', 'question'),
        get_string('questiondefaultssave_desc', 'question'),
        1
    ));
...
if ($hassiteconfig && !empty($CFG->enableplagiarism)) {
    ...
    $ADMIN->add('plagiarism', new admin_externalpage(
        'manageplagiarismplugins',
        new lang_string('manageplagiarism', 'plagiarism'),
...
$ADMIN->add('reports', new admin_externalpage(
    'comments',
    new lang_string('comments'),
    $CFG->wwwroot . '/comment/index.php',
...
if ($hassiteconfig) {
    ...
    foreach (core_component::get_plugin_list('coursereport') as $report => $path) {
        ...
        if (file_exists($file)) {
            $settings = new admin_settingpage(
                'coursereport' . $report,
                new lang_string('pluginname', 'coursereport_' . $report),
                'moodle/site:config'
            );
...
$ADMIN->add('reportplugins', new admin_externalpage(
    'managereports',
    new lang_string('reportsmanage', 'admin'),
...
if ($hassiteconfig) {
    ...
    foreach (core_component::get_plugin_list('search') as $engine => $plugindir) {
        ...
        if (file_exists($settingspath)) {
            $settings = new admin_settingpage(
                'search' . $engine,
                new lang_string('pluginname', 'search_' . $engine),
                'moodle/site:config'
            );
    ...
    $searchengineselect = new admin_setting_configselect(
        'searchengine',
        new lang_string('selectsearchengine', 'admin'),
        '',
        'simpledb',
        $engines
    );
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('searchindexwhendisabled', 'admin'),
        new lang_string('searchindexwhendisabled_desc', 'admin'),
        0
    ));
    $temp->add(new admin_setting_configduration(
        'searchindextime',
        new lang_string('searchindextime', 'admin'),
        new lang_string('searchindextime_desc', 'admin'),
        600
    ));
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('searchincludeallcourses', 'admin'),
        new lang_string('searchincludeallcourses_desc', 'admin'),
        0
    ));
    ...
    $temp->add(new admin_setting_configselect(
        ...
        \core_search\manager::SEARCH_AREA_CATEGORY_ALL,
        $options
    ));
    $temp->add(new admin_setting_configcheckbox(
    ...
    $temp->add(new admin_setting_configcheckbox(
        'searchbannerenable',
        new lang_string('searchbannerenable', 'admin'),
        new lang_string('searchbannerenable_desc', 'admin'),
        0
    ));
    $temp->add(new admin_setting_confightmleditor(
        'searchbanner',
    ...
    $ADMIN->add('searchplugins', new admin_externalpage(
        'searchareas',
        new lang_string('searchareas', 'admin'),
...
if ($hassiteconfig) {
    ...
    $ADMIN->add('cache', new admin_externalpage(
        'cacheusage',
        new lang_string('cacheusage', 'cache'),
        $CFG->wwwroot . '/cache/usage.php'
    ));
...
if ($hassiteconfig) {
    ...
    $ADMIN->add(
        ...
        new admin_externalpage(
            'contentbank',
            new lang_string('contentbankcustomfields', 'contentbank'),
...
if ($hassiteconfig) {
    ...
    $ADMIN->add('localplugins', new admin_externalpage(
        'managelocalplugins',
        new lang_string('localpluginsmanage'),
