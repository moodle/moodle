...
Feature: An admin can update courses using a CSV file
  ...
  Scenario: Updating a course fullname
    Given I upload "admin/tool/bulkenrol/tests/fixtures/courses.csv" file to "File" filemanager
  ...
  Scenario: Updating a course with custom fields
    ...
    When I upload "admin/tool/bulkenrol/tests/fixtures/courses_custom_fields.csv" file to "File" filemanager
