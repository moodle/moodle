...
Example:
\$sudo -u www-data /usr/bin/php admin/tool/bulkenrol/cli/bulkenrol.php --mode=createnew \\
...
$modes = array(
    'createnew' => tool_bulkenrol_processor::MODE_CREATE_NEW,
    'createall' => tool_bulkenrol_processor::MODE_CREATE_ALL,
    'createorupdate' => tool_bulkenrol_processor::MODE_CREATE_OR_UPDATE,
    'update' => tool_bulkenrol_processor::MODE_UPDATE_ONLY
);
if (!isset($options['mode']) || !isset($modes[$options['mode']])) {
    echo get_string('invalidmode', 'tool_bulkenrol')."\n";
    echo $help;
    die();
}
...
$updatemodes = array(
    'nothing' => tool_bulkenrol_processor::UPDATE_NOTHING,
    'dataonly' => tool_bulkenrol_processor::UPDATE_ALL_WITH_DATA_ONLY,
    'dataordefaults' => tool_bulkenrol_processor::UPDATE_ALL_WITH_DATA_OR_DEFAUTLS,
    'missingonly' => tool_bulkenrol_processor::UPDATE_MISSING_WITH_DATA_OR_DEFAUTLS
);
...
$processor->execute(new tool_bulkenrol_tracker(tool_bulkenrol_tracker::OUTPUT_PLAIN));
