...
/**
 * Template learningpaths table class.
 *
 * Note that presently this table may display some rows although the current user
 * does not have permission to view those learningpaths.
 *
 * @package    tool_lp
 * @copyright  2015 Frédéric Massart - FMCorz.net
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class template_learningpaths_table extends table_sql {
