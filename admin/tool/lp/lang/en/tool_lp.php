...
$string['qcompetencies'] = 'Question competencies';
$string['qcompetencies_help'] = 'Question competencies linked to this activity.';
$string['move'] = 'Move';
...
$string['uponquestioncompletion'] = 'Upon question completion:';
