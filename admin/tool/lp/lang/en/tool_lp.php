...
$string['coursecompetencyoutcome_complete'] = 'Marked as complete';
$string['coursecompetencyoutcome_evidence'] = 'Attached to evidence';
$string['coursecompetencyoutcomelabel'] = 'When the course is completed the competency is';
$string['coursecompetencyoutcome_none'] = 'None';
$string['coursecompetencyoutcome_recommend'] = 'Recommended';
