...
$string['cachedef_iomadpolicy_optional'] = 'Cache of the optional/compulsory flag for policy versions';
...
$string['editingiomadpolicydocument'] = 'Editing policy';
$string['erroriomadpolicyversioncompulsory'] = 'Compulsory policies cannot be declined!';
$string['erroriomadpolicyversionnotfound'] = 'There isn\'t any policy version with this identifier.';
$string['errorsaveasdraft'] = 'Minor change can not be saved as draft';
$string['errorusercantviewiomadpolicyversion'] = 'The user doesn\'t have access to this policy version.';
...
$string['newiomadpolicy'] = 'New policy';
...
$string['nopermissiontoviewiomadpolicyversion'] = 'You do not have permissions to view this policy version.';
$string['nopolicies'] = 'There are no policies for registered users with an active version.';
$string['selectiomadpolicyandversion'] = 'Use the filter above to select policy and/or version';
...
$string['iomadpolicydoccontent'] = 'Full policy';
...
$string['iomadpolicydocsummary_help'] = 'This text should provide a summary of the policy, potentially in a simplified and easily accessible form, using clear and plain language.';
$string['iomadpolicydoctype'] = 'Type';
$string['iomadpolicydoctype0'] = 'Site policy';
$string['iomadpolicydoctype1'] = 'Privacy policy';
$string['iomadpolicydoctype2'] = 'Third parties policy';
$string['iomadpolicydoctype99'] = 'Other policy';
$string['iomadpolicydocuments'] = 'Policy documents';
$string['iomadpolicynamedversion'] = 'Policy {$a->name} (version {$a->revision} - {$a->id})';
$string['iomadpolicypriorityagreement'] = 'Show policy before showing other policies';
$string['iomadpolicyversionacceptedinbehalf'] = 'Consent for this policy has been given on your behalf.';
$string['iomadpolicyversionacceptedinotherlang'] = 'Consent for this policy version has been given in a different language.';
...
$string['privacy:metadata:acceptances:iomadpolicyversionid'] = 'The version of the policy for which consent was given.';
...
$string['privacy:metadata:versions:iomadpolicyid'] = 'The policy that this version is associated with.';
