...
$sql_item = "SELECT id FROM mdl_feedback_item WHERE feedback = ".$feed_id. " ORDER BY position";
// echo $sql_item;
...
$i = 1;
$url = 'http://usein.dolibarrgestion.fr/devinfans/SuiviFOAD/refresh_notes_retour_cron.php?s='.$session."&stag=".$stag."&";
