...
if (typeof M.core_filemanager == "undefined" || !M.core_filemanager) {
    ...
    Y.extend(core_filemanager, Y.Base, {
            ...
            button_addfile.on('click', function(e) {
                ...
                Y.use('core_filepicker', function (Y) {
                    ...
                    if (!fm_filepickers[client_id]) {
                        fm_filepickers[client_id] = new Y.core_filepicker(options); 
                    }
        ...
        create_menu: function(ev, menuid, menuitems, fileinfo, options) {
            ...
            function remove(type, ev, obj) {
                ...
                dialog_options.callback = function() {
                    this.request({
                        action: 'delete',
                        scope: scope,
                        params: params,
                ...
                var dlg = confirm_dialog(ev, dialog_options);
            }
