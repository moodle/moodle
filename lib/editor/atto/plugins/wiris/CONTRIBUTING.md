...
If you find a bug in the source code, you can help us by [submitting an issue](#submitting-an-issue) to our [GitHub Repository](https://github.com/wiris/moodle-atto_wiris). Even better, you can submit a Pull Request with a fix.
...
You can file new issues by selecting from our [new issue templates](https://github.com/wiris/moodle-atto_wiris/issues/new/choose) and filling out the issue template.
