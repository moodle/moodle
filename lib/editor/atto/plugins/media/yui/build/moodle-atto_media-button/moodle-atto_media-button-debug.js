            ...
            '<form class="mform atto_form atto_media" id="{{elementid}}_atto_media_form">' +
                '<ul class="root nav nav-tabs mb-1" role="tablist">' +
                    '<li data-medium-type="{{CSS.LINK}}" class="nav-item">' +
                        '<a class="nav-link active" href="#{{elementid}}_{{CSS.LINK}}" role="tab" data-bs-toggle="tab">' +
                            '{{get_string "link" component}}' +
                        '</a>' +
                    '</li>' +
                    '<li data-medium-type="{{CSS.VIDEO}}" class="nav-item">' +
                        '<a class="nav-link" href="#{{elementid}}_{{CSS.VIDEO}}" role="tab" data-bs-toggle="tab">' +
                            '{{get_string "video" component}}' +
                        '</a>' +
                    '</li>' +
                    '<li data-medium-type="{{CSS.AUDIO}}" class="nav-item">' +
                        '<a class="nav-link" href="#{{elementid}}_{{CSS.AUDIO}}" role="tab" data-bs-toggle="tab">' +
                ...
                '<div class="{{CSS.DISPLAY_OPTIONS}}">' +
                    ...
                    '<div class="mb-1">' +
                        ...
                        '<div class="d-flex flex-wrap align-items-center {{CSS.POSTER_SIZE}}">' +
                            ...
                            '<input type="text" class="form-control me-1 {{CSS.WIDTH_INPUT}} input-mini" size="4"/>' +
                            ' x ' +
                            '<label class="accesshide">{{get_string "videoheight" component}}</label>' +
                            '<input type="text" class="form-control ms-1 {{CSS.HEIGHT_INPUT}} input-mini" size="4"/>' +
                        '</div>' +
                    '</div>' +
                    '<div class="clearfix"></div>' +
            ...
            TRACK_TABS: '' +
                '<ul class="nav nav-tabs mb-3">' +
                    ...
                    '<li data-track-kind="{{CSS.TRACK_CAPTIONS}}" class="nav-item">' +
                        '<a class="nav-link" href="#{{elementid}}_{{id}}_{{CSS.TRACK_CAPTIONS}}" role="tab" data-bs-toggle="tab">' +
                    ...
                    '<li data-track-kind="{{CSS.TRACK_CHAPTERS}}" class="nav-item">' +
                        '<a class="nav-link" href="#{{elementid}}_{{id}}_{{CSS.TRACK_CHAPTERS}}" role="tab" data-bs-toggle="tab">' +
                            '{{get_string "chapters" component}}' +
                        '</a>' +
                    '</li>' +
                    '<li data-track-kind="{{CSS.TRACK_METADATA}}" class="nav-item">' +
                        '<a class="nav-link" href="#{{elementid}}_{{id}}_{{CSS.TRACK_METADATA}}" role="tab" data-bs-toggle="tab">' +
