...
If you find a bug in the source code, you can help us by [submitting an issue](#submitting-an-issue) to our [GitHub Repository](https://github.com/wiris/moodle-tinymce_tiny_mce_wiris). Even better, you can submit a Pull Request with a fix.
