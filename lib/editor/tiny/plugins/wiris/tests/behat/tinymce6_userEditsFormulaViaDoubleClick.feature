@tiny @tiny_wiris @wiris_mathtype @tinymce6_edit_formula @mtmoodle-34
Feature: Edit MathType formula with tinymce6 editor via double click
...
Background:
  ...
  Scenario: MTMOODLE-34 - Edit MathType formula via double click
    ...
    ## Go to the editor's iframe to db click the wirisformula
