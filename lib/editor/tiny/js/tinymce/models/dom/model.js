...
(function () {
    ...
    const caretPositionFromPoint = (doc, x, y) => Optional.from(doc.dom.caretPositionFromPoint?.(x, y)).bind(pos => {
    ...
    const caretRangeFromPoint = (doc, x, y) => Optional.from(doc.dom.caretRangeFromPoint?.(x, y));
