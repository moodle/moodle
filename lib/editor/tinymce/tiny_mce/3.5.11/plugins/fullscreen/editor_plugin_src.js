...
(function() {
	...
	var transferState = function(oldEditor, newEditor, bookmark) {
		...
		var oldExists = oldEditor.plugins.spellchecker && oldEditor.plugins.spellchecker.selectedLang;
		var newExists = newEditor.plugins.spellchecker && newEditor.plugins.spellchecker.setLanguage;
