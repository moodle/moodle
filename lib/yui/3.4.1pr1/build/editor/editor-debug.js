...
}, '3.4.1pr1' ,{skinnable:false, requires:['base', 'node', 'selector-css3', 'substitute', 'yui-throttle']});
...
}, '3.4.1pr1' ,{skinnable:false, requires:['frame']});
...
}, '3.4.1pr1' ,{skinnable:false, requires:['editor-base']});
...
}, '3.4.1pr1' ,{skinnable:false, requires:['base', 'frame', 'node', 'exec-command', 'selection']});
...
YUI.add('editor', function(Y){}, '3.4.1pr1' ,{skinnable:false, use:['frame', 'selection', 'exec-command', 'editor-base', 'editor-para', 'editor-br', 'editor-bidi', 'editor-tab', 'createlink-base']});
