...
YUI.add('yui', function(Y){}, '3.4.1pr1' ,{use:['yui-base','get','features','intl-base','yui-log','yui-later']});
...
}, '3.4.1pr1' ,{requires:['oop','features']});
...
}, '3.4.1pr1' ,{requires:['dom-base', 'dom-style']});
...
}, '3.4.1pr1' ,{requires:['selector-native']});
...
}, '3.4.1pr1' ,{requires:['event-custom-base']});
...
}, '3.4.1pr1' ,{requires:['dom-core', 'selector']});
...
}, '3.4.1pr1' ,{requires:['dom-base', 'node-core', 'event-base']});
(function () {
...
}, '3.4.1pr1' ,{requires:['pluginhost-base']});
...
}, '3.4.1pr1' ,{requires:['node-base', 'event-delegate']});
...
}, '3.4.1pr1' ,{requires:['node-base', 'pluginhost']});
...
}, '3.4.1pr1' ,{requires:['node-base', 'dom-screen']});
...
}, '3.4.1pr1' ,{requires:['dom-style', 'node-base']});
...
}, '3.4.1pr1' ,{requires:['event-custom-base', 'querystring-stringify-simple']});
...
}, '3.4.1pr1' ,{requires:['selector-native', 'selector-css2']});
YUI.add('yui-log', function(Y) {
...
}, '3.4.1pr1' ,{use:['yui','oop','dom','event-custom-base','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie','querystring-stringify-simple']});
var Y = YUI().use('*');
