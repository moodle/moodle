...
var Checkbox = forwardRef(({ invalidFeedback, invalid, indeterminate = false, supportingText, className, label, hideLabel = false, id: idProp, required, disabled, "aria-label": ariaLabelProp, ...inputProps }, ref) => {
	...
	const messageText = hasVisibleLabel ? isInvalid && !isDisabled && invalidFeedback ? invalidFeedback : supportingText : void 0;
	const hasInvalidFeedback = hasVisibleLabel && isInvalid && !isDisabled && !!invalidFeedback;
	const feedbackId = messageText ? `${id}-feedback` : void 0;
	return /* @__PURE__ */ jsxs("div", {
		className: classes.join(" "),
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "mds-checkbox-input-wrapper",
