...
class web_test extends UnitTestCase {
    ...
    function test_convert_urls_into_links() {
        $texts = array (
                     'URL: http://moodle.org/s/i=1&j=2' => 'URL: <a href="http://moodle.org/s/i=1&j=2">http://moodle.org/s/i=1&j=2</a>',
                     'URL: www.moodle.org/s/i=1&amp;j=2' => 'URL: <a href="http://www.moodle.org/s/i=1&amp;j=2">www.moodle.org/s/i=1&amp;j=2</a>',
                     'URL: https://moodle.org/s/i=1&j=2' => 'URL: <a href="https://moodle.org/s/i=1&j=2">https://moodle.org/s/i=1&j=2</a>',
                     'URL: http://moodle.org:8080/s/i=1' => 'URL: <a href="http://moodle.org:8080/s/i=1">http://moodle.org:8080/s/i=1</a>',
                     'http://moodle.org - URL' => '<a href="http://moodle.org">http://moodle.org</a> - URL',
                     'www.moodle.org - URL' => '<a href="http://www.moodle.org">www.moodle.org</a> - URL',
                     '(http://moodle.org) - URL' => '(<a href="http://moodle.org">http://moodle.org</a>) - URL',
                     '(www.moodle.org) - URL' => '(<a href="http://www.moodle.org">www.moodle.org</a>) - URL',
                     '[http://moodle.org] - URL' => '[<a href="http://moodle.org">http://moodle.org</a>] - URL',
                     '[www.moodle.org] - URL' => '[<a href="http://www.moodle.org">www.moodle.org</a>] - URL',
                     '[http://moodle.org/main#anchor] - URL' => '[<a href="http://moodle.org/main#anchor">http://moodle.org/main#anchor</a>] - URL',
                     '[www.moodle.org/main#anchor] - URL' => '[<a href="http://www.moodle.org/main#anchor">www.moodle.org/main#anchor</a>] - URL',
                     'URL: http://cc.org/url_(withpar)_go/?i=2' => 'URL: <a href="http://cc.org/url_(withpar)_go/?i=2">http://cc.org/url_(withpar)_go/?i=2</a>',
                     'URL: www.cc.org/url_(withpar)_go/?i=2' => 'URL: <a href="http://www.cc.org/url_(withpar)_go/?i=2">www.cc.org/url_(withpar)_go/?i=2</a>',
                     'URL: http://cc.org/url_(with)_(par)_go/?i=2' => 'URL: <a href="http://cc.org/url_(with)_(par)_go/?i=2">http://cc.org/url_(with)_(par)_go/?i=2</a>',
                     'URL: www.cc.org/url_(with)_(par)_go/?i=2' => 'URL: <a href="http://www.cc.org/url_(with)_(par)_go/?i=2">www.cc.org/url_(with)_(par)_go/?i=2</a>',
                     ...
                     'URL: http://moodle.org/s/i=1&j=2.' => 'URL: <a href="http://moodle.org/s/i=1&j=2">http://moodle.org/s/i=1&j=2</a>.',
                     'URL: www.moodle.org/s/i=1&amp;j=2.' => 'URL: <a href="http://www.moodle.org/s/i=1&amp;j=2">www.moodle.org/s/i=1&amp;j=2</a>.',
                     'URL: http://moodle.org)<br />' => 'URL: <a href="http://moodle.org">http://moodle.org</a>)<br />',
                     'URL: <p>text www.moodle.org&lt;/p> text' => 'URL: <p>text <a href="http://www.moodle.org">www.moodle.org</a>&lt;/p> text'
                 );
