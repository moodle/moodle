...
define(['jquery', 'core/pubsub'], function($, PubSub) {
    ...
    var getToggleGroupElements = function(root, toggleGroup) {
    ...
    var getControlCheckboxes = function(root, toggleGroup) {
        return getToggleGroupElements(root, toggleGroup).filter('[data-toggle="master"]');
    };

    var getActionElements = function(root, toggleGroup) {
        return getToggleGroupElements(root, toggleGroup).filter('[data-toggle="action"]');
    };
    ...
    var toggleSlavesFromMasters = function(e) {
        ...
        // Enable action elements when master checkboxes have been checked. Disable otherwise.
        setActionElementStates(root, toggleGroupName, !targetState);
