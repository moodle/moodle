 ...
 * @param {object} modalConfig The configuration of the modal
 * @return {object} Modal instance
 */
const createFromElement = (registryConf, modalElement, modalConfig) => {
 ...
 * @param {object} modalConfig The configuration to pass in
 * @returns {promise} Resolved with a Modal instance
 */
const createFromType = (registryConf, templateContext, modalConfig) => {
    const templateName = registryConf.template;
    return Templates.render(templateName, templateContext)
        .then((html) => createFromElement(registryConf, $(html), modalConfig));
};
...
export const create = (modalConfig, triggerElement) => {
    ...
    const modalPromise = createFromType(registryConf, templateContext, modalConfig);
