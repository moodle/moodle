...
host._updateHandler();
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_setGraphic", 938);
...
this._graphic = graphic;
	...
	{
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "addClass", 962);
...
node.className.baseVal = Y_LANG.trim([node.className.baseVal, className].join(' '));
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "removeClass", 974);
...
node.className.baseVal = classString;
	...
	getXY: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getXY", 988);
...
return [parentXY[0] + x, parentXY[1] + y];
	...
	setXY: function(xy)
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setXY", 1003);
...
this.set("transform", this.get("transform"));
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "contains", 1019);
...
return needle === Y.one(this.node);
	...
	compareTo: function(refNode) {
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "compareTo", 1031);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1032);
var node = this.node;
...
return node === refNode;
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "test", 1044);
...
return Y.Selector.test(this.node, selector);
	...
	_getDefaultFill: function() {
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_getDefaultFill", 1056);
...
return {
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_getDefaultStroke", 1075);
...
return {
	...
	createNode: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "createNode", 1092);
...
if(id)
		{
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1104);
...
Y.one(node).setStyle("visibility", "hidden");
	...
	on: function(type, fn)
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "on", 1126);
...
return Y.on.apply(this, arguments);
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_strokeChangeHandler", 1141);
...
node.setAttribute("stroke", "none");
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_fillChangeHandler", 1190);
...
node.setAttribute("fill", "url(#grad" + this.get("id") + ")");
			...
			else {_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1204);
if(!fill.color)
			{
...
node.setAttribute("fill", "none");
	...
	_setGradientFill: function(fill) {
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_setGradientFill", 1229);
...
this._stops = stopNodes;
	...
	set: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "set", 1371);
...
host._updateHandler();
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "translate", 1388);
...
this._addTransform("translate", arguments);
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "translateX", 1400);
...
this._addTransform("translateX", arguments);
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "translateY", 1412);
...
this._addTransform("translateY", arguments);
    ...
    skew: function(x, y)
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "skew", 1424);
...
this._addTransform("skew", arguments);
    ...
    skewX: function(x)
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "skewX", 1435);
...
this._addTransform("skewX", arguments);
    ...
    skewY: function(y)
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "skewY", 1446);
...
this._addTransform("skewY", arguments);
    ...
    rotate: function(deg)
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "rotate", 1457);
...
this._addTransform("rotate", arguments);
    ...
    scale: function(x, y)
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "scale", 1468);
...
this._addTransform("scale", arguments);
	...
	{
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_addTransform", 1481);
...
this._updateTransform();
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_updateTransform", 1499);
...
this._transforms = [];
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 1572);
...
this._updateTransform();
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_updateHandler", 1592);
...
this._draw();
	...
	getBounds: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getBounds", 1615);
...
return this._normalizedMatrix.getContentRect(w, h, x, y);
    ...
    toFront: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "toFront", 1643);
...
graphic._toFront(this);
    ...
    toBack: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "toBack", 1657);
...
graphic._toBack(this);
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_parsePathData", 1673);
...
this.end();
    ...
    destroy: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "destroy", 1714);
...
this._destroy();
    ...
    _destroy: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_destroy", 1733);
...
SVGShape.ATTRS = {
	...
	transformOrigin: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "valueFn", 1756);
...
return [0.5, 0.5];
	...
	transform: {
		setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 1793);
...
return val;
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 1802);
...
return this._transform;
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "valueFn", 1815);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1817);
return Y.guid();
		},

		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 1820);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1822);
var node = this.node;
...
node.setAttribute("id", val);
			...
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1827);
return val;
		}
	},
	...
	x: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 1838);
...
return this._x;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 1843);
...
this.set("transform", transform);
	...
	y: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 1861);
...
return this._y;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 1866);
...
if(transform)
            {
                _yuitest_coverline("build/graphics-svg/graphics-svg.js", 1872);
this.set("transform", transform);
            }
        }
	},
	...
	visible: {
		...
		setter: function(val){
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 1906);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1907);
...
this.node.style.visibility = visibility;
			...
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1912);
return val;
		}
	},
...
if(fill && fill.color)
			{
				_yuitest_coverline("build/graphics-svg/graphics-svg.js", 1971);
...
return fill;
	...
	stroke: {
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2011);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2013);
var tmpl = this.get("stroke") || this._getDefaultStroke(),
                wt;
            _yuitest_coverline("build/graphics-svg/graphics-svg.js", 2015);
...
return (val) ? Y.merge(tmpl, val) : null;
	...
	pointerEvents: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "valueFn", 2034);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2036);
var val = "visiblePainted",
				node = this.node;
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2038);
if(node)
			{
...
return val;
	...
	node: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2066);
...
return this.node;
    ...
    data: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2082);
...
return val;
	...
	graphic: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2102);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2104);
...
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGPath", 2121);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2123);
...
SVGPath.ATTRS = Y.merge(Y.SVGShape.ATTRS, {
	...
	path: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2194);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2196);
return this._path;
		}
	},
	...
	width: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2207);
...
return val;
	...
	height: {
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2221);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2223);
 ...
 * @constructor
 */
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2238);
SVGRect = function()
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGRect", 2238);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2240);
...
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2253);
...
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGEllipse", 2265);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2267);
...
Y.extend(SVGEllipse, SVGShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 2288);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2290);
var node = this.node,
			w = this.get("width"),
			h = this.get("height"),
			x = this.get("x"),
...
SVGEllipse.ATTRS = Y.merge(SVGShape.ATTRS, {
	...
	xRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2317);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2319);
this.set("width", val * 2);
		},

		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2322);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2324);
var val = this.get("width");
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2325);
if(val)
			{
				_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2327);
val *= 0.5;
			}
...
this.set("height", val * 2);
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2346);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2348);
var val = this.get("height");
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2349);
if(val)
			{
				_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2351);
val *= 0.5;
			}
...
SVGCircle = function(cfg)
 {
    _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGCircle", 2368);
...
Y.extend(SVGCircle, Y.SVGShape, {
    ...
    _draw: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 2392);
...
var node = this.node,
            ...
            cx = x + radius,
            cy = y + radius;
        _yuitest_coverline("build/graphics-svg/graphics-svg.js", 2400);
...
SVGCircle.ATTRS = Y.merge(Y.SVGShape.ATTRS, {
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2417);
...
return val;
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2423);
...
return this.get("radius") * 2;
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2436);
...
return val;
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2442);
...
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGPieSlice", 2466);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2468);
...
Y.extend(SVGPieSlice, Y.SVGShape, Y.mix({
	...
	_draw: function(e)
	{
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 2487);
...
SVGGraphic = function(cfg) {
    _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGGraphic", 2548);
