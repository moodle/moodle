...
@since 3.8.1
**/
_yuitest_coverline("build/event-delegate/event-delegate.js", 225);
...
delegate._applyFilter = function (filter, args, ce) {
    _yuitest_coverfunc("build/event-delegate/event-delegate.js", "_applyFilter", 243);
...
if (target.nodeType === 3) {
        _yuitest_coverline("build/event-delegate/event-delegate.js", 252);
...
if (target.disabled && delegate._disabledRE.test(target.nodeName)) {
        _yuitest_coverline("build/event-delegate/event-delegate.js", 260);
return match;
    }
    ...
    _yuitest_coverline("build/event-delegate/event-delegate.js", 266);
args.unshift(target);

    _yuitest_coverline("build/event-delegate/event-delegate.js", 268);
if (isString(filter)) {
        _yuitest_coverline("build/event-delegate/event-delegate.js", 269);
while (target) {
            _yuitest_coverline("build/event-delegate/event-delegate.js", 270);
...
match.push(target);
            ...
            _yuitest_coverline("build/event-delegate/event-delegate.js", 275);
if (isContainer) {
                _yuitest_coverline("build/event-delegate/event-delegate.js", 276);
break;
            }

            _yuitest_coverline("build/event-delegate/event-delegate.js", 279);
target = target.parentNode;
        }
    } else {
        // filter functions are implementer code and should receive wrappers
        _yuitest_coverline("build/event-delegate/event-delegate.js", 283);
args[0] = Y.one(target);
        _yuitest_coverline("build/event-delegate/event-delegate.js", 284);
args[1] = new Y.DOMEventFacade(e, container, ce);

        _yuitest_coverline("build/event-delegate/event-delegate.js", 286);
while (target) {
            // filter(target, e, extra args...) - this === target
            _yuitest_coverline("build/event-delegate/event-delegate.js", 288);
if (filter.apply(args[0], args)) {
                _yuitest_coverline("build/event-delegate/event-delegate.js", 289);
match.push(target);
            }

            _yuitest_coverline("build/event-delegate/event-delegate.js", 292);
if (target === container) {
                _yuitest_coverline("build/event-delegate/event-delegate.js", 293);
break;
            }

            _yuitest_coverline("build/event-delegate/event-delegate.js", 296);
target = target.parentNode;
            _yuitest_coverline("build/event-delegate/event-delegate.js", 297);
args[0] = Y.one(target);
        }
        _yuitest_coverline("build/event-delegate/event-delegate.js", 299);
args[1] = e; // restore the raw DOM event
    }

    _yuitest_coverline("build/event-delegate/event-delegate.js", 302);
if (match.length <= 1) {
        _yuitest_coverline("build/event-delegate/event-delegate.js", 303);
match = match[0]; // single match or undefined
    }

    // remove the target
    _yuitest_coverline("build/event-delegate/event-delegate.js", 307);
args.shift();

    _yuitest_coverline("build/event-delegate/event-delegate.js", 309);
return match;
};
 ...
 * @for YUI
 */
_yuitest_coverline("build/event-delegate/event-delegate.js", 344);
