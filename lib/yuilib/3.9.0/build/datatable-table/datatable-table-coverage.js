...
if (columns) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 420);
process(columns);
        }
        ...
        @since 3.6.0
        **/
        _yuitest_coverline("build/datatable-table/datatable-table.js", 431);
this.displayColumns = displayColumns;
    ...
    **/
    _initEvents: function () {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "_initEvents", 441);
_yuitest_coverline("build/datatable-table/datatable-table.js", 442);
this.publish({
    ...
    **/
    initializer: function (config) {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "initializer", 459);
...
this._extractDisplayColumns();
        ...
        _yuitest_coverline("build/datatable-table/datatable-table.js", 466);
this.after('columnsChange', this._extractDisplayColumns, this);
    ...
    **/
    _relayAttrChange: function (e) {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "_relayAttrChange", 477);
_yuitest_coverline("build/datatable-table/datatable-table.js", 478);
var attr = e.attrName,
            val  = e.newVal;

        _yuitest_coverline("build/datatable-table/datatable-table.js", 481);
if (this.head) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 482);
this.head.set(attr, val);
        }

        _yuitest_coverline("build/datatable-table/datatable-table.js", 485);
if (this.foot) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 486);
this.foot.set(attr, val);
        }

        _yuitest_coverline("build/datatable-table/datatable-table.js", 489);
if (this.body) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 490);
if (attr === 'columns') {
                _yuitest_coverline("build/datatable-table/datatable-table.js", 491);
val = this.displayColumns;
            }

            _yuitest_coverline("build/datatable-table/datatable-table.js", 494);
this.body.set(attr, val);
    ...
    **/
    render: function () {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "render", 505);
_yuitest_coverline("build/datatable-table/datatable-table.js", 506);
if (this.get('container')) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 507);
this.fire('renderTable', {
        ...
        _yuitest_coverline("build/datatable-table/datatable-table.js", 519);
return this;
    },
    ...
    **/
    _uiSetCaption: function (htmlContent) {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "_uiSetCaption", 531);
_yuitest_coverline("build/datatable-table/datatable-table.js", 532);
var table   = this.tableNode,
            caption = this.captionNode;

        _yuitest_coverline("build/datatable-table/datatable-table.js", 535);
if (htmlContent) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 536);
if (!caption) {
                _yuitest_coverline("build/datatable-table/datatable-table.js", 537);
this.captionNode = caption = Y.Node.create(
                    fromTemplate(this.CAPTION_TEMPLATE, {
                        className: this.getClassName('caption')
                    }));

                _yuitest_coverline("build/datatable-table/datatable-table.js", 542);
table.prepend(this.captionNode);
            }

            _yuitest_coverline("build/datatable-table/datatable-table.js", 545);
caption.setHTML(htmlContent);

        } else {_yuitest_coverline("build/datatable-table/datatable-table.js", 547);
if (caption) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 548);
caption.remove(true);

            _yuitest_coverline("build/datatable-table/datatable-table.js", 550);
delete this.captionNode;
    ...
    **/
    _uiSetSummary: function (summary) {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "_uiSetSummary", 561);
_yuitest_coverline("build/datatable-table/datatable-table.js", 562);
if (summary) {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 563);
this.tableNode.setAttribute('summary', summary);
        } else {
            _yuitest_coverline("build/datatable-table/datatable-table.js", 565);
this.tableNode.removeAttribute('summary');
    ...
    **/
    _uiSetWidth: function (width) {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "_uiSetWidth", 577);
_yuitest_coverline("build/datatable-table/datatable-table.js", 578);
var table = this.tableNode;

        // Table width needs to account for borders
        _yuitest_coverline("build/datatable-table/datatable-table.js", 581);
table.setStyle('width', !width ? '' :
        ...
        _yuitest_coverline("build/datatable-table/datatable-table.js", 587);
table.setStyle('width', width);
    },
    ...
    **/
    _validateView: function (val) {
        _yuitest_coverfunc("build/datatable-table/datatable-table.js", "_validateView", 598);
_yuitest_coverline("build/datatable-table/datatable-table.js", 599);
...
}, '3.9.0', {"requires": ["datatable-core", "datatable-head", "datatable-body", "view", "classnamemanager"]});
