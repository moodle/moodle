...
YUI.Env.JSONP[proxy] = wrap(config.on.success);
        ...
        _yuitest_coverline("build/jsonp/jsonp.js", 196);
Y.Get.js(url, {
        ...
        _yuitest_coverline("build/jsonp/jsonp.js", 205);
return self;
    },
    ...
    _format: function (url, proxy) {
        _yuitest_coverfunc("build/jsonp/jsonp.js", "_format", 222);
_yuitest_coverline("build/jsonp/jsonp.js", 223);
return url.replace(/\{callback\}/, proxy);
    }
};

_yuitest_coverline("build/jsonp/jsonp.js", 227);
 ...
 * @for YUI
 */
_yuitest_coverline("build/jsonp/jsonp.js", 241);
Y.jsonp = function (url,c) {
    _yuitest_coverfunc("build/jsonp/jsonp.js", "jsonp", 241);
...
_yuitest_coverline("build/jsonp/jsonp.js", 246);
if (!YUI.Env.JSONP) {
    _yuitest_coverline("build/jsonp/jsonp.js", 247);
YUI.Env.JSONP = {};
}


}, '3.9.0', {"requires": ["get", "oop"]});
