...
var EventTarget = Y.EventTarget,
     ...
     * @uses EventTarget
     */
    _yuitest_coverline("build/attribute-observable/attribute-observable.js", 34);
function AttributeObservable() {
        // Perf tweak - avoid creating event literals if not required.
        _yuitest_coverfunc("build/attribute-observable/attribute-observable.js", "AttributeObservable", 34);
_yuitest_coverline("build/attribute-observable/attribute-observable.js", 36);
this._ATTR_E_FACADE = {};

        _yuitest_coverline("build/attribute-observable/attribute-observable.js", 38);
...
AttributeObservable._ATTR_CFG = [BROADCAST];
    ...
    _yuitest_coverline("build/attribute-observable/attribute-observable.js", 43);
AttributeObservable.prototype = {
        ...
        set : function(name, val, opts) {
            _yuitest_coverfunc("build/attribute-observable/attribute-observable.js", "set", 65);
_yuitest_coverline("build/attribute-observable/attribute-observable.js", 66);
return this._setAttr(name, val, opts);
        ...
        _set : function(name, val, opts) {
            _yuitest_coverfunc("build/attribute-observable/attribute-observable.js", "_set", 82);
_yuitest_coverline("build/attribute-observable/attribute-observable.js", 83);
return this._setAttr(name, val, opts, true);
        ...
        setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-observable/attribute-observable.js", "setAttrs", 95);
_yuitest_coverline("build/attribute-observable/attribute-observable.js", 96);
return this._setAttrs(attrs, opts);
        ...
        _setAttrs : function(attrs, opts) {
            _yuitest_coverfunc("build/attribute-observable/attribute-observable.js", "_setAttrs", 109);
...
return this;
        ...
        _fireAttrChange : function(attrName, subAttrName, currVal, newVal, opts) {
            _yuitest_coverfunc("build/attribute-observable/attribute-observable.js", "_fireAttrChange", 131);
_yuitest_coverline("build/attribute-observable/attribute-observable.js", 132);
var host = this,
            ...
            _yuitest_coverline("build/attribute-observable/attribute-observable.js", 139);
if (!state.get(attrName, PUBLISHED)) {

                _yuitest_coverline("build/attribute-observable/attribute-observable.js", 141);
evtCfg = {
                    queuable:false,
...
if (broadcast !== undefined) {
                    _yuitest_coverline("build/attribute-observable/attribute-observable.js", 150);
...
facade.newVal = newVal;
            ...
            // host.fire(facade);
            _yuitest_coverline("build/attribute-observable/attribute-observable.js", 170);
