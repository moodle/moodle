 ...
 *
 * License GNU/LGPL - Vincent Blavet - July 2003<br>
 * {@link http://www.phpconcept.net}<br>
 * --------------------------------------------------------------------------------
 *
 * Presentation :<br>
 *   PclZip is a PHP library that manage ZIP archives.<br>
 *   So far tests show that archives generated by PclZip are readable by
 *   WinZip application and other tools.
 *
 * Description :<br>
 *   See readme.txt and {@link http://www.phpconcept.net}<br>
 *
 * <b>Warning :</b><br>
...
/// GLOBAL CONSTANTS /////////////////////////////////////////////////////////
   ...
   * abilty to change that.<br>
   * However notice that changing this value may have impact on existing
   * scripts which use space separated filenames.
   ...
   * Error configuration.
   *
   * Value of 0 = PclZip Class integrated error handling
   * Value of 1 = PclError external library error handling. By enabling this
...
// --------------------------------------------------------------------------------
  ...
  /**
   * Error code: Unable to open file in binary write mode
   */
  define( 'PCLZIP_ERR_WRITE_OPEN_FAIL', -1 );
  /**
   * Error code: Unable to open file in binary read mode
   */
  ...
  /**
   * Error code: Filename is too long (max. 255)
   */
  define( 'PCLZIP_ERR_FILENAME_TOO_LONG', -5 );
  /**
   * Error code: Not a valid zip file
   */
  define( 'PCLZIP_ERR_INVALID_ZIP', -6 );
  /**
   * Error code: Invalid extracted file size
   */
  define( 'PCLZIP_ERR_BAD_EXTRACTED_FILE', -7 );
  /**
   * Error code: Unable to create directory
   */
  define( 'PCLZIP_ERR_DIR_CREATE_FAIL', -8 );
  /**
   * Error code:  Invalid archive extension
   */
  define( 'PCLZIP_ERR_BAD_EXTENSION', -9 );
  /**
   * Error code: Invalid archive format
   */
  define( 'PCLZIP_ERR_BAD_FORMAT', -10 );
  /**
   * Error code: Unable to delete file (unlink)
   */
  define( 'PCLZIP_ERR_DELETE_FILE_FAIL', -11 );
  /**
   * Error code: Unable to rename file (rename)
   */
  define( 'PCLZIP_ERR_RENAME_FILE_FAIL', -12 );
  /**
   * Error code: Invalid header checksum
   */
  define( 'PCLZIP_ERR_BAD_CHECKSUM', -13 );
  /**
   * Error code: Invalid archive size
   */
  ...
  // ----- Call backs values
  /**
   * Call back: Pre-extract
   */
  define( 'PCLZIP_CB_PRE_EXTRACT', 78001 );
  /**
   * Call back: Post-extract
   */
 ...
 *
 *   The public methods allow for the manipulation of the archive.<br>
 *
 * Public Methods :
 *  - {@link PclZip()} : Object creator
 *  - {@link create()} : Creates the Zip archive
 *  - {@link listContent()} : List the content of the Zip archive
 *  - {@link extract()} : Extract the content of the archive
 *  - {@link properties()} : List the properties of the archive
 */
  class PclZip
  {
    /**
  ...
  *
  * Description :
  *   Creates a PclZip object and sets the name of the associated Zip archive
  *   filename.<br>
  *   Note that no real action is taken, if the archive does not exist it is not
  *   created. Use {@link create()} for that.
  * @param string $p_zipname The name of the associated Zip archive
  *   filename
  */
  ...
  *   - PCLZIP_CB_POST_ADD 
  *
  * @param array  $p_filelist  An array containing file or directory names, or
  *                 a string containing one filename or one directory name, or
  *                 a string containing a list of filenames and/or directory
  *                 names separated by spaces.
  * @param string  $p_add_dir A path to add before the real path of the archived file,
  *                in order to have it memorized in the archive.
  * @param string  $p_remove_dir A path to remove from the real path of the file to archive,
  *                   in order to have a shorter path memorized in the archive.
  *                   When $p_add_dir and $p_remove_dir are set, $p_remove_dir
  *                   is removed first, before $p_add_dir is added.
  * @return int|string  0 on failure or the list of the added files, 
  *                           with a status of the add action.
  *                    (see {@link PclZip::listContent()} for returned list entry format)
  * @access public
  */
//  function create($p_filelist, $p_add_dir="", $p_remove_dir="")
  ...
  /**
  * This method adds the list of files in an existing archive.
  *
  * Description :<br>
  ...
  *   If the archive does not exist, it is created.<br>
  *
  * Example usage:
  * <code>
...
//  function add($p_filelist, $p_add_dir="", $p_remove_dir="")
  ...
  *   properties.
  *   The properties of each of the  entries in the list returned are (used also in other functions) :
  ...
  *     Valid values for status property are :
  *                - ok : OK !
  ...
  * @return int|array Returns 0 on an unrecoverable failure,
  *                   or the list of the files in the archive.
  * @access public
  */
  ...
  *   are used, the path indicated in PCLZIP_OPT_ADD_PATH is appended
  *   to the end of the path value of PCLZIP_OPT_PATH.<br>
  * Supported options :
  *   - PCLZIP_OPT_ADD_PATH 
  *   - PCLZIP_OPT_REMOVE_PATH 
  *   - PCLZIP_OPT_REMOVE_ALL_PATH 
  ...
  *   - PCLZIP_CB_POST_ADD 
  *
  * @param string $p_path Path where the files and directories are to be extracted
  * @param string $p_remove_path First part ('root' part) of the memorized path
  *                    (if any similar) to remove while extracting.
  * @return int|array  Returns 0 or a negative value on failure,
  *                    or the list of the extracted files, with a status of the action.
  *                    (see {@link PclZip::listContent()} for returned list entry format)
  * @access public
  */
 ...
 /**
  * List the properties of the archive
  *
  *   This method returns the properties of the archive.
  *   The properties are :
  *     - nb : Number of files in the archive
  *     - comment : Comment associated with the archive file
  *     - status : not_exist, ok
  * @return int|array Returns 0 on failure,
  *                     or an array with the archive properties.
  * @access public
  */
  function properties()
  {
