...
$string['privacy:metadata:jwt:roles'] = 'Brugerens kursusroller til adgangsvalidering.';
$string['privacy:metadata:jwt:userid'] = 'Bruger-ID for brugeren til adgangsvalidering.';
