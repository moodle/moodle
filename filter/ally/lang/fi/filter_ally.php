...
$string['privacy:metadata:jwt:roles'] = 'Nämä ovat käyttäjän roolit kurssilla, joilla tarkistetaan käyttöoikeudet.';
$string['privacy:metadata:jwt:userid'] = 'Tämä on käyttäjän käyttäjätunnus, jolla tarkistetaan käyttöoikeudet.';
