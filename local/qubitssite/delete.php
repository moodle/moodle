...
$strdeletesite = get_string("deletesite", "local_qubitssite");

if(!empty($id) && !(has_capability('local/qubitssite:deletetenantsite', $context))){
...
$PAGE->set_url('/local/qubitssite/delete.php', $pageparams);
