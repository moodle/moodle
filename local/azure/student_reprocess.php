...
class local_azure_plugin {
    ...
    public function run_student_reprocess($run_as_adhoc = false) {
        ...
        ues::require_libs();
        require_once($CFG->dirroot . '/local/azure/provider.php');
    ...
    private function get_scheduled_task() {
        $task = \core\task\manager::get_scheduled_task('\local_azure\task\reprocess_student_data');
