...
class tool_uploadcourse_course_testcase extends advanced_testcase {
    ...
    public function test_restore_file() {
        ...
        $updatemode = tool_uploadcourse_processor::UPDATE_ALL_WITH_DATA_ONLY;
        // IOMAD
        $data = array('shortname' => 'A1', 'backupfile' => __DIR__ . '/fixtures/tool_uploadcourse/backup.mbz',
        ...
        // IOMAD
        $data = array('shortname' => 'B1', 'backupfile' => __DIR__ . '/fixtures/tool_uploadcourse/backup.mbz',
