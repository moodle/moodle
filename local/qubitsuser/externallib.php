 ...
 * @since Moodle 2.2
 */
class local_qubitsuser_external extends external_api {
     ...
     */
    public static function get_potential_users($courseid, $enrolid, $search, $searchanywhere, $page, $perpage, $siteid) {
        global $PAGE, $DB, $CFG;

        require_once($CFG->dirroot.'/enrol/locallib.php');
        require_once($CFG->dirroot.'/user/lib.php');
        require_once($CFG->dirroot.'/local/qubitsuser/locallib.php');
        ...
        $manager = new qbcourse_enrolment_manager($PAGE, $course);

        $site = $DB->get_record('local_qubits_sites', array('id' => $params['siteid']));
        $acohortmembers = core_cohort_external::get_cohort_members(array($site->cohortid));
