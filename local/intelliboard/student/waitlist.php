...
$PAGE->set_url(new moodle_url(
    "/local/intelliboard/student/waitlist.php",
    [
        'search'  => $search,
        'sesskey' => sesskey()
    ]
...
$PAGE->navbar->add(get_string('mywaitlist', 'local_intelliboard'));
$PAGE->requires->jquery();
$PAGE->requires->css('/local/intelliboard/assets/css/style.css');
$PAGE->set_pagetype('mywaitlist');
$params = array(
    'do'=>'learner',
    'mode'=> 1
);
$intelliboard = intelliboard($params);
$table = new intelliboard_user_waitlist_table('user_waitlist', $search);
$intellicartenabled = (
