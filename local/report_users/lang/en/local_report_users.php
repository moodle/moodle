...
$string['clear'] = 'Clear';
$string['clearconfirm'] = 'User will be removed from the course.  Are you sure you want to do this?';
$string['clearreallocateconfirm'] = 'User will be removed from the course.  Where possible a license will be re-allocated for this course to the user. Are you sure you want to do this?';
...
$string['deleteconfirm'] = 'User will be removed from the course and all their data will be deleted. Any unused licenses will be released for re-allocation. This cannot be undone. Are you sure?';
$string['delete_successful'] = 'User has been removed from the course sucessfully.';
...
$string['trackclearconfirm'] = 'User\'s course record will be deleted. Are you sure you want to do this?';
