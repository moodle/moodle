...
/**
 * course_sections module upgrade code
 *
...
function xmldb_local_qbmanifest_install() {
    global $CFG, $DB;

  //  echo $oldversion; exit;
    ...
    // Put any upgrade step following this.
        ...
        // Define field forcedownload to be added to course_sections.
        ...
        $table = new xmldb_table('qubitspage');
        $field = new xmldb_field('uid', XMLDB_TYPE_CHAR, "512", null, null, null, null);
        ...
        if(empty($cexists)){
                ...
                $cat->parent = 5;
                $cat->contextid = 1;
                $cat->name = 'Qubits Question Bank';
                $cat->info = 'Qubits default category';
                $cat->infoformat = 1;
                $cat->sortorder = 999;
                $cat->stamp = make_unique_id_code();
                $cat->idnumber = 'qbtopcat';
