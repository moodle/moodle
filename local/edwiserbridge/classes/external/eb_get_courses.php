        ...
        return new external_function_parameters(
            array(
                ...
                'total_courses'   => new external_value(
                    PARAM_INT,
                    get_string('web_service_total_courses', 'local_edwiserbridge')
                ),
            )
        );
    }
                    ...
                    new external_single_structure(
                        array(
                            'id'        => new external_value(
                                PARAM_INT,
                                get_string('web_service_courseid', 'local_edwiserbridge')
                            ),
                            'fullname'  => new external_value(
                                PARAM_TEXT,
                                get_string('web_service_fullname', 'local_edwiserbridge')
                            ),
                            'categoryid' => new external_value(
                                PARAM_INT,
                                get_string('web_service_categoryid', 'local_edwiserbridge')
                            )
                        )
                    )
                )
