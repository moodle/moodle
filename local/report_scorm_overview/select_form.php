...
class completion_select_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform =& $this->_form;
        $mform->addElement('header', 'iomadreportselect',
                            get_string('reportselect', 'local_report_completion'));
        $mform->addElement('select', 'repcourse',
                            get_string('course', 'local_report_completion'),
                            $courses, array());
