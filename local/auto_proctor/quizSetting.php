...
// Setup moodle global variable also
require_login();
...
if ( $_SERVER[ 'REQUEST_METHOD' ] === 'GET' && isset( $_GET[ 'save_btn' ] ) ) {
    ...
    // If the box is checked, update the AP feature field to 1 in the AP table;
    if it's not checked, update it to 0.
        ...
        <div class="p-4 bg-white block sm:flex items-center">
            <div class="w-full mb-1">
                <div class="p-6 rounded-md">
                    ...
                    <div class="flex items-center mb-2">
                        <input type="checkbox' id='strictEnforcement' class='mr-2' name='enable_strict_enforcement' value='1" <label
                            for="strictEnforcement' class='text-gray-900">Strict Enforcement</label>
                    </div>
                    <p class="text-sm text-gray-600 mb-5">Enabling this option enforces proctoring. If a student disagrees with tracking, the quiz will automatically end.</p>
                    <!-- Checkbox for Enable Strict Mode -->
                    <div class="flex items-center mb-2">
                        <input type="checkbox' id='strictMode' class='mr-2' name='enable_strict_mode' value='1" <label
                            for="strictMode' class='text-gray-900">Enable Strict Mode</label>
                    </div>
