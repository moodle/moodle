                        ...
                        <div class="items-center justify-between lg:flex">
                            ...
                            <div class="items-center sm:flex">
                                <div date-rangepicker class="flex items-center space-x-4">
                                    ...
                                    <div class="relative">
                                        <form action="#" method="GET" class=" lg:pl-3.5">
                                            ...
                                            <div class="relative mt-1 lg:w-96">
                                                ...
                                                <input type="text" name="email" id="topbar-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5  text-white " placeholder="Search">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="sticky bottom-0 right-0 items-center w-full p-4 bg-white border-t border-gray-200 sm:flex sm:justify-between d">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center mb-4 sm:mb-0">
                                    ...
                                    <span class="text-sm font-normal text-gray-500 ">Page<span class="font-semibold text-gray-900 ">1 of 1 </span>| <span class="font-semibold text-gray-900 ">Go to Page</span></span>
