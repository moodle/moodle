// define(['jquery', 'https://html2canvas.hertzen.com/dist/html2canvas.min.js'], function($) {
//     return {
...
//                 xhr.open('POST', jsdata.wwwroot + '/local/auto_proctor/save_activity.php', true);
//                 xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
//                 xhr.send('screen_status=' + screen_status + '&userid=' + 3 + '&quizid=' + 1 + '&quizattempt=' + 140 + '&filename=' + encodeURIComponent(filename) + '&activity_type=' + activity_type);
//             }
...
//                         fetch('" + jsdata.wwwroot + "/local/auto_proctor/save_capture.php', {
...
$(document).ready(function () {
    ...
    function sendScreenSharingStatus(screen_activity, filename, activity_type) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', jsdata.wwwroot + '/local/auto_proctor/save_activity.php', true); // Replace with the actual path
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
