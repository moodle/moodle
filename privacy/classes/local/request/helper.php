...
class helper {
     ...
     */
    public static function delete_for_context($component, deletion_criteria $criteria) {
     ...
     */
    public static function delete_for_context_course_module($component, \context_module $context) {
        global $DB;
