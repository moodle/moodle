...
if( isset($_POST['selectGroup']) )	{
	...
	$sql_utilisateur =  "SELECT user.id, user.username, GROUP_CONCAT(groups.courseid SEPARATOR '#') as listCourses, groups.name 
	...
	//echo '<p style="color:blue;">' . $sql_utilisateur . '</p>';
	// exit;
	...
	// echo "url: ".$url_dolibarr."   ".$selectGroup."  ".$retour; exit;
